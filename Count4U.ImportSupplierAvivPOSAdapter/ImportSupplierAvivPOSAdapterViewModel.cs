...
{
    public class ImportSupplierAvivPOSAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        private string _branchErpCode = String.Empty;

        public ImportSupplierAvivPOSAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportSupplierAvivPOS Adapter");
            IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportSupplierAvivPOSADOProvider);
        ...
        {
            base.LogImport.Clear();
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportSupplierAvivPOSADOProvider);
