...
{																																				  
    public class UpdateCatalogERPQuantityAvivMultiBarcodeViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		string _branchErpCode = String.Empty;

        public UpdateCatalogERPQuantityAvivMultiBarcodeViewModel(IServiceLocator serviceLocator,
