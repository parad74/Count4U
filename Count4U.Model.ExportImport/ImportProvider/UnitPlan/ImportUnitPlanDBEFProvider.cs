...
{
	public class ImportUnitPartDBEFProvider : BaseProvider, IImportProvider
	{
		private readonly IImportUnitPlanRepository _importUnitPlanRepository;

		public ImportUnitPartDBEFProvider(IImportUnitPlanRepository importUnitPlanRepository,
		...
		public void Import()
		{
			...
			UnitPlanParserEnum.UnitPlanFromDBParser,
