...
{
	public class ImportIturERPADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportIturRepository _importIturADORepository;

		public ImportIturERPADOProvider(IImportIturRepository importIturADORepository,
		...
		public void Import()
		{
			...
			this._importIturADORepository.InsertIturs(this.FromPathFile, this.ToPathDB, IturParserEnum.IturERPParser,
