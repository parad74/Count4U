...
{
	public class ImportIturNativXslx2SdfProvider : BaseProvider, IImportProvider
	{
		...
		public ImportIturNativXslx2SdfProvider(//IImportIturRepository importIturADORepository,
		...
		public void Import()
		{
			...
			this._importIturBlukRepository.InsertIturs(this.FromPathFile,
				this.ToPathDB, IturParserEnum.IturNativXslx2SdfParser,	//IturDBParser,		  
			...
			this._importIturBlukRepository.InsertIturs(this.FromPathFile,
				this.ToPathDB, IturParserEnum.IturNativXslx2SdfUpdateUpLevelParser,	//IturDBParser,		  
			this.ProviderEncoding, this._separators, this._countExcludeFirstString,
			this._importTypes, this.Parms);
