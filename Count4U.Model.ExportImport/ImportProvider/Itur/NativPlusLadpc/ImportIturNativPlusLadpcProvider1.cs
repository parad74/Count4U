...
{
	public class ImportIturNativPlusLadpcProvider1 : BaseProvider, IImportProvider
	{
		private readonly IImportIturRepository _importIturADORepository;

		public ImportIturNativPlusLadpcProvider1(IImportIturRepository importIturADORepository,
		...
		public void Import()
		{
			...
			IturParserEnum.IturNativPlusLadpcParser1,
