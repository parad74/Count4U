...
{
	public class ImportIturYesXlsxProviderSN : BaseProvider, IImportProvider
	{
		private readonly IImportIturRepository _importIturADORepository;

		public ImportIturYesXlsxProviderSN(IImportIturRepository importIturADORepository,
		...
		public void Import()
		{
			...
			IturParserEnum.IturYesXlsxParserSN,
