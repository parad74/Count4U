...
{
	public class ImportIturYesXlsxProvider : BaseProvider, IImportProvider
	{
		private readonly IImportIturRepository _importIturADORepository;

		public ImportIturYesXlsxProvider(IImportIturRepository importIturADORepository,
		...
		public void Import()
		{
			...
			IturParserEnum.IturYesXlsxParser,
