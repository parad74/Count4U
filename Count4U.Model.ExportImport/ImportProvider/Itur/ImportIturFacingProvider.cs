...
{
	public class ImportIturFacingProvider : BaseProvider, IImportProvider
	{
		private readonly IImportIturRepository _importIturADORepository;

		public ImportIturFacingProvider(IImportIturRepository importIturADORepository,
		...
		public void Import()
		{
			...
			this._importIturADORepository.InsertIturs(this.FromPathFile, this.ToPathDB, IturParserEnum.IturFacingParser,
