...
{
	public class ImportPropertyStr7MerkavaXslx2SdfProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrRepository _importPropertyStrADORepository;

		public ImportPropertyStr7MerkavaXslx2SdfProvider(IImportPropertyStrRepository importPropertyStrADORepository,
		...
		public void Import()
		{
			...
			PropertyStrParserEnum.PropertyStr7MerkavaXslx2SdfParser,
