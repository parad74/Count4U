...
{
	public class ImportPropertyStr9NativXslx2SdfProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrRepository _importPropertyStrADORepository;

		public ImportPropertyStr9NativXslx2SdfProvider(
		...
		public void Import()
		{
			...
			PropertyStrParserEnum.PropertyStr9NativXslx2SdfParser,
			DomainObjectTypeEnum.PropertyStr9,
		...
		public void Clear()
		{
			this._importPropertyStrADORepository.ClearPropertyStrs(DomainObjectTypeEnum.PropertyStr9, this.ToPathDB);
		}
