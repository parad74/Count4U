...
{
	public class ImportPropertyStr10NativXslx2SdfProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrRepository _importPropertyStrADORepository;

		public ImportPropertyStr10NativXslx2SdfProvider(
				IImportPropertyStrRepository importPropertyStrADORepository,
				IServiceLocator serviceLocator,
				ILog log)
			: base(log, serviceLocator)
		{
			if (importPropertyStrADORepository == null) throw new ArgumentNullException("ImportPropertyStr9NativXslx2SdfProvider");
		...
		public void Import()
		{
			...
			PropertyStrParserEnum.PropertyStr10NativXslx2SdfParser,
			DomainObjectTypeEnum.PropertyStr10,
		...
		public void Clear()
		{
			this._importPropertyStrADORepository.ClearPropertyStrs(DomainObjectTypeEnum.PropertyStr10, this.ToPathDB);
		}
