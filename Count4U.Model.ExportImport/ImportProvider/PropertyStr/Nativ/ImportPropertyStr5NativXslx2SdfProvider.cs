...
{
	public class ImportPropertyStr5NativXslx2SdfProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrRepository _importPropertyStrADORepository;

		public ImportPropertyStr5NativXslx2SdfProvider(
				IImportPropertyStrRepository importPropertyStrADORepository,
				IServiceLocator serviceLocator,
				ILog log)
			: base(log, serviceLocator)
		{
			if (importPropertyStrADORepository == null) throw new ArgumentNullException("ImportPropertyStr5NativXslx2SdfProvider");
		...
		public void Import()
		{
			...
			PropertyStrParserEnum.PropertyStr5NativXslx2SdfParser,
			DomainObjectTypeEnum.PropertyStr5,
		...
		public void Clear()
		{
			this._importPropertyStrADORepository.ClearPropertyStrs(DomainObjectTypeEnum.PropertyStr5, this.ToPathDB);
		}
