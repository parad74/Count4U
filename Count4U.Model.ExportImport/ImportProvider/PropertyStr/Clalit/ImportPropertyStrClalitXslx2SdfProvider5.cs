...
{
	public class ImportPropertyStrClalitXslx2SdfProvider5 : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrRepository _importPropertyStrADORepository;

		public ImportPropertyStrClalitXslx2SdfProvider5(
		...
		public void Import()
		{
			...
			PropertyStrParserEnum.PropertyStrClalitXslx2SdfParser5,
