...
{
	public class ImportPropertyStrClalitXslx2SdfProvider2 : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrRepository _importPropertyStrADORepository;

		public ImportPropertyStrClalitXslx2SdfProvider2(
		...
		public void Import()
		{
			...
			PropertyStrParserEnum.PropertyStrClalitXslx2SdfParser2,
