...
{
	public class ImportPropertyStrClalitXslx2SdfProvider4 : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrRepository _importPropertyStrADORepository;

		public ImportPropertyStrClalitXslx2SdfProvider4(
		...
		public void Import()
		{
			...
			PropertyStrParserEnum.PropertyStrClalitXslx2SdfParser4,
