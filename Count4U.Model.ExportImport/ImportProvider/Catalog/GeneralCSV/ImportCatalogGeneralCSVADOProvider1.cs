...
{
	public class ImportCatalogGeneralCSVADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGeneralCSVADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForGeneralCSVParser1,
