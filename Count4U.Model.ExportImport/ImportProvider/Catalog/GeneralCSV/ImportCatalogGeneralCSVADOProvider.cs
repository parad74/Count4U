...
{
	public class ImportCatalogGeneralCSVADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGeneralCSVADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForGeneralCSVParser,
