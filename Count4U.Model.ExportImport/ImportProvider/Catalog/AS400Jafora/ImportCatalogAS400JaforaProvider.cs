...
{
	public class ImportCatalogAS400JaforaProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400JaforaProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400JaforaParser,
