...
{
	public class ImportCatalogYarpaWindowsADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYarpaWindowsADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForYarpaWindowsParser,
