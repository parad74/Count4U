...
{
	public class ImportCatalogYarpaWindowsADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYarpaWindowsADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForYarpaWindowsParser1,
