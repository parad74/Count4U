...
{
	public class ImportCatalogYarpaUpdateERPQuentetyWindowsADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYarpaUpdateERPQuentetyWindowsADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForYarpaUpdateERPQuentetyWindowsDBParser1,
