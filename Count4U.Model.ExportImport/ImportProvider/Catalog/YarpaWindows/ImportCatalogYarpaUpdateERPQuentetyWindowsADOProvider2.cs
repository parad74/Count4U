...
{
	public class ImportCatalogYarpaUpdateERPQuentetyWindowsADOProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYarpaUpdateERPQuentetyWindowsADOProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForYarpaUpdateERPQuentetyWindowsDBParser2,
