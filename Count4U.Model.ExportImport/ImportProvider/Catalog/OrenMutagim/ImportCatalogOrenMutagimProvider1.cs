...
{
	public class ImportCatalogOrenMutagimProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOrenMutagimProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOrenMutagimParser1,
