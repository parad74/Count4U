...
{
	public class ImportCatalogOrenMutagimProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOrenMutagimProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOrenMutagimParser,
