...
{
	public class ImportCatalogYarpaUpdateERPQuentetyADOProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYarpaUpdateERPQuentetyADOProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForYarpaUpdateERPQuentetyDBParser2,
