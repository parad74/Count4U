...
{
	public class ImportCatalogYarpaADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYarpaADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForYarpaParser,
