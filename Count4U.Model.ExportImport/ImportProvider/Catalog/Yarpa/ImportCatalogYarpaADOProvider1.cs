...
{
	public class ImportCatalogYarpaADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYarpaADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForYarpaParser1,
