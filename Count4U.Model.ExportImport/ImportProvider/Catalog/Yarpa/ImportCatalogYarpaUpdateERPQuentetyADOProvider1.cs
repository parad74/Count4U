...
{
	public class ImportCatalogYarpaUpdateERPQuentetyADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYarpaUpdateERPQuentetyADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForYarpaUpdateERPQuentetyDBParser1,
