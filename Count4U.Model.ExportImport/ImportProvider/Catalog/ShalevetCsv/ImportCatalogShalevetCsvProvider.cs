...
{												
	 // ВНИМАНИЕ !!! the same paeser used in ShalevetCsv
	public class ImportCatalogShalevetCsvProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogShalevetCsvProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNikeIntParser,
