...
{
	public class ImportCatalogMiniSoftADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMiniSoftADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMiniSoftParser,
