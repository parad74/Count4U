...
{
	public class ImportCatalogMiniSoftADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMiniSoftADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMiniSoftParser1,
