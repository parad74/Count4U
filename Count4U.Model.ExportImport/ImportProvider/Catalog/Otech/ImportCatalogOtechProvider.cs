...
{
	public class ImportCatalogOtechProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOtechProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOtechParser,
