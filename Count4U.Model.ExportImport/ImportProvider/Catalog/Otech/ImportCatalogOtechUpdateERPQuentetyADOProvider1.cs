...
{
	public class ImportCatalogOtechUpdateERPQuentetyADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOtechUpdateERPQuentetyADOProvider(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOtechUpdateERPQuentetyDBParser1,
