...
{
	public class ImportCatalogOtechProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOtechProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOtechParser2,
