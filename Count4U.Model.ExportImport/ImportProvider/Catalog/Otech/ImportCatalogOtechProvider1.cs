...
{
	public class ImportCatalogOtechProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOtechProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOtechParser1,
