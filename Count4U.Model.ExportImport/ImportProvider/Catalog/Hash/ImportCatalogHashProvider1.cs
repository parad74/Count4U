...
{
	public class ImportCatalogHashProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogHashProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogHashParser1,
