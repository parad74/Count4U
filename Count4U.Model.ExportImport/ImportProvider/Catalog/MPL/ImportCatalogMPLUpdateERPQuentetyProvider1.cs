...
{
	public class ImportCatalogMPLUpdateERPQuentetyProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMPLUpdateERPQuentetyProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMPLUpdateERPQuentetyDBParser1,
