...
{
	public class ImportCatalogXtechMeuhedetADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogXtechMeuhedetADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForXtechMeuhedetParser1,
