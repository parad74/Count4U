...
{
	public class ImportCatalogXtechMeuhedetADOProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogXtechMeuhedetADOProvider2(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForXtechMeuhedetParser2,
