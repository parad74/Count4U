...
{
	public class ImportCatalogComaxASPMultiBarcodeADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogComaxASPMultiBarcodeADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogComaxASPMultiBarcodeParser,
