...
{
	public class ImportCatalogComaxASPMultiBarcodeADOProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogComaxASPMultiBarcodeADOProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogComaxASPMultiBarcodeParser2,
