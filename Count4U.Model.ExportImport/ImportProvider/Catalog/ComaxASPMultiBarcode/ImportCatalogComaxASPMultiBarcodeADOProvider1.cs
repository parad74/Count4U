...
{
	public class ImportCatalogComaxASPMultiBarcodeADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogComaxASPMultiBarcodeADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogComaxASPMultiBarcodeParser1,
