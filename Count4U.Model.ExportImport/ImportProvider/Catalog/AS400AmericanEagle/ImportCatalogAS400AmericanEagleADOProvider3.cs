...
{
	public class ImportCatalogAS400AmericanEagleADOProvider3 : BaseProvider, IImportProvider
	{
	...
	//	private ISupplierRepository _supplierRepository;
		...
		public ImportCatalogAS400AmericanEagleADOProvider3(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400AmericanEagleParser3,
