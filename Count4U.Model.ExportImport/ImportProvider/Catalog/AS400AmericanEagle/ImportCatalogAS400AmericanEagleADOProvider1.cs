...
{
	public class ImportCatalogAS400AmericanEagleADOProvider1 : BaseProvider, IImportProvider
	{
        ...
        public ImportCatalogAS400AmericanEagleADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
                ...
                ProductSimpleParserEnum.ProductCatalogAS400AmericanEagleParser1,
