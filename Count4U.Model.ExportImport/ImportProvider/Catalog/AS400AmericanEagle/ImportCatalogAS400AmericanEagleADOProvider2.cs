...
{
	public class ImportCatalogAS400AmericanEagleADOProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400AmericanEagleADOProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400AmericanEagleParser2,
