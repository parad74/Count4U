...
namespace Count4U.Model
{
	...
	public class ImportCatalogPrioritySweetGirlXLSXProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPrioritySweetGirlXLSXProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogPrioritySweetGirlXLSXParser,
