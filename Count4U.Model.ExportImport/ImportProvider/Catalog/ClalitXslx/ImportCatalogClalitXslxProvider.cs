...
{
	public class ImportCatalogClalitXslxProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogClalitXslxProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogClalitXslx2SdfParser,
