...
{
	public class ImportCatalogPrioritytEsteeLouderXslxProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPrioritytEsteeLouderXslxProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogPrioritytEsteeLouderXslxParser,
