...
{
	public class ImportCatalogPrioritytEsteeLouderUpdateERPQuentetyProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPrioritytEsteeLouderUpdateERPQuentetyProvider(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogPrioritytEsteeLouderUpdateERPQuentetyDBParser,
