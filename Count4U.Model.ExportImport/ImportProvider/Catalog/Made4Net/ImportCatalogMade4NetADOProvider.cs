...
{
	public class ImportCatalogMade4NetADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMade4NetADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMade4NetParser,
