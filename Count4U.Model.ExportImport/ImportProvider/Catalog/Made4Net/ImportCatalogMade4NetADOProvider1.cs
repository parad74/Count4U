...
{
	public class ImportCatalogMade4NetADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMade4NetADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMade4NetParser1,
