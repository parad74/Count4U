...
{
	public class ImportCatalogAS400HonigmanProvider1 : BaseProvider, IImportProvider
	{
	...
	//	private ISupplierRepository _supplierRepository;
		...
		public ImportCatalogAS400HonigmanProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HonigmanParser1,
