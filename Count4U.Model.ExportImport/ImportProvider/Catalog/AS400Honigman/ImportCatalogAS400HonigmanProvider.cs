...
{
	public class ImportCatalogAS400HonigmanProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HonigmanProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HonigmanParser,
