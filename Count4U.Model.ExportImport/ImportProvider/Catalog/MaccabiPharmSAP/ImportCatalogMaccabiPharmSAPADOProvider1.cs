...
{
	public class ImportCatalogMaccabiPharmSAPADOProvider1 : BaseProvider, IImportProvider
	{
	...
	//	private ISupplierRepository _supplierRepository;
		...
		public ImportCatalogMaccabiPharmSAPADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMaccabiPharmSAPParser1,
