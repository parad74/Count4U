...
{
	public class ImportCatalogMaccabiPharmSAPUpdateERPQuentetyADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMaccabiPharmSAPUpdateERPQuentetyADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMaccabiPharmSAPUpdateERPQuentetyParser,
