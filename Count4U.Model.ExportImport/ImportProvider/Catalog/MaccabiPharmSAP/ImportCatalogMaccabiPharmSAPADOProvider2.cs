...
{
	public class ImportCatalogMaccabiPharmSAPADOProvider2 : BaseProvider, IImportProvider
	{
	...
	//	private ISupplierRepository _supplierRepository;
		...
		public ImportCatalogMaccabiPharmSAPADOProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMaccabiPharmSAPParser2,
