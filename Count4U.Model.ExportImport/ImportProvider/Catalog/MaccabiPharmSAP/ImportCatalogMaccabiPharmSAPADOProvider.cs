...
{
	public class ImportCatalogMaccabiPharmSAPADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMaccabiPharmSAPADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMaccabiPharmSAPParser,
