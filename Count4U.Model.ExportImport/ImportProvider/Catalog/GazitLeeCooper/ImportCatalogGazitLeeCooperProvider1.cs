...
{
	public class ImportCatalogGazitLeeCooperProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGazitLeeCooperProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogGazitLeeCooperParser1,
