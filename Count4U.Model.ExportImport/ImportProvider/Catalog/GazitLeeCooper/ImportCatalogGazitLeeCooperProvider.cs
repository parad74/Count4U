...
{
	public class ImportCatalogGazitLeeCooperProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGazitLeeCooperProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogGazitLeeCooperParser,
