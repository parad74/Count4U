...
{
	public class ImportCatalogPriorityRenuarADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPriorityRenuarADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForPriorityRenuarParser,
