...
{
	public class ImportCatalogPriorityRenuarADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPriorityRenuarADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForPriorityRenuarParser1,
