...
{
	public class ImportCatalogOrenOriginalsProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOrenOriginalsProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOrenOriginalsParser,
