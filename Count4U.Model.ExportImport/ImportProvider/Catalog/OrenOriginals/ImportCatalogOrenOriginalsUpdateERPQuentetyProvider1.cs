...
{
	public class ImportCatalogOrenOriginalsUpdateERPQuentetyProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOrenOriginalsUpdateERPQuentetyProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOrenOriginalsUpdateERPQuentetyDBParser1,
