...
{
	public class ImportCatalogXtechMeuhedetXLSXProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogXtechMeuhedetXLSXProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogXtechMeuhedetXLSXParser1,
