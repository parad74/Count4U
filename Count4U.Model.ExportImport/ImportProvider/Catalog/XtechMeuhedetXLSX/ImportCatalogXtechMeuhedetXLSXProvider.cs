...
{
	public class ImportCatalogXtechMeuhedetXLSXProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogXtechMeuhedetXLSXProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogXtechMeuhedetXLSXParser,
