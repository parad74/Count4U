...
{
	public class ImportCatalogXtechMeuhedetXLSXProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogXtechMeuhedetXLSXProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogXtechMeuhedetXLSXParser2,
