...
{
	public class ImportCatalogXtechMeuhedetXLSXUpdateERPQuentetyADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogXtechMeuhedetXLSXUpdateERPQuentetyADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogXtechMeuhedetXLSXUpdateERPQuentetyDBParser1,
