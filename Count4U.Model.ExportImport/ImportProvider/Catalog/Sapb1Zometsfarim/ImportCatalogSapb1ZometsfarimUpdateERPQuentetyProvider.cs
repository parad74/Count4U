...
{
	public class ImportCatalogSapb1ZometsfarimUpdateERPQuentetyProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogSapb1ZometsfarimUpdateERPQuentetyProvider(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogSapb1ZometsfarimUpdateERPQuentetyDBParser,
