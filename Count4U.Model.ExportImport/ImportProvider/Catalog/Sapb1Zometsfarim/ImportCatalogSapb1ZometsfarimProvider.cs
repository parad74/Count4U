...
{
	public class ImportCatalogSapb1ZometsfarimProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogSapb1ZometsfarimProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogSapb1ZometsfarimParser,
