...
{
	public class ImportCatalogSapb1ZometsfarimProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogSapb1ZometsfarimProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogSapb1ZometsfarimParser1,
