...
{
	public class ImportCatalogSapb1ZometsfarimProvider3 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogSapb1ZometsfarimProvider3(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogSapb1ZometsfarimParser3,
