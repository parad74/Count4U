...
{
	public class ImportCatalogSapb1ZometsfarimProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogSapb1ZometsfarimProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogSapb1ZometsfarimParser2,
