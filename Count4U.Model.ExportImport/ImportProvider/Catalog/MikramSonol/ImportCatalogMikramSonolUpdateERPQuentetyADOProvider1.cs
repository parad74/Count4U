...
{
	public class ImportCatalogMikramSonolUpdateERPQuentetyADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMikramSonolUpdateERPQuentetyADOProvider(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMikramSonolUpdateERPQuentetyDBParser1,
