...
{
	public class ImportCatalogMikramSonolADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMikramSonolADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMikramSonolParser,
