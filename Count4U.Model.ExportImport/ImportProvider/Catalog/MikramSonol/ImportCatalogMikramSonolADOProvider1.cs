...
{
	public class ImportCatalogMikramSonolADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMikramSonolADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMikramSonolParser1,
