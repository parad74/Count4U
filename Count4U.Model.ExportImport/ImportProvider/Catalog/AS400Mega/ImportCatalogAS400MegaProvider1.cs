...
{
	public class ImportCatalogAS400MegaProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400MegaProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400MegaParser1,
