...
{
	public class ImportCatalogAS400MegaProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400MegaProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400MegaParser,
