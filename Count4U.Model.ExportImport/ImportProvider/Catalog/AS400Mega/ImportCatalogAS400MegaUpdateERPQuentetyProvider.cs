...
{
	public class ImportCatalogAS400MegaUpdateERPQuentetyProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400MegaUpdateERPQuentetyProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400MegaUpdateERPQuentetyParser,
