...
{
	public class ImportCatalogAvivPOSADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAvivPOSADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAvivPOSParser,
