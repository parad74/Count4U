...
{
	public class ImportCatalogAvivPOSADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAvivPOSADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAvivPOSParser1,
