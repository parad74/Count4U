...
{
	public class ImportCatalogAvivPOSUpdateERPQuentetyADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAvivPOSUpdateERPQuentetyADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAvivPOSUpdateERPQuentetyDBParser1,
