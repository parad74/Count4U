...
{
	public class ImportCatalogAS400HoProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HoProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HoParser,
