...
{
	public class ImportCatalogAS400HoProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HoProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HoParser1,
		...
		{
			this.ProviderEncoding = Encoding.GetEncoding("utf-8");
