...
{
	public class ImportCatalogAS400HoProvider2_1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HoProvider2_1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HoParser2_1,
