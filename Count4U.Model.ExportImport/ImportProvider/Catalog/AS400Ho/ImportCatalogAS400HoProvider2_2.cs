...
{
	public class ImportCatalogAS400HoProvider2_2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HoProvider2_2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HoParser2_2,
