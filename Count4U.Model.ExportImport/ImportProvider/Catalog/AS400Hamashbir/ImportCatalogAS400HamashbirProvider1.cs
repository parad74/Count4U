...
{
	public class ImportCatalogAS400HamashbirProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HamashbirProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HamashbirParser1,
