...
{
	public class ImportCatalogAS400HamashbirUpdateERPQuentetyProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HamashbirUpdateERPQuentetyProvider2(
			...
			: base(log, serviceLocator)
		{
			...
			this._importTypes.Add(ImportDomainEnum.DontRefillProductMakatDictionary);
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HamashbirUpdateERPQuentetyParser2,
