...
{
	public class ImportCatalogAS400HamashbirUpdateERPQuentetyProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HamashbirUpdateERPQuentetyProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HamashbirUpdateERPQuentetyParser,
