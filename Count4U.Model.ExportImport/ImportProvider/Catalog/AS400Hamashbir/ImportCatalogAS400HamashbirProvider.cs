...
{
	public class ImportCatalogAS400HamashbirProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HamashbirProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HamashbirParser,
