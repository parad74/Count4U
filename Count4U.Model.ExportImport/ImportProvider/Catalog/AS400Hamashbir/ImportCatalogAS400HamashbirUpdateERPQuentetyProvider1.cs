...
{
	public class ImportCatalogAS400HamashbirUpdateERPQuentetyProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400HamashbirUpdateERPQuentetyProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400HamashbirUpdateERPQuentetyParser1,
