...
{
	public class ImportCatalogPriorityKedsADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPriorityKedsADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogPriorityKedsParser1,
