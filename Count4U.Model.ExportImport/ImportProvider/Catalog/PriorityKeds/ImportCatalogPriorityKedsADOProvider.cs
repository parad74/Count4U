...
{
	public class ImportCatalogPriorityKedsADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPriorityKedsADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogPriorityKedsParser,
