...
{
	public class ImportCatalogForComaxASPADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogForComaxASPADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForComaxASPParser1,
