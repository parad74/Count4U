...
{
	public class ImportCatalogForComaxASPADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogForComaxASPADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForComaxASPParser,
