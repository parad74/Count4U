...
{
	public class ImportCatalogAS400LeumitADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400LeumitADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400LeumitParser,
