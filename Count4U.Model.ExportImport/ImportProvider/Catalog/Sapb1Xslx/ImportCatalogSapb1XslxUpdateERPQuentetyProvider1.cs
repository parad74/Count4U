...
{
	public class ImportCatalogSapb1XslxUpdateERPQuentetyProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogSapb1XslxUpdateERPQuentetyProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogSapb1XslxUpdateERPQuentetyDBParser1,
