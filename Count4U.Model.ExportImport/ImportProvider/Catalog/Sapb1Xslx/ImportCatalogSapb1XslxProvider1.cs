...
{
	public class ImportCatalogSapb1XslxProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogSapb1XslxProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogSapb1XslxParser1,
