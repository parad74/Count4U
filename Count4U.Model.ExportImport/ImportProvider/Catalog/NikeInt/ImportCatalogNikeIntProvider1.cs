...
{
	public class ImportCatalogNikeIntProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNikeIntProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNikeIntParser1,
