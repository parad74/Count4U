...
{	   //не используется пока
	public class ImportCatalogNikeIntProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNikeIntProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNikeIntParser2,
