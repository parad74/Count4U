...
namespace Count4U.Model
{
	...
	public class ImportCatalogNikeIntUpdateERPQuentetyProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNikeIntUpdateERPQuentetyProvider(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNikeIntUpdateERPQuentetyDBParser,
