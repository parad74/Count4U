...
{
	public class ImportCatalogAvivMultiADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAvivMultiADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAvivMultiParser,
