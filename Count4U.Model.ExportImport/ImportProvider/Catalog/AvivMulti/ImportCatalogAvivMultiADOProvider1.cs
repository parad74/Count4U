...
{
	public class ImportCatalogAvivMultiADOProvider1 : BaseProvider, IImportProvider
	{
	...
	//	private ISupplierRepository _supplierRepository;
		...
		public ImportCatalogAvivMultiADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAvivMultiParser1,
