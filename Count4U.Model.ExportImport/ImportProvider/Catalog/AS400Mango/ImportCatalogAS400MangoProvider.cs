...
{
	public class ImportCatalogAS400MangoProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400MangoProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400MangoParser,
