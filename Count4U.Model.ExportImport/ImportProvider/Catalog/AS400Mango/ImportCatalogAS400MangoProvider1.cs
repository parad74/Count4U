...
{
	public class ImportCatalogAS400MangoProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400MangoProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400MangoParser1,
