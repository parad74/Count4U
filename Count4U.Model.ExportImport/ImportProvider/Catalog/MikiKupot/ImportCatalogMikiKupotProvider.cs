...
{
	public class ImportCatalogMikiKupotProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMikiKupotProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMikiKupotParser,
