...
{
	public class ImportCatalogPriorityCastroProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPriorityCastroProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogPriorityCastroParser1,
