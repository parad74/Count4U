...
{
	public class ImportCatalogPriorityCastroProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogPriorityCastroProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogPriorityCastroParser,
