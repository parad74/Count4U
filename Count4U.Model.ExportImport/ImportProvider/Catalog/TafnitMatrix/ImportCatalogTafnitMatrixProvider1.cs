...
{
	public class ImportCatalogTafnitMatrixProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogTafnitMatrixProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogTafnitMatrixParser1,
