...
{
	public class ImportCatalogTafnitMatrixProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogTafnitMatrixProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogTafnitMatrixParser2,
