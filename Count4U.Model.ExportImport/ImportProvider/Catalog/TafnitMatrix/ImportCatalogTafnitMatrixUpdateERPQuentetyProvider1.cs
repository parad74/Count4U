...
{
	public class ImportCatalogTafnitMatrixUpdateERPQuentetyProvider : BaseProvider, IImportProvider
	{
        ...
        public ImportCatalogTafnitMatrixUpdateERPQuentetyProvider(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
                ...
                ProductSimpleParserEnum.ProductCatalogTafnitMatrixUpdateERPQuentetyDBParser,
