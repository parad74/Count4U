...
namespace Count4U.Model
{
	...
	public class ImportCatalogYtungXlsxProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYtungXlsxProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogYtungXlsxParser,
