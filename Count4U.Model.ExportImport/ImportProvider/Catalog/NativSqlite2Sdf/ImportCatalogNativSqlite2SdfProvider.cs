...
{
	public class ImportCatalogNativSqlite2SdfProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNativSqlite2SdfProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNativSqlite2SdfParser,
