...
{
	public class ImportCatalogNativMISSqlite2SdfProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNativMISSqlite2SdfProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNativMISSqlite2SdfParser,
