...
{
	public class ImportCatalogRetalixNextBulkProvider : BaseProvider, IImportProvider
	{
		private readonly IImportCatalogBlukRepository _importCatalogBlukRepository;

		public ImportCatalogRetalixNextBulkProvider(
		...
		public void Import()
		{
			...
			this._importCatalogBlukRepository.InsertProduct(this.FromPathFile, this.ToPathDB,
				ProductSimpleParserEnum.ProductRetalixNextParser,
