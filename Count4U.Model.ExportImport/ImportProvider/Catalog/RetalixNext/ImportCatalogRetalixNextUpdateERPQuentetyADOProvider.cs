...
{
	public class ImportCatalogRetalixNextUpdateERPQuentetyADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogRetalixNextUpdateERPQuentetyADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductRetalixNextUpdateERPQuentetyDBParser,
