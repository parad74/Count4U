...
{
	public class ImportCatalogRetalixNextADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogRetalixNextADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogRetalixNextParser,
