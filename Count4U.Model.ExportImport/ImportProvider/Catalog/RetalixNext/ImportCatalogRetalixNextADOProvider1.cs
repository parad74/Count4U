...
{
	public class ImportCatalogRetalixNextADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogRetalixNextADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogRetalixNextParser1,
