...
{
	public class ImportCatalogAS400AprilProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400AprilProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400AprilParser,
