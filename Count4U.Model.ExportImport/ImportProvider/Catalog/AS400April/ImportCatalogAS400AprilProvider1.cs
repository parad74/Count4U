...
{
	public class ImportCatalogAS400AprilProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400AprilProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400AprilParser1,
