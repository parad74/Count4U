...
{
	public class ImportCatalogAS400AprilUpdateERPQuentetyProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAS400AprilUpdateERPQuentetyProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAS400AprilUpdateERPQuentetyParser,
