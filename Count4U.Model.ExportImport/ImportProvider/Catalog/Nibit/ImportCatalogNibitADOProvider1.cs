...
{
	public class ImportCatalogNibitADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNibitADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNibitParser1,
