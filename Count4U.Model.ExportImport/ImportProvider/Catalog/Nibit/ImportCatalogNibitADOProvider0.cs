...
{
	public class ImportCatalogNibitADOProvider0 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNibitADOProvider0(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNibitParser0,
