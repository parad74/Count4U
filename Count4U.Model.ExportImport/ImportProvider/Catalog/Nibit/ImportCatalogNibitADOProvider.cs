...
{
	public class ImportCatalogNibitADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNibitADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNibitParser,
