...
{
	public class ImportCatalogNibitUpdateERPQuentetyADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNibitUpdateERPQuentetyADOProvider(
			...
			: base(log, serviceLocator)
		{
			...
			this._countExcludeFirstString = 9;
		}
		...
		public  void Import()
		{
			...
			if (File.Exists(this.FromPathFile) == false) return;
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNibitUpdateERPQuentetyDBParser,
