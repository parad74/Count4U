...
{												
	public class ImportCatalogNativPlusLadpcProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNativPlusLadpcProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNativPlusLadpcParser,
