...
namespace Count4U.Model
{
	...
	public class ImportHamarotGazitVerifoneADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportHamarotGazitVerifoneADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductHamarotForGazitVerifoneParser1,
