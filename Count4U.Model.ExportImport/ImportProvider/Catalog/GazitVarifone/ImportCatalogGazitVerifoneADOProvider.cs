...
namespace Count4U.Model
{
	...
	public class ImportCatalogGazitVerifoneADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGazitVerifoneADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForGazitVerifoneParser,
