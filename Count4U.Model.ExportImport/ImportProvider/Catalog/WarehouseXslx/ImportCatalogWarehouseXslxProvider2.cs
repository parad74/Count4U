...
{	  
	public class ImportCatalogWarehouseXslxProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogWarehouseXslxProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogWarehouseXslxParser2,
