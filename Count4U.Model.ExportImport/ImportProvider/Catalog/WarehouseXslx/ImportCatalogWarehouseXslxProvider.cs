...
{												
	public class ImportCatalogWarehouseXslxProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogWarehouseXslxProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogWarehouseXslxParser,
