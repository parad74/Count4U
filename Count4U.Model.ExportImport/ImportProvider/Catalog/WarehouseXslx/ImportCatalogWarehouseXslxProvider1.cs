...
{
	public class ImportCatalogWarehouseXslxProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogWarehouseXslxProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogWarehouseXslxParser1,
