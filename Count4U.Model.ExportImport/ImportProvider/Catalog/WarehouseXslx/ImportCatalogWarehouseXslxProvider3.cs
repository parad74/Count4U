...
{
	public class ImportCatalogWarehouseXslxProvider3 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogWarehouseXslxProvider3(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogWarehouseXslxParser3,
