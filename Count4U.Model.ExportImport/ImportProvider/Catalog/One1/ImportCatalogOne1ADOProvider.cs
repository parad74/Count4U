...
{
	public class ImportCatalogOne1ADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOne1ADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOne1Parser,
