...
{
	public class ImportCatalogOne1UpdateERPQuentetyADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogOne1UpdateERPQuentetyADOProvider(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogOne1UpdateERPQuentetyDBParser1,
