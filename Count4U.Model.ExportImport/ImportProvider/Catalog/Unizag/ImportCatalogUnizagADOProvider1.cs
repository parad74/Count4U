...
{
	public class ImportCatalogUnizagADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogUnizagADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForUnizagParser1,
