...
{
	public class ImportCatalogUnizagADOProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogUnizagADOProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForUnizagParser2,
