...
{
	public class ImportCatalogUnizagADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogUnizagADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForUnizagParser,
