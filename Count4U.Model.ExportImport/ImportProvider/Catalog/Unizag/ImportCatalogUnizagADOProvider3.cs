...
{
	public class ImportCatalogUnizagADOProvider3 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogUnizagADOProvider3(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForUnizagParser3,
