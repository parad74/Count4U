...
{
	public class ImportCatalogMerkavaXslxProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMerkavaXslxProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMerkavaXslx2SdfParser1,
