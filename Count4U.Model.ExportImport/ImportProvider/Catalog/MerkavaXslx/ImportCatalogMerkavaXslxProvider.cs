...
{
	public class ImportCatalogMerkavaXslxProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogMerkavaXslxProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogMerkavaXslx2SdfParser,
