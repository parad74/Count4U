...
{
	public class ImportCatalogLadyComfortADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogLadyComfortADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogLadyComfortParser,
