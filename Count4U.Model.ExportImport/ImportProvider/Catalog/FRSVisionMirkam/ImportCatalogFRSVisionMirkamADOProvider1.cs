...
{
	public class ImportCatalogFRSVisionMirkamADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogFRSVisionMirkamADOProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogFRSVisionMirkamParser1,
