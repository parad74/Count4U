...
{
	public class ImportCatalogFRSVisionMirkamADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogFRSVisionMirkamADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogFRSVisionMirkamParser,
