...
{
	public class ImportCatalogGeneralXLSXUpdateERPQuentetyADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGeneralXLSXUpdateERPQuentetyADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForGeneralXLSXUpdateERPQuentetyDBParser1,
