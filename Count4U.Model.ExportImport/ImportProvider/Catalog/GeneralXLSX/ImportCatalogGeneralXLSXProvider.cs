...
{
	public class ImportCatalogGeneralXLSXProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGeneralXLSXProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForGeneralXLSXParser,
