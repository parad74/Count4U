...
{
	public class ImportCatalogGeneralXLSXProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGeneralXLSXProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForGeneralXLSXParser1,
