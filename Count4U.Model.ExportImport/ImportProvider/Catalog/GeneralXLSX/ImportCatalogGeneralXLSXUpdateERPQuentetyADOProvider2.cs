...
{
	public class ImportCatalogGeneralXLSXUpdateERPQuentetyADOProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGeneralXLSXUpdateERPQuentetyADOProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForGeneralXLSXUpdateERPQuentetyDBParser2,
