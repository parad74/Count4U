...
{
	public class ImportCatalogNativXslxUpdateERPQuentetyProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNativXslxUpdateERPQuentetyProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNativXslx2SdfUpdateERPQuentetyDBParser1,
