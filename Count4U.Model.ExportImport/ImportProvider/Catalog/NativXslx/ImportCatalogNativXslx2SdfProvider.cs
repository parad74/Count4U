...
{
	public class ImportCatalogNativXslx2SdfProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNativXslx2SdfProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNativXslx2SdfParser,
