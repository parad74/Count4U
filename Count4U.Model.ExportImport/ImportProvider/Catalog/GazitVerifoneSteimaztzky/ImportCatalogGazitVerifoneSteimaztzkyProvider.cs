...
{
	public class ImportCatalogGazitVerifoneSteimaztzkyProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGazitVerifoneSteimaztzkyProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogGazitVerifoneSteimaztzkyParser,
