...
{
	public class ImportCatalogGazitVerifoneSteimaztzkyProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGazitVerifoneSteimaztzkyProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogGazitVerifoneSteimaztzkyParser1,
