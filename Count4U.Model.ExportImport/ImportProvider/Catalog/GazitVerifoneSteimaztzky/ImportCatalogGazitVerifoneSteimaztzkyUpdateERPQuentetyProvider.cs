...
{
	public class ImportCatalogGazitVerifoneSteimaztzkyUpdateERPQuentetyProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGazitVerifoneSteimaztzkyUpdateERPQuentetyProvider(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogGazitVerifoneSteimaztzkyUpdateERPQuentetyDBParser,
