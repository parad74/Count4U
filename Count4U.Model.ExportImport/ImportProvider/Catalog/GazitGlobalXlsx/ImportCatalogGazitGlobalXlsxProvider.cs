...
namespace Count4U.Model
{
	...
	public class ImportCatalogGazitGlobalXlsxProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogGazitGlobalXlsxProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogGazitGlobalXlsxParser,
