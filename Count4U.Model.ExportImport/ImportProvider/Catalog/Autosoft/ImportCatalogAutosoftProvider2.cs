...
{
	public class ImportCatalogAutosoftProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAutosoftProvider2(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAutosoftParser2,
