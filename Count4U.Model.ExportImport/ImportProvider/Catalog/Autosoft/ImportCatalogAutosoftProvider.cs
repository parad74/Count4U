...
{
	public class ImportCatalogAutosoftProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAutosoftProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAutosoftParser,
