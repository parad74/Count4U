...
{
	public class ImportCatalogAutosoftProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogAutosoftProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogAutosoftParser1,
