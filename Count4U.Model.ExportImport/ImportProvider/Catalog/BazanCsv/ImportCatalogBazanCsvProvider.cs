...
{
	public class ImportCatalogBazanCsvProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogBazanCsvProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNesherParser,
