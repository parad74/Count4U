...
{
	public class ImportCatalogNimrodAvivProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNimrodAvivProvider1(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNimrodAvivParser1,
