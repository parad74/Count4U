...
{
	public class ImportCatalogNimrodAvivProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNimrodAvivProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNimrodAvivParser,
