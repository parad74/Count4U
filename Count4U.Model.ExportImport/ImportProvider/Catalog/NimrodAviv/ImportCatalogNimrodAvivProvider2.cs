...
{
	public class ImportCatalogNimrodAvivProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNimrodAvivProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogNimrodAvivParser2,
