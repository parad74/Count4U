...
{												
	public class ImportCatalogYesXlsxProviderQ : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYesXlsxProviderQ(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogYesXslxParserQ,
