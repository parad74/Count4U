...
{
	public class ImportCatalogYesXlsxProviderSN : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogYesXlsxProviderSN(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogYesXslxParserSN,
