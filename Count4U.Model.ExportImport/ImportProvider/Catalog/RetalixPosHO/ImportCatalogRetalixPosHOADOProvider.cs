...
{
	public class ImportCatalogRetalixPosHOADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogRetalixPosHOADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductRetalixPosHOParser,
