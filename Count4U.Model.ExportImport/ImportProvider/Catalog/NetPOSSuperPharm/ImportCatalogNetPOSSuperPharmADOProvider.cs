...
{
	public class ImportCatalogNetPOSSuperPharmADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNetPOSSuperPharmADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForNetPOSSuperPharmParser,
