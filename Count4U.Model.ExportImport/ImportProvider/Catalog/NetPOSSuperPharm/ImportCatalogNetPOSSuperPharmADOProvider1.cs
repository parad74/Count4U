...
{
	public class ImportCatalogNetPOSSuperPharmADOProvider1 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNetPOSSuperPharmADOProvider1(
		...
		public  void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogForNetPOSSuperPharmParser1,
