...
{
	public class ImportCatalogNetPOSSuperPharmUpdateERPQuentetyADOProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogNetPOSSuperPharmUpdateERPQuentetyADOProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductNetPOSSuperPharmParserUpdateERPQuentetyDBParser,
