...
{
	public class ImportCatalogH_M_NewProvider3 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogH_M_NewProvider3(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogH_M_NewParser3,
