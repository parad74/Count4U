...
{
	public class ImportCatalogH_M_NewProvider : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogH_M_NewProvider(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogH_M_NewParser,
