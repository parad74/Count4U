...
{
	public class ImportCatalogH_M_NewProvider2 : BaseProvider, IImportProvider
	{
		...
		public ImportCatalogH_M_NewProvider2(
		...
		public void Import()
		{
			...
			if (this.FastImport == true)
			{
				...
				ProductSimpleParserEnum.ProductCatalogH_M_NewParser2,
