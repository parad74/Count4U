...
{			 //ImportFamilyGeneralXLSXProvider
	public class ImportSupplierGeneralXLSXProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSupplierRepository _importSupplierRepository;

		public ImportSupplierGeneralXLSXProvider(IImportSupplierRepository importSupplierRepository,
		...
		public void Import()
		{
			...
			this._importSupplierRepository.InsertSuppliers(this.FromPathFile, this.ToPathDB,
				SupplierParserEnum.SupplierGeneralXLSXParser,
