...
{
	public class ImportSupplierSapb1ZometsfarimProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSupplierRepository _importSupplierRepository;

		public ImportSupplierSapb1ZometsfarimProvider(IImportSupplierRepository importSupplierRepository,
		...
		public void Import()
		{
			...
			this._importSupplierRepository.InsertSuppliers(this.FromPathFile, this.ToPathDB,
				SupplierParserEnum.SupplierSapb1ZometsfarimParser,
