...
{
	public class ImportSupplierNibitADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSupplierRepository _importSupplierRepository;

		public ImportSupplierNibitADOProvider(IImportSupplierRepository importSupplierRepository,
		...
		public void Import()
		{
			...
			this._importSupplierRepository.InsertSuppliers(this.FromPathFile, this.ToPathDB,
				SupplierParserEnum.SupplierNibitParser,
