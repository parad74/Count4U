...
{
	public class ImportSupplierComaxASPADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSupplierRepository _importSupplierRepository;

		public ImportSupplierComaxASPADOProvider(IImportSupplierRepository importSupplierRepository,
		...
		public void Import()
		{
			...
			this._importSupplierRepository.InsertSuppliers(this.FromPathFile, this.ToPathDB,
				SupplierParserEnum.SupplierComaxASPParser,
