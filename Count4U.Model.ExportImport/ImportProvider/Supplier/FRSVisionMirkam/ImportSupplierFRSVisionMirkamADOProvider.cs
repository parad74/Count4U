...
{
	public class ImportSupplierFRSVisionMirkamADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSupplierRepository _importSupplierRepository;

		public ImportSupplierFRSVisionMirkamADOProvider(IImportSupplierRepository importSupplierRepository,
		...
		public void Import()
		{
			...
			this._importSupplierRepository.InsertSuppliers(this.FromPathFile, this.ToPathDB,
				SupplierParserEnum.SupplierFRSVisionMirkamParser,
