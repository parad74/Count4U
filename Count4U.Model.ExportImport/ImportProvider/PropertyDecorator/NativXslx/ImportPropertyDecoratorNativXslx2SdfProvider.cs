...
{
	public class ImportPropertyDecoratorNativXslx2SdfProvider : BaseProvider, IImportProvider
	{
	//	private readonly IImportBuildingConfigADORepository _importBuildingConfigADORepository;
		...
		public ImportPropertyDecoratorNativXslx2SdfProvider(
			...
			: base(log, serviceLocator)
	    {
			...
			if (importPropertyStrADORepository == null) throw new ArgumentNullException("ImportPropertyDecoratorNativXslx2SdfProvider");
		...
		PropertyStrParserEnum.PropertyStrPropertyDecoratorNativXslx2SdfParser,
		DomainObjectTypeEnum.PropertyDecorator,
		...
		//	this._importBuildingConfigADORepository.ClearBuildingConfig(this.ToPathDB);
			this._importPropertyStrADORepository.ClearPropertyStrs(DomainObjectTypeEnum.PropertyDecorator, this.ToPathDB);
		}
