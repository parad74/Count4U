...
{
	public class ImportPropertyDecoratorNativExportErpProvider1 : BaseProvider, IImportProvider
	{
	//	private readonly IImportBuildingConfigADORepository _importBuildingConfigADORepository;
		...
		public ImportPropertyDecoratorNativExportErpProvider1(
		...
		PropertyStrParserEnum.PropertyStrPropertyDecoratorNativExportErpParser1,
		DomainObjectTypeEnum.PropertyExportErpDecorator1,
		...
		//	this._importBuildingConfigADORepository.ClearBuildingConfig(this.ToPathDB);
			this._importPropertyStrADORepository.ClearPropertyStrs(DomainObjectTypeEnum.PropertyExportErpDecorator1, this.ToPathDB);
		}
