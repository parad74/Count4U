...
{
	public class ImportPropertyDecoratorNativExportErpProvider3 : BaseProvider, IImportProvider
	{
	//	private readonly IImportBuildingConfigADORepository _importBuildingConfigADORepository;
		...
		public ImportPropertyDecoratorNativExportErpProvider3(
		...
		PropertyStrParserEnum.PropertyStrPropertyDecoratorNativExportErpParser3,
		DomainObjectTypeEnum.PropertyExportErpDecorator3,
		...
		//	this._importBuildingConfigADORepository.ClearBuildingConfig(this.ToPathDB);
			this._importPropertyStrADORepository.ClearPropertyStrs(DomainObjectTypeEnum.PropertyExportErpDecorator3, this.ToPathDB);
		}
