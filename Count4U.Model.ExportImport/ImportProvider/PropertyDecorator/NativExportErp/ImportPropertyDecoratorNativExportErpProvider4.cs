...
{
	public class ImportPropertyDecoratorNativExportErpProvider4 : BaseProvider, IImportProvider
	{
	//	private readonly IImportBuildingConfigADORepository _importBuildingConfigADORepository;
		...
		public ImportPropertyDecoratorNativExportErpProvider4(
		...
		PropertyStrParserEnum.PropertyStrPropertyDecoratorNativExportErpParser4,
		DomainObjectTypeEnum.PropertyExportErpDecorator4,
		...
		//	this._importBuildingConfigADORepository.ClearBuildingConfig(this.ToPathDB);
			this._importPropertyStrADORepository.ClearPropertyStrs(DomainObjectTypeEnum.PropertyExportErpDecorator4, this.ToPathDB);
		}
