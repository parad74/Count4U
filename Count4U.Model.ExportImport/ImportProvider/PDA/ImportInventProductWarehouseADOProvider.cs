...
{
	public class ImportInventProductWarehouseADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportInventProductRepository _importInventProductRepository;

		public ImportInventProductWarehouseADOProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductWarehouseParser,
