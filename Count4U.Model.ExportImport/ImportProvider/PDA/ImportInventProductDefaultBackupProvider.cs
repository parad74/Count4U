...
{
	public class ImportInventProductDefaultBackupProvider : BaseProvider, IImportProvider
	{
		private readonly IImportInventProductRepository _importInventProductRepository;

		public ImportInventProductDefaultBackupProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductDefaultBackupParser,
