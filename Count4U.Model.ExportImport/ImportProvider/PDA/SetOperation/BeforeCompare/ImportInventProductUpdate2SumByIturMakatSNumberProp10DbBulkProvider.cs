...
{
	public class ImportInventProductUpdate2SumByIturMakatSNumberProp10DbBulkProvider : BaseProvider, IImportProvider
	{
...
//		public SqlCeBulkCopyColumnMappingCollection ColumnMappings { set; get; }
		...
		public ImportInventProductUpdate2SumByIturMakatSNumberProp10DbBulkProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductUpdate2SumByIturMakatSNumberProp10FromDBParser,	 		 //InventProductUpdate2SumByIturMakatSNumberProp10FromDBParser
