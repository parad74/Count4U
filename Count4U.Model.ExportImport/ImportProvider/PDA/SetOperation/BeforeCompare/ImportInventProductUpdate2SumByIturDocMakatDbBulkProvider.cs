...
{
	public class ImportInventProductUpdate2SumByIturDocMakatDbBulkProvider : BaseProvider, IImportProvider
	{
...
//		public SqlCeBulkCopyColumnMappingCollection ColumnMappings { set; get; }
		...
		public ImportInventProductUpdate2SumByIturDocMakatDbBulkProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductUpdate2SumByIturDocMakatFromDBParser,	 
