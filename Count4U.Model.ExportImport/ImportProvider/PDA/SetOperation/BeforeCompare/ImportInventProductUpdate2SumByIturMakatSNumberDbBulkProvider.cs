...
{
	public class ImportInventProductUpdate2SumByIturMakatSNumberDbBulkProvider : BaseProvider, IImportProvider
	{
...
//		public SqlCeBulkCopyColumnMappingCollection ColumnMappings { set; get; }
		...
		public ImportInventProductUpdate2SumByIturMakatSNumberDbBulkProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductUpdate2SumByIturMakatSNumberFromDBParser,	 
