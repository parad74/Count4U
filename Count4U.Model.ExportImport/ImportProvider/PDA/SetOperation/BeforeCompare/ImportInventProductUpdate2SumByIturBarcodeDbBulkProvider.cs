...
{
	public class ImportInventProductUpdate2SumByIturBarcodeDbBulkProvider : BaseProvider, IImportProvider
	{
...
//		public SqlCeBulkCopyColumnMappingCollection ColumnMappings { set; get; }
		...
		public ImportInventProductUpdate2SumByIturBarcodeDbBulkProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductUpdate2SumByIturBarcodeFromDBParser,	 
