...
{
	public class ImportInventProductBulkUpdateProvider : BaseProvider, IImportProvider
	{
...
//		public SqlCeBulkCopyColumnMappingCollection ColumnMappings { set; get; }
		...
		public ImportInventProductBulkUpdateProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductUpdateDBParser,	 
