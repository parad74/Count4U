...
{
	public class ImportInventProductAfterCompareFromDbBulkProvider : BaseProvider, IImportProvider
	{
...
//		public SqlCeBulkCopyColumnMappingCollection ColumnMappings { set; get; }
		...
		public ImportInventProductAfterCompareFromDbBulkProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductFromDBAfterCompareParser,	 
