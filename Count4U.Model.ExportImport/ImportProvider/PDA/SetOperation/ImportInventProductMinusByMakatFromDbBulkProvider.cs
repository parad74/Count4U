...
{
	public class ImportInventProductMinusByMakatFromDbBulkProvider : BaseProvider, IImportProvider
	{
...
//		public SqlCeBulkCopyColumnMappingCollection ColumnMappings { set; get; }
		...
		public ImportInventProductMinusByMakatFromDbBulkProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductMinusByMakatFromDBParser,	 
