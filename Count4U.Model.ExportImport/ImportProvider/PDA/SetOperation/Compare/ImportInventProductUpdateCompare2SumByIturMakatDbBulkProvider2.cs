...
{
	public class ImportInventProductUpdateCompare2SumByIturMakatDbBulkProvider2 : BaseProvider, IImportProvider
	{
...
//		public SqlCeBulkCopyColumnMappingCollection ColumnMappings { set; get; }
		...
		public ImportInventProductUpdateCompare2SumByIturMakatDbBulkProvider2(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductUpdateCompare2SumByIturMakatFromDBParser2,	 
