...
{
	public class ImportInventProductYesXlsxProviderSN : BaseProvider, IImportProvider
	{
		...
		public ImportInventProductYesXlsxProviderSN(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductYesXlsxParserSN,
