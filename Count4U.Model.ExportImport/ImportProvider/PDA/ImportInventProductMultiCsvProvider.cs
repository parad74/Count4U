...
{
	public class ImportInventProductMultiCsvProvider : BaseProvider, IImportProvider
	{
		...
		public ImportInventProductMultiCsvProvider(
			...
			: base(log, serviceLocator)
		{
			...
			this._importTypes.Add(ImportDomainEnum.RefillMakatDictionary);
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductMultiCsvParser,
		...
		public void Clear()
		{
			...
			this._importInventProductRepository.ClearItur(this.ToPathDB);
		}
	}
}	   	
