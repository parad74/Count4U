...
{
	public class ImportInventProductAdvancedYarpaADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportInventProductRepository _importInventProductRepository;

		public ImportInventProductAdvancedYarpaADOProvider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductSimpleYarpaParser,	 
