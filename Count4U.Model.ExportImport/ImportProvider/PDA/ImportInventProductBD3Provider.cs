...
{
	public class ImportInventProductBD3Provider : BaseProvider, IImportProvider
	{
		private readonly IImportInventProductRepository _importInventProductRepository;

		public ImportInventProductBD3Provider(
		...
		public void Import()
		{
			...
			InventProductSimpleParserEnum.InventProductDB3Parser,
