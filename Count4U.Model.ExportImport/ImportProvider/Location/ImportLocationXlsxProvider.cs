...
{
	public class ImportLocationXlsxProvider : BaseProvider, IImportProvider
	{
		private readonly IImportLocationRepository _importLocationADORepository;

		public ImportLocationXlsxProvider(IImportLocationRepository importLocationRepository,
		...
		public void Import()
		{
			...
			LocationParserEnum.LocationXlsxParser,
