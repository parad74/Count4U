...
{
	public class ImportEmulationLocationADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportLocationRepository _importLocationADORepository;

		public ImportEmulationLocationADOProvider(IImportLocationRepository importLocationRepository,
		...
		public void Import()
		{
			...
			LocationParserEnum.LocationEmulationParser,
