...
{
	public class ImportLocationUpdateMerkavaSqlite2SdfProvider : BaseProvider, IImportProvider
	{
		...
		public ImportLocationUpdateMerkavaSqlite2SdfProvider(
		...
		public void Import()
		{
			...
			//LocationParserEnum.LocationUpdateMerkavaSqlite2SdfParser,
			...
			this._importIturBulkRepository.InsertIturs(
				this.FromPathFile, 	  //db3Path		  sqlite	
				this.ToPathDB,			//GetDbPath		Count4U	
				IturParserEnum.IturUpdateMerkavaSqlite2SdfParser,
				this.ProviderEncoding, this._separators, this._countExcludeFirstString,
				this._importTypes, this.Parms);
