...
{
	public class ImportLocationMerkavaXslx2SdfProvider : BaseProvider, IImportProvider
	{
		private readonly IImportLocationRepository _importLocationADORepository;

		public ImportLocationMerkavaXslx2SdfProvider(
		...
		public void Import()
		{
			...
			LocationParserEnum.LocationMerkavaXslx2SdfParser,
