...
{
	public class ImportLocationADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportLocationRepository _importLocationADORepository;

		public ImportLocationADOProvider(IImportLocationRepository importLocationRepository,
		...
		public void Import()
		{
			...
			LocationParserEnum.LocationParser,
