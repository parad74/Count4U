...
{
	public class ImportLocationUpdateNativXslx2SdfProvider : BaseProvider, IImportProvider
	{
		...
		public ImportLocationUpdateNativXslx2SdfProvider(
		...
		public void Import()
		{
			...
			LocationParserEnum.LocationNativXslx2SdfParser,
			...
			this._importIturBulkRepository.InsertIturs(
				...
				IturParserEnum.IturUpdateNativXslx2SdfParser,
				this.ProviderEncoding, this._separators, this._countExcludeFirstString,
				this._importTypes, this.Parms);
		}
