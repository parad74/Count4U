...
{
	public class ImportLocationUpdateNativSqlite2SdfProvider : BaseProvider, IImportProvider
	{
		...
		public ImportLocationUpdateNativSqlite2SdfProvider(
		...
		public void Import()
		{
			...
			this._importIturBulkRepository.InsertIturs(
				this.FromPathFile, 	  //db3Path		  sqlite	
				this.ToPathDB,			//GetDbPath		Count4U	
				IturParserEnum.IturUpdateNativSqlite2SdfParser,
				this.ProviderEncoding, this._separators, this._countExcludeFirstString,
				this._importTypes, this.Parms);
