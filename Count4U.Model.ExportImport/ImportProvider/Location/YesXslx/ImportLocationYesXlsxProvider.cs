...
{
	public class ImportLocationYesXlsxProvider : BaseProvider, IImportProvider
	{
		private readonly IImportLocationRepository _importLocationADORepository;

		public ImportLocationYesXlsxProvider(IImportLocationRepository importLocationRepository,
		...
		public void Import()
		{
			...
			LocationParserEnum.LocationYesXlsxParser,
