...
{
	public class ImportLocationFromDBADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportLocationRepository _importLocationADORepository;

		public ImportLocationFromDBADOProvider(IImportLocationRepository importLocationRepository,
		...
		public void Import()
		{
			...
			LocationParserEnum.LocationFromDBParser,
