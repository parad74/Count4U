...
{
	public class ImportPropertyStr7ListMerkavaSqliteXslxProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrListSQLiteADORepository _importPropertyStrListADORepository;

		public ImportPropertyStr7ListMerkavaSqliteXslxProvider(
		...
		public void Import()
		{
			...
			this._importPropertyStrListADORepository.InsertPropertyStrList(
  			...
  			PropertyStrListSQLiteTableNameEnum.PropertyStr7List,
			PropStrCodeEnum.PropStr7Code,
 			PropStrNameEnum.PropStr7Name, 
		
			PropertyStrListSQLiteParserEnum.PropertyStrListDefaultXslx2SqliteParser,
			DomainObjectTypeEnum.PropertyStr7,
		...
		public void Clear()
		{
			this._importPropertyStrListADORepository.ClearPropertyStrList(
				PropertyStrListSQLiteTableNameEnum.PropertyStr7List.ToString(), this.ToPathDB);
		}
