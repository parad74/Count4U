...
{
	public class ImportPropertyStr1ListNativSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrListSQLiteADORepository _importPropertyStrListADORepository;

		public ImportPropertyStr1ListNativSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			PropertyStrListSQLiteTableNameEnum.PropertyStr1List,
			PropStrCodeEnum.PropStr1Code,
			PropStrNameEnum.PropStr1Name,
		...
		public void Clear()
		{
			this._importPropertyStrListADORepository.ClearPropertyStrList(
				PropertyStrListSQLiteTableNameEnum.PropertyStr1List.ToString(), this.ToPathDB);
		}
