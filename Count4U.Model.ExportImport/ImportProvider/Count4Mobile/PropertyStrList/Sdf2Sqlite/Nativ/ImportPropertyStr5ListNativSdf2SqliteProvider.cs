...
{
	public class ImportPropertyStr5ListNativSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrListSQLiteADORepository _importPropertyStrListADORepository;

		public ImportPropertyStr5ListNativSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			PropertyStrListSQLiteTableNameEnum.PropertyStr5List,
			PropStrCodeEnum.PropStr5Code,
			PropStrNameEnum.PropStr5Name,
		...
		public void Clear()
		{
			this._importPropertyStrListADORepository.ClearPropertyStrList(
				PropertyStrListSQLiteTableNameEnum.PropertyStr5List.ToString(), this.ToPathDB);
		}
