...
{
	public class ImportPropertyStr9ListNativSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPropertyStrListSQLiteADORepository _importPropertyStrListADORepository;

		public ImportPropertyStr9ListNativSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			this.FromPathFile, 		  //GetDbPath		Count4U
  			...
  			PropertyStrListSQLiteTableNameEnum.PropertyStr9List,
			PropStrCodeEnum.PropStr9Code,
 			PropStrNameEnum.PropStr9Name,
		...
		public void Clear()
		{
			this._importPropertyStrListADORepository.ClearPropertyStrList(
				PropertyStrListSQLiteTableNameEnum.PropertyStr9List.ToString(), this.ToPathDB);
		}
