...
{
	public class ImportBuildingConfigClalitSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportBuildingConfigSQLiteADORepository _importBuildingConfigSQLiteADORepository;

		public ImportBuildingConfigClalitSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			BuildingConfigParserEnum.BuildingConfigClalitSdf2SqliteParser,
