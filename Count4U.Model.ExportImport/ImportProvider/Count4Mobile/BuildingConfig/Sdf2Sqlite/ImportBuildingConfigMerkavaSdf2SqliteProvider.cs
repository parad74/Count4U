...
{
	public class ImportBuildingConfigMerkavaSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportBuildingConfigSQLiteADORepository _importBuildingConfigSQLiteADORepository;

		public ImportBuildingConfigMerkavaSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			BuildingConfigParserEnum.BuildingConfigMerkavaSdf2SqliteParser,
