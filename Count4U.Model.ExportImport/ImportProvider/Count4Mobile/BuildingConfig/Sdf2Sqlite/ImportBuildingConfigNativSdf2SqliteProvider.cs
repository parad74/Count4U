...
{
	public class ImportBuildingConfigNativSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportBuildingConfigSQLiteADORepository _importBuildingConfigSQLiteADORepository;

		public ImportBuildingConfigNativSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			BuildingConfigParserEnum.BuildingConfigNativSdf2SqliteParser,
