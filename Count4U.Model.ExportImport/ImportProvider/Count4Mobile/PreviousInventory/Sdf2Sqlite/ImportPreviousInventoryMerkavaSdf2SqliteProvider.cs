...
{
	public class ImportPreviousInventoryMerkavaSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPreviousInventorysSQLiteADORepository _importPreviousInventorysSQLiteADORepository;

		public ImportPreviousInventoryMerkavaSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			PreviousInventorySQLiteParserEnum.PreviousInventoryMerkavaSdf2SqliteParser,
