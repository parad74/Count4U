...
{
	public class ImportPreviousInventoryNativSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPreviousInventorysSQLiteADORepository _importPreviousInventorysSQLiteADORepository;

		public ImportPreviousInventoryNativSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			PreviousInventorySQLiteParserEnum.PreviousInventoryNativSdf2SqliteParser,
