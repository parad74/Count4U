...
namespace Count4U.Model
{
	...
	public class ImportCatalogClalitSdf2SqliteProvider  : BaseProvider, IImportProvider
	{
		private readonly IImportCatalogSQLiteADORepository _importCatalogSQLiteADORepository;

		public ImportCatalogClalitSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			this._importCatalogSQLiteADORepository.InsertCatalogs(this.FromPathFile, 
				this.ToPathDB,
				CatalogSQLiteParserEnum.CatalogClalitSdf2SqliteParser,
