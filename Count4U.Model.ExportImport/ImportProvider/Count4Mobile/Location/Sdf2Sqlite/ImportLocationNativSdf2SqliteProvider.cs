...
{
	public class ImportLocationNativSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportLocationSQLiteADORepository _importLocationADORepository;

		public ImportLocationNativSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			LocationSQLiteParserEnum.LocationNativSdf2SqliteParser,
