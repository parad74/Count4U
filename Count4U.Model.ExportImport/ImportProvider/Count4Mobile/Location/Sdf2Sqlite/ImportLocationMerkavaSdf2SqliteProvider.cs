...
{
	public class ImportLocationMerkavaSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportLocationSQLiteADORepository _importLocationADORepository;

		public ImportLocationMerkavaSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			LocationSQLiteParserEnum.LocationMerkavaSdf2SqliteParser,
