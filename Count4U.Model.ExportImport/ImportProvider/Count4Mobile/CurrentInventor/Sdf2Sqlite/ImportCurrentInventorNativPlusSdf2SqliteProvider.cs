...
{
	public class ImportCurrentInventorNativPlusSdf2SqliteProvider : BaseProvider, IImportProvider
	{
		private readonly IImportCurrentInventorSQLiteADORepository _importCurrentInventorSQLiteADORepository;

		public ImportCurrentInventorNativPlusSdf2SqliteProvider(
		...
		public void Import()
		{
			...
			if (this.IsEmptyPath(this.ToPathDB) == true) return;			//db3Path
   			...
   			this._importCurrentInventorSQLiteADORepository.InsertCurrentInventors(this.FromPathFile, 
				this.ToPathDB,
			CurrentInventorSQLiteParserEnum.CurrentInventoryNativPlusSdf2SqliteParser,
