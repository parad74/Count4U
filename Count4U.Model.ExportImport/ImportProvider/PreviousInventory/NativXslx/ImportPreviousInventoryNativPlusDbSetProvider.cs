...
{
	public class ImportPreviousInventoryNativPlusDbSetProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPreviousInventorysRepository _importPreviousInventorysDbSetRepository;

		public ImportPreviousInventoryNativPlusDbSetProvider(IImportPreviousInventorysRepository importPreviousInventorysDbSetRepository,
		...
		public void Import()
		{
			...
			PreviousInventorySQLiteParserEnum.PreviousInventoryNativPlusXslx2DbSetParser,
