...
{
	public class ImportPreviousInventoryNativYesDbSetProviderSN : BaseProvider, IImportProvider
	{
		private readonly IImportPreviousInventorysRepository _importPreviousInventorysDbSetRepository;

		public ImportPreviousInventoryNativYesDbSetProviderSN(IImportPreviousInventorysRepository importPreviousInventorysDbSetRepository,
		...
		public void Import()
		{
			...
			PreviousInventorySQLiteParserEnum.PreviousInventoryNativPlusYesXlsxDbSetParserSN,
