...
{
	public class ImportPreviousInventoryNativYesDbSetProviderQ : BaseProvider, IImportProvider
	{
		private readonly IImportPreviousInventorysRepository _importPreviousInventorysDbSetRepository;

		public ImportPreviousInventoryNativYesDbSetProviderQ(IImportPreviousInventorysRepository importPreviousInventorysDbSetRepository,
		...
		public void Import()
		{
			...
			PreviousInventorySQLiteParserEnum.PreviousInventoryNativPlusYesXlsxDbSetParserQ,
