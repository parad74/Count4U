...
{
	public class ImportPreviousInventoryNativPlusLadpcDbSetProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPreviousInventorysRepository _importPreviousInventorysDbSetRepository;

		public ImportPreviousInventoryNativPlusLadpcDbSetProvider(IImportPreviousInventorysRepository importPreviousInventorysDbSetRepository,
			...
			: base(log, serviceLocator)
	    {
			...
			this._importTypes.Add(ImportDomainEnum.ExistPreviousInventory);
		}
		...
		public void Import()
		{
			...
			PreviousInventorySQLiteParserEnum.PreviousInventoryNativPlusLadpc2DbSetParser,
