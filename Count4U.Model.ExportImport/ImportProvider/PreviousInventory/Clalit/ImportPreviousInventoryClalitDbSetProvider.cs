...
{
	public class ImportPreviousInventoryClalitDbSetProvider : BaseProvider, IImportProvider
	{
		private readonly IImportPreviousInventorysRepository _importPreviousInventorysDbSetRepository;

		public ImportPreviousInventoryClalitDbSetProvider(IImportPreviousInventorysRepository importPreviousInventorysDbSetRepository,
				IServiceLocator serviceLocator,
				ILog log)
			: base(log, serviceLocator)
	    {
			if (importPreviousInventorysDbSetRepository == null) throw new ArgumentNullException("importLocationRepository");
		...
		public void Import()
		{
			...
			PreviousInventorySQLiteParserEnum.PreviousInventoryClalitXslx2DbSetParser,
		...
		protected override void InitDefault()
		{
			...
			this._countExcludeFirstString = 7;
		}
