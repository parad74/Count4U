...
{
	public class ImportFamilyPriorityKedsShowRoomProvider : BaseProvider, IImportProvider
	{
		private readonly IImportFamilyRepository _importFamilyRepository;

		public ImportFamilyPriorityKedsShowRoomProvider(IImportFamilyRepository importFamilyRepository,
		...
		public void Import()
		{
			...
			this._importFamilyRepository.InsertFamilys(this.FromPathFile, this.ToPathDB,
				FamilyParserEnum.FamilyPriorityKedsShowRoomParser,
