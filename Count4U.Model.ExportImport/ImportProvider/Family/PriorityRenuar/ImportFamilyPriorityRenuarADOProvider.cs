...
{
	public class ImportFamilyPriorityRenuarADOProvider : BaseProvider, IImportProvider
	{
		private readonly IImportFamilyRepository _importFamilyRepository;

		public ImportFamilyPriorityRenuarADOProvider(IImportFamilyRepository importFamilyRepository,
		...
		public void Import()
		{
			...
			this._importFamilyRepository.InsertFamilys(this.FromPathFile, this.ToPathDB,
				FamilyParserEnum.FamilyPriorityRenuarParser,
