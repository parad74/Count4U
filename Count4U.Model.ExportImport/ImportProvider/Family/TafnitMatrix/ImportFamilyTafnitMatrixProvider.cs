...
{
	public class ImportFamilyTafnitMatrixProvider : BaseProvider, IImportProvider
	{
		private readonly IImportFamilyRepository _importFamilyRepository;

		public ImportFamilyTafnitMatrixProvider(IImportFamilyRepository importFamilyRepository,
		...
		public void Import()
		{
			...
			this._importFamilyRepository.InsertFamilys(this.FromPathFile, this.ToPathDB,
				FamilyParserEnum.FamilyTafnitMatrixParser,
