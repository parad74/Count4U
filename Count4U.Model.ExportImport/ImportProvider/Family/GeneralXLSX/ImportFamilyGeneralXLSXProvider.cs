...
{
	public class ImportFamilyGeneralXLSXProvider : BaseProvider, IImportProvider
	{
		private readonly IImportFamilyRepository _importFamilyRepository;

		public ImportFamilyGeneralXLSXProvider(IImportFamilyRepository importFamilyRepository,
		...
		public void Import()
		{
			...
			this._importFamilyRepository.InsertFamilys(this.FromPathFile, this.ToPathDB,
				FamilyParserEnum.FamilyGeneralXLSXParser,
