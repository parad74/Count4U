...
{
	public class ImportFamilyH_M_NewProvider : BaseProvider, IImportProvider
	{
		private readonly IImportFamilyRepository _importFamilyRepository;

		public ImportFamilyH_M_NewProvider(IImportFamilyRepository importFamilyRepository,
		...
		public void Import()
		{
			...
			this._importFamilyRepository.InsertFamilys(this.FromPathFile, this.ToPathDB,
				FamilyParserEnum.FamilyH_M_NewParser,
