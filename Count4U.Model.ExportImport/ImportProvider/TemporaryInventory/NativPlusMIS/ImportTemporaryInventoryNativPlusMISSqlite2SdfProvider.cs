...
{
	public class ImportTemporaryInventoryNativPlusMISSqlite2SdfProvider : BaseProvider, IImportProvider
	{

		private readonly IImportTemporaryInventoryRepository _importTemporaryInventoryDbSetRepository;

		public ImportTemporaryInventoryNativPlusMISSqlite2SdfProvider(
		...
		public void Clear()
		{
			this._importTemporaryInventoryDbSetRepository.ClearTemporaryInventorys(this.ToPathDB);
		}
