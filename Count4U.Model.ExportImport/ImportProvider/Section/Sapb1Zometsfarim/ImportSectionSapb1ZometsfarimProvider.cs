...
{
	public class ImportSectionSapb1ZometsfarimProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSectionRepository _importSectionRepository;

		public ImportSectionSapb1ZometsfarimProvider(IImportSectionRepository importSectionRepository,
		...
		public void Import()
		{
			...
			this._importSectionRepository.InsertSections(this.FromPathFile, this.ToPathDB,
				SectionParserEnum.SectionSapb1ZometsfarimParser,
