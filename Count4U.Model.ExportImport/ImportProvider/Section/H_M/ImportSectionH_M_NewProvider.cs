...
{
	public class ImportSectionH_M_NewProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSectionRepository _importSectionRepository;

		public ImportSectionH_M_NewProvider(IImportSectionRepository importSectionRepository,
		...
		public void Import()
		{
			...
			this._importSectionRepository.InsertSections(this.FromPathFile, this.ToPathDB,
				SectionParserEnum.SectionH_M_NewParser,
