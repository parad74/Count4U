...
{
	public class ImportSectionAS400MegaProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSectionRepository _importSectionRepository;

		public ImportSectionAS400MegaProvider(IImportSectionRepository importSectionRepository,
		...
		public void Import()
		{
			...
			this._importSectionRepository.InsertSections(this.FromPathFile, this.ToPathDB,
				SectionParserEnum.SectionAS400MegaParser,
