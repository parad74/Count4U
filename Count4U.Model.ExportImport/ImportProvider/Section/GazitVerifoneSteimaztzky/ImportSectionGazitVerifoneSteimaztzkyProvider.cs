...
{
	public class ImportSectionGazitVerifoneSteimaztzkyProvider : BaseProvider, IImportProvider
	{
		private readonly IImportSectionRepository _importSectionRepository;

		public ImportSectionGazitVerifoneSteimaztzkyProvider(IImportSectionRepository importSectionRepository,
		...
		public void Import()
		{
			...
			this._importSectionRepository.InsertSections(this.FromPathFile, this.ToPathDB,
				SectionParserEnum.SectionGazitVerifoneSteimaztzkyParser,
