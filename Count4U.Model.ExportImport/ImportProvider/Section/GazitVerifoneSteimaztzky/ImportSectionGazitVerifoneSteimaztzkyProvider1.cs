...
{
	public class ImportSectionGazitVerifoneSteimaztzkyProvider1 : BaseProvider, IImportProvider
	{
		private readonly IImportSectionRepository _importSectionRepository;

		public ImportSectionGazitVerifoneSteimaztzkyProvider1(IImportSectionRepository importSectionRepository,
		...
		public void Import()
		{
			...
			this._importSectionRepository.InsertSections(this.FromPathFile, this.ToPathDB,
				SectionParserEnum.SectionGazitVerifoneSteimaztzkyParser1,
