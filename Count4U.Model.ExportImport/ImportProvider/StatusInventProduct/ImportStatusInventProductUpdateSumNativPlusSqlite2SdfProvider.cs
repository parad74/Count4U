...
{
	public class ImportStatusInventProductUpdateSumNativPlusSqlite2SdfProvider : BaseProvider, IImportProvider
	{
	...
	//	private readonly IImportInventProductRepository _importInventProductRepository;
		...
		public ImportStatusInventProductUpdateSumNativPlusSqlite2SdfProvider(
		...
		public void Import()
		{
			...
			StatusInventProductSimpleParserEnum.StatusInventProductUpdateSumNativPlusSqlite2SdfParser,
