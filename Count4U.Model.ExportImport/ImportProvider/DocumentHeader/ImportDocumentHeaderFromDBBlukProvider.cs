...
{
	//ипользуется только для добавления отсутствующего в DocumentHeader
	public class ImportDocumentHeaderFromDBBlukProvider : BaseProvider, IImportProvider
	{
		private readonly IImportDocumentHeaderBlukRepository _importDocumentHeaderBlukRepository;

		public ImportDocumentHeaderFromDBBlukProvider(
		...
		public void Import()
		{
			...
			DocumentHeaderParseEnum.DocumentHeaderFromDBParser,
