...
{
	//ипользуется для добавления специального одного документа DocumentHeader в Itur => DocumentCode = IturCode + _99999
	public class ImportDocumentHeaderAddSpetialDocToIturBlukProvider : BaseProvider, IImportProvider
	{
		private readonly IImportDocumentHeaderBlukRepository _importDocumentHeaderBlukRepository;

		public ImportDocumentHeaderAddSpetialDocToIturBlukProvider(
		...
		public void Import()
		{
			...
			DocumentHeaderParseEnum.DocumentHeaderAddSpetialDocToIturParser,
