...
{
	public class ImportBranchXtechMeuhedetXlsxProvider  : BaseProvider, IImportProvider
	{
		private readonly IImportBranchRepository _importBranchRepository;

		public ImportBranchXtechMeuhedetXlsxProvider(IImportBranchRepository importBranchRepository,
		...
		public void Import()
		{
			...
			BranchParserEnum.BranchXtechMeuhedetXlsxParser,
