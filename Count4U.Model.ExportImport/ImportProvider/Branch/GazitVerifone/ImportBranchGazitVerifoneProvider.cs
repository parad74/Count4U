...
{
	public class ImportBranchGazitVerifoneProvider  : BaseProvider, IImportProvider
	{
		private readonly IImportBranchRepository _importBranchRepository;

		public ImportBranchGazitVerifoneProvider(IImportBranchRepository importBranchRepository,
		...
		public void Import()
		{
			...
			BranchParserEnum.BranchGazitVerifoneParser,
