...
{
	public class ImportBranchAS400HonigmanProvider  : BaseProvider, IImportProvider
	{
		private readonly IImportBranchRepository _importBranchRepository;

		public ImportBranchAS400HonigmanProvider(IImportBranchRepository importBranchRepository,
		...
		public void Import()
		{
			...
			BranchParserEnum.BranchAS400HonigmanParser,
