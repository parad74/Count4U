...
{
	public class ImportBranchMikramSonolProvider  : BaseProvider, IImportProvider
	{
		private readonly IImportBranchRepository _importBranchRepository;

		public ImportBranchMikramSonolProvider(IImportBranchRepository importBranchRepository,
		...
		public void Import()
		{
			...
			BranchParserEnum.BranchMikramSonolParser,
