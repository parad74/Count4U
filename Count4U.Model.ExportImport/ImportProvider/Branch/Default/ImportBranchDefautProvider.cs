...
{
	public class ImportBranchDefautProvider  : BaseProvider, IImportProvider
	{
		private readonly IImportBranchRepository _importBranchRepository;

		public ImportBranchDefautProvider(IImportBranchRepository importBranchRepository,
		...
		public void Import()
		{
			...
			BranchParserEnum.BranchDefaultParser,
