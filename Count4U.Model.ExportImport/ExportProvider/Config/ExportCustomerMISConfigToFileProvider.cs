...
{
	public class ExportCustomerMISConfigToFileProvider : BaseProvider, IExportProvider
	{
		protected readonly IExportConfigIniRepository _exportRepository;

		public ExportCustomerMISConfigToFileProvider(
			...
			: base(log, serviceLocator)
		{
			...
			this._exportRepository =
				this._serviceLocator.GetInstance<IExportConfigIniRepository>(ExportRepositoryEnum.ExportCustomerMISConfigFileRepository.ToString());
