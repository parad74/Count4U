...
{
	public class ExportInventProductNetPOSSuperPharmERPFileProvider1 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductNetPOSSuperPharmERPFileProvider1(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductNetPOSSuperPharmERPFileWriter1,
