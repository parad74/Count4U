...
{
	public class ExportInventProductPriorityRenuarERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductPriorityRenuarERPFileProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductPriorityRenuarERPFileWriter,
