...
{
	public class ExportInventProductPriorityRenuarERPFileProvider_TW : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductPriorityRenuarERPFileProvider_TW(
		...
		public override void WriteToFile(string toPathFile)
		{
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductPriorityRenuarERPFileWriter_TW,
