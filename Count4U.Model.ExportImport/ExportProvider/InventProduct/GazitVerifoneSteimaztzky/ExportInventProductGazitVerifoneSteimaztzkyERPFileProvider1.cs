...
{
	public class ExportInventProductGazitVerifoneSteimaztzkyERPFileProvider1 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductGazitVerifoneSteimaztzkyERPFileProvider1(
				IServiceLocator serviceLocator,
				ILog log)
			: base(log, serviceLocator)
		{
			this._importTypes.Add(ImportDomainEnum.ExportInventProduct);
			this._importTypes.Add(ImportDomainEnum.ExportInventProductW);
		...
		public override void WriteToFile(string toPathFile)
		{
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductGazitVerifoneSteimaztzkyERPFileWriter1,
