...
{
	public class ExportInventProductMikiKupotERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductMikiKupotERPFileProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			WriterEnum.ExportInventProductMikiKupotERPFileWriter,
