...
{
	public class ExportInventProductRetalixPosHOERPFileProvider0 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;
		

		public ExportInventProductRetalixPosHOERPFileProvider0(
