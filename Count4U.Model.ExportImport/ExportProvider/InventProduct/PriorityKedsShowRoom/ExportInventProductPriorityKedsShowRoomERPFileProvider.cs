...
{
	public class ExportInventProductPriorityKedsShowRoomERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductPriorityKedsShowRoomERPFileProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductPriorityKedsShowRoomERPFileWriter,
