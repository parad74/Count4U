...
{
	public class ExportInventProductTafnitMatrixERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		...
		public ExportInventProductTafnitMatrixERPFileProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile,
					WriterEnum.ExportInventProductTafnitMatrixERPFileWriter,
