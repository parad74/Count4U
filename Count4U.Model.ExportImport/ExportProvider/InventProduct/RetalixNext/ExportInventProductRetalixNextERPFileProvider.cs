...
{
	public class ExportInventProductRetalixNextERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		...
		public ExportInventProductRetalixNextERPFileProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, 
					WriterEnum.ExportInventProductRetalixNextERPFileWriter,
