...
{
	public class ExportInventProductRetalixNextERPFileProvider0 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;
		

		public ExportInventProductRetalixNextERPFileProvider0(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductRetalixNextERPFileWriter0,
