...
{
	public class ExportInventProductAvivPOSERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductAvivPOSERPFileProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			WriterEnum.ExportInventProductAvivPOSERPFileWriter,
