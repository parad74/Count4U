...
{
	public class ExportInventProductUnizagERPFileProvider1 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductUnizagERPFileProvider1(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			this._exportRepository.WriteToFile(this.FromPathDB, toPathFile,  WriterEnum.ExportInventProductUnizagERPFileWriter,
