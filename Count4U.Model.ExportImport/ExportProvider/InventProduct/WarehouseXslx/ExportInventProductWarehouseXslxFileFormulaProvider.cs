...
{
	public class ExportInventProductWarehouseXslxFileFormulaProvider : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductWarehouseXslxFileFormulaProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductWarehouseXslxFileFormulaWriter,
			...
			sw.Flush();
				...
				{
					XLColor[] colors = new XLColor[] {XLColor.Yellow};
