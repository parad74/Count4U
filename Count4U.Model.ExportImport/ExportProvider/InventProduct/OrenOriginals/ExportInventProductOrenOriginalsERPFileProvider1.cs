...
{
	public class ExportInventProductOrenOriginalsERPFileProvider1 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductOrenOriginalsERPFileProvider1(
				IServiceLocator serviceLocator,
				ILog log)
			: base(log, serviceLocator)
		{
			this._importTypes.Add(ImportDomainEnum.ExportSumInventProduct);
			//this._importTypes.Add(ImportDomainEnum.UnitTypeCodeContains);
			this._importTypes.Add(ImportDomainEnum.IturERPCodeContains);
			this._importTypes.Add(ImportDomainEnum.IncludeProductMakatWithoutInventProduct);
		...
		public override void WriteToFile(string toPathFile)
		{
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductOrenOriginalsERPFileWriter1,
