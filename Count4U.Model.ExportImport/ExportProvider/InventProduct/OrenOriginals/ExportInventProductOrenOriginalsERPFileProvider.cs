...
{
	public class ExportInventProductOrenOriginalsERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductOrenOriginalsERPFileProvider(
			...
			: base(log, serviceLocator)
		{
			...
			//this._importTypes.Add(ImportDomainEnum.IncludeIPIfContansOnlyOneItur);
		...
		public override void WriteToFile(string toPathFile)
		{
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductOrenOriginalsERPFileWriter,
