...
{
	public class ExportInventProductXtechMeuhedetXlsxProvider2 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductXtechMeuhedetXlsxProvider2(
				IServiceLocator serviceLocator,
				ILog log)
			: base(log, serviceLocator)
		{
			this._importTypes.Add(ImportDomainEnum.ExportSumInventProduct);
			this._importTypes.Add(ImportDomainEnum.TagContains);
		...
		public override void WriteToFile(string toPathFile)
		{
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductXtechMeuhedetXlsxERPFileWriter2,
