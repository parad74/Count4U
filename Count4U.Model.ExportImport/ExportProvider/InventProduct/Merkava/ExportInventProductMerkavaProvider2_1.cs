...
{		  	public class ExportInventProductMerkavaProvider2_1 : BaseExportERPProvider, IExportERPProvider

	{
		protected readonly IExportCurrentInventorAdvancedRepository _exportRepository;		

		public ExportInventProductMerkavaProvider2_1(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportCurrentInventoryMerkavaXslxWriter2_1,
			...
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportCurrentInventoryMerkavaXslxWriter2_2,
					this.ProviderEncoding, this._separators, this._importTypes, sw, this.Parms);
