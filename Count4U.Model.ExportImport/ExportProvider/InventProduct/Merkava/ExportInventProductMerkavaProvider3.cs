...
{
	public class ExportInventProductMerkavaProvider3 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportCurrentInventorAdvancedRepository _exportRepository;			  //TODO

		public ExportInventProductMerkavaProvider3(
		...
		public override void WriteToFile(string toPathFile)
		{
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportCurrentInventoryMerkavaXslxWriter3,
