...
{				  //не используется перенесено в ExportInventProductMerkavaProvider2_1
	public class ExportInventProductMerkavaProvider2_2 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductMerkavaProvider2_2(
