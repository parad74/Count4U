...
{
	public class ExportInventProductPriorityKedsMatrixERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductPriorityKedsMatrixERPFileProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductPriorityKedsMatrixERPFileWriter,
