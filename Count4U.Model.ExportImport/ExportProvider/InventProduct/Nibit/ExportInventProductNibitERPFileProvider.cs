...
{
	public class ExportInventProductNibitERPFileProvider : BaseExportERPProvider, IExportERPProvider
	{
		...
		public ExportInventProductNibitERPFileProvider(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			using (MemoryStream ms = new MemoryStream())
			{
				...
				this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, 
					WriterEnum.ExportInventProductNibitERPFileWriter,
