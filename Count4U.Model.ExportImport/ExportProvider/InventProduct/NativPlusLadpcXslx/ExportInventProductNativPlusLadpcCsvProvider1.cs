...
{
	public class ExportInventProductNativPlusLadpcCsvProvider1 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportCurrentInventorAdvancedRepository _exportRepository;			  //TODO

		public ExportInventProductNativPlusLadpcCsvProvider1(
		...
		public override void WriteToFile(string toPathFile)
		{
			using (MemoryStream ms = new MemoryStream())
			{
				...
				WriterEnum.ExportCurrentInventoryNativPlusLadpcCsvWriter1,
