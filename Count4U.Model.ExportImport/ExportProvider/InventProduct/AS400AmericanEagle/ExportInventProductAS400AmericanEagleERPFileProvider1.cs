...
{
	public class ExportInventProductAS400AmericanEagleERPFileProvider1 : BaseExportERPProvider, IExportERPProvider
	{
		protected readonly IExportInventProductSimpleRepository _exportRepository;

		public ExportInventProductAS400AmericanEagleERPFileProvider1(
		...
		public override void WriteToFile(string toPathFile)
		{
			...
			this._exportRepository.WriteToFile(this.FromPathDB, toPathFile, WriterEnum.ExportInventProductAS400AmericanEagleERPFileWriter1,
