...
{
	public class ForwardInventProductMalamDataSetProvider : BaseProvider, IExportProvider
	{
		public ForwardInventProductMalamDataSetProvider(
		...
		public void Export()
		{
			...
			IInventProductToObjectParser inventProductParser =
							this._serviceLocator.GetInstance<IInventProductToObjectParser>(InventProductSimpleParserEnum.InventProductToMalamDataSetParser.ToString());
			...
			DataSet ds = inventProductParser.GetMyObject(fromFilePath, this.ProviderEncoding, this._separators,
				this._countExcludeFirstString, this._importTypes, this.Parms) as DataSet;

			Serialise<DataSet>(ds, toFilePath);
