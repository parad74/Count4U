...
namespace Count4U.Model.Count4U
{
	...
	public class ExportCurrentInventoryMerkavaGovXslxWriter2_2 : IExportCurrentInventoryWriter
	{
			...
			string separator = "^", Dictionary<ImportProviderParmEnum, object> parms = null, List<PreviousInventory> details = null)
		{
			...
			//{
				...
				newRows[11] = ""; //L	12	ציוד עליון	HEQUI	ציוד עליון	Empty (not in use)
				...
				newRows[24] = currentInventory.PropertyStr15Code; //@"	Empty (not in use)	";//	Y	25	יצרן	HERST	יצרן	PropertyStr15
				newRows[25] = ""; //@"	Empty (not in use)	";//	Z	26
				newRows[26] = currentInventory.PropertyStr2Name; //	AA	27	מספר מודל	TYPBZ	מספר מודל	PropertyStr2
				...
				newRows[34] = currentInventory.PropertyStr14Code; //AI	35	שדה מיון	EQFNR	שדה מיון	PropertyStr14   				newRows[35] = currentInventory.PropertyStr1Code; //@"	PropertyStr1	";//	AJ	36
			...
			Dictionary<ImportProviderParmEnum, object> parms = null, object argument = null)
		{
			...
			newRows[10] = @"Empty (not in use)	";//	K	11
			newRows[11] = @"	Empty (not in use)";//L	12	ציוד עליון	HEQUI	ציוד עליון	Empty (not in use)
			...
			newRows[23] = @"	Empty (not in use)	";//	X	24
			newRows[24] = @"PropertyStr15";//	Y	25	יצרן	HERST	יצרן	PropertyStr15
			newRows[25] = @"	Empty (not in use)	";//	Z	26
			newRows[26] = @"PropertyStr2";//	AA	27	מספר מודל	TYPBZ	מספר מודל	PropertyStr2
			...
			newRows[32] = @"	Empty (not in use)	";//	AG	33
			newRows[33] = @"	Empty (not in use)	";//	AH	34
			newRows[34] = @"	PropertyStr14	";//	AI	35	שדה מיון	EQFNR	שדה מיון	PropertyStr14
			...
			newRows1[11] = @"	HEQUI	";//	L	12	ציוד עליון	HEQUI	ציוד עליון	Empty (not in use)
			...
			newRows1[24] = @"	HERST	";//	Y	25	יצרן	HERST	יצרן	PropertyStr15
			newRows1[25] = @"	HERLD	";//	Z	26
			newRows1[26] = @"	TYPBZ	";//	AA	27	מספר מודל	TYPBZ	מספר מודל	PropertyStr2
			...
			newRows1[34] = @"	EQFNR	";//	AI	35	שדה מיון	EQFNR	שדה מיון	PropertyStr14
			...
			newRows2[11] = @"	ציוד עליון	";//	L	12	ציוד עליון	HEQUI	ציוד עליון	Empty (not in use)
			...
			newRows2[24] = @"	יצרן 	";//	Y	25	יצרן	HERST	יצרן	PropertyStr15
			newRows2[25] = @"	ארץ יצרן 	";//	Z	26
			newRows2[26] = @"	מספר מודל 	";//	AA	27	מספר מודל	TYPBZ	מספר מודל	PropertyStr2
			...
			newRows2[34] = @"	שדה מיון	";//AI	35	שדה מיון	EQFNR	שדה מיון	PropertyStr14
