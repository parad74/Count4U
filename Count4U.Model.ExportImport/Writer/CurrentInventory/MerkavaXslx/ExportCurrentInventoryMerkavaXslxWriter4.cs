...
{
	public class ExportCurrentInventoryMerkavaXslxWriter4 : IExportCurrentInventoryWriter
	{
			...
			string separator = "^", Dictionary<ImportProviderParmEnum, object> parms = null, List<PreviousInventory> details = null)
		{
			...
			{
				if (string.IsNullOrWhiteSpace(currentInventory.PropertyStr10) == true
						&& string.IsNullOrWhiteSpace(currentInventory.PropertyStr11) == true)
				{
					if (details != null)
					{
						if (details.Count > 0)
