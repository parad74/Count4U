...
namespace Count4U.Model.Count4U
{
	...
	public class ExportCurrentInventoryMerkavaXslxWriter2_1 : IExportCurrentInventoryWriter
	{
		//"SN"
			...
			string separator = "^", Dictionary<ImportProviderParmEnum, object> parms = null, List<PreviousInventory> details = null)
		{
				...
				if (key == "SN")
				{
					...
					newRows[4] = currentInventory.PropertyStr8Code;//@"	UID-RFID (PropertyStr8)	";//	E	5
			...
			//		newRows[13] = currentInventory.LocationLevel1Code + "-" + currentInventory.LocationLevel3Code;//@Location.Level1 & "-" & Location.Level3;//	N	14
					...
					newRows[22] = currentInventory.PropertyStr11Code;// @"	PropertyStr11	";//	W	23
					...
					newRows[35] = currentInventory.PropertyStr4Code;//@"	PropertyStr4	";//	AJ	36
					...
					newRows[36] = currentInventory.SerialNumberLocal;//@"	SerialNumberLocal	";//	AK	37
			...
			Dictionary<ImportProviderParmEnum, object> parms = null, object argument = null)
		{
			...
			newRows[4] = @"	UID-RFID (PropertyStr8)	";//	E	5
			...
			newRows[20] = @"	Empty (not in use)	";//	U	21
			newRows[21] = @"	Empty (not in use)	";//	V	22
			newRows[22] = @"	PropertyStr11	";//	W	23
			newRows[23] = @"	PropertyStr10	";//	X	24
			newRows[24] = @"	Empty (not in use)	";//	Y	25
			newRows[25] = @"	Empty (not in use)	";//	Z	26
			newRows[26] = @"	Empty (not in use)	";//	AA	27
			newRows[27] = @"	Empty (not in use)	";//	AB	28
			...
			newRows[35] = @"	PropertyStr4	";//	AJ	36
			newRows[36] = @"	SerialNumberLocal	";//	AK	37
			...
			newRows1[22] = @"	ANSWT	";//	W	23
			newRows1[23] = @"	ANSDT	";//	X	24
			newRows1[24] = @"	GROES	";//	Y	25
			newRows1[25] = @"	HERST	";//	Z	26
			newRows1[26] = @"	HERLD	";//	AA	27
			newRows1[27] = @"	TYPBZ	";//	AB	28
			...
			newRows1[35] = @"	EQFNR	";//	AJ	36
			newRows1[36] = @"	SN OLD	";//	AK	37
			...
			newRows2[22] = @"	Value in NIS ";//	W	23
			newRows2[23] = @"	תאריך רכישה 	";//	X	24
			newRows2[24] = @"	גודל /מימד	";//	Y	25
			newRows2[25] = @"	יצרן 	";//	Z	26
			newRows2[26] = @"	ארץ יצרן 	";//	AA	27
			newRows2[27] = @"	מספר מודל 	";//	AB	28
			...
			newRows2[35] = @"	שדה מיון	";//	AJ	36
			newRows2[36] = @"	מספר סידורי ישן	";//	AK	37
