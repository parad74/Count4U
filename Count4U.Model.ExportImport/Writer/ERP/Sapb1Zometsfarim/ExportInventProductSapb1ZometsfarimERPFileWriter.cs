...
{
	public class ExportInventProductSapb1ZometsfarimERPFileWriter : IExportInventProductFileWriter
	{
		...
		{
//Field1: Quantity Expected
//Field2: Item Code 
//Field3: ERP Branch Code
			...
			string[] newRows = new string[] {quantityEditStr, makat,  ERPNum};
