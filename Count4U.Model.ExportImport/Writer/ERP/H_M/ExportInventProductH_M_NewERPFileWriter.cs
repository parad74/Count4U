...
{
	public class ExportInventProductH_M_NewERPFileWriter : IExportInventProductFileWriter
	{
		...
		public void AddRowSimple(StreamWriter sw, IturAnalyzesSimple iturAnalyzes, long countRow, string ERPNum = "", string INVDate = "", string separator = ",")
		{
			...
			string[] newRows = new string[] { iturAnalyzes.Makat, iturAnalyzes.FamilyCode, quantityEdit };
