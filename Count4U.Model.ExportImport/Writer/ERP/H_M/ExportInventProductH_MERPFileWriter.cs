...
{
	public class ExportInventProductH_MERPFileWriter : IExportInventProductFileWriter
	{
		...
		{
			//Makat , Quantity Edit 
			string quantityEdit = iturAnalyzes.QuantityEdit.ToString().PadLeft(7,' ');
			string[] newRows = new string[] { iturAnalyzes.MakatOriginal, quantityEdit };
