...
{
	public class ExportInventProductGeneralCSVERPFileWriter2 : IExportInventProductFileWriter
	{
...
//QuantityEdit 
			separator = "\t";
			string[] newRows = new string[] {ERPNum, INVDate, iturAnalyzes.Makat, iturAnalyzes.QuantityEdit.ToString() };
