...
{								   
	public class ExportInventProductGeneralCSVERPFileWriter : IExportInventProductFileWriter
	{
		...
		{
			//Makat , Quantity Edit 
			string[] newRows = new string[] { iturAnalyzes.Makat, iturAnalyzes.QuantityEdit.ToString() };
