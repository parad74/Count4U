...
{
	public class ExportInventProductGazitVerifoneSteimaztzkyERPFileWriter : IExportInventProductFileWriter
	{
		...
		public void AddRowSimple(StreamWriter sw, IturAnalyzesSimple iturAnalyzes, long countRow, string ERPNum = "", string INVDate = "", string separator = ";")
		{
			...
			string[] newRows = new string[] { ERPNum, INVDate, makat, quantityEditStr };
