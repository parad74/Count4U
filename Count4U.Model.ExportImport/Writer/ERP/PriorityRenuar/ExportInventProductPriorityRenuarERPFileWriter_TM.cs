...
{
	public class ExportInventProductPriorityRenuarERPFileWriter_TM : IExportInventProductFileWriter
	{
		...
		public void AddRowSimple(StreamWriter sw, IturAnalyzesSimple iturAnalyzes, long countRow, string ERPNum = "", string INVDate = "", string separator = ",")
		{
			...
			//Sample: 
			//			                    312300226Y            1 2    7
//			Add all data rows that starts with "6","7","8","9" & "0" (in the item code)
//Add to the Header "T" to the Branch code
//15/06/14 900T 0 1 1
			...
			//}
						...
						///NEW
////////File record: Makat (col 1-30 Aligned to right) - starts with 5 and 8 only!
////////Quantity Edit (col 40-43 Aligned to right)
////////Const2 (col 45)
////////Record Counter (col 47-50 Aligned to right)
		...
		///NEW
		////////			File header: InventorDate (col 1-8) Format DD/MM/YY
		////////Code ERP (col 10-12) – If CodeERP is greater then 3 chars, cut the first 3
		////////Const 'M' (col 13)
		////////Const0 (col 15)
		////////Const1 (col 45)
		////////Const 1 (col 50)
		////////Example: "15/04/12 305M 0 1 1"
