...
namespace Count4U.Model.Count4Mobile
{
	...
	public class LocationNativPlusMISSdf2SqliteParser : ILocationSQLiteParser
	{
		...
		public LocationNativPlusMISSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
		{
...
//[Location].LevelNum= [Itur]. LevelNum
				...
				// 1 step. Add IturCode liek LocationCode in db3
				LocationMobile newLocation = new LocationMobile();
				string locationCode = itur.IturCode;
				string iturCode = itur.IturCode;
				...
				try
				{
					...
					newLocation.Level1Code = locationCode;
