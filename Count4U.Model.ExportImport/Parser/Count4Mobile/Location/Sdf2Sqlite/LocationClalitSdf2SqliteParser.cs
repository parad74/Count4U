...
{
	public class LocationClalitSdf2SqliteParser : ILocationSQLiteParser
	{
		...
		public LocationClalitSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
		{
...
//[Location].Level4Code  = [Itur].Level4
//[Location].Level4Name  = [Itur].Name4
...
//[Location].LevelNum= [Itur]. LevelNum
			...
			//Need to build default row on Location : LocationCode = "-1", Name = "NoLocation"  nodeType = "0"
