...
{
	// 2 step. Add ERPIturCode like LocationCode in db3
	//решили не использвать 11/04/2018  Юваль
	public class LocationNativPlusMISSdf2SqliteParserERP : ILocationSQLiteParser
	{
		...
		public LocationNativPlusMISSdf2SqliteParserERP(IServiceLocator serviceLocator,
			ILog log)
		{
