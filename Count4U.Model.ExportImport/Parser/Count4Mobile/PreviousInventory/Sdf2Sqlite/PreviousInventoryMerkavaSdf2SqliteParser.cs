...
{
	public class PreviousInventoryMerkavaSdf2SqliteParser : IPreviousInventorySQLiteParser
	{
		...
		public PreviousInventoryMerkavaSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
		{
