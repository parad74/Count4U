...
{
	public class PreviousInventoryClalitSdf2SqliteParser : IPreviousInventorySQLiteParser
	{
		...
		public PreviousInventoryClalitSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
		{
