...
{
	public class PropertyStrListNativSdf2SqliteParser : IPropertyStrListSQLiteParser
	{
		...
		public PropertyStrListNativSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
		{
