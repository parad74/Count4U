...
{
	public class PropertyStrListClalitSdf2SqliteParser : IPropertyStrListSQLiteParser
	{
		...
		public PropertyStrListClalitSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
		{
