...
{
	public class CatalogClalitSdf2SqliteParser : BaseCatalogSOLiteParser, ICatalogSQLiteParser
	{
		private  IProductRepository _productRepository;

		public CatalogClalitSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
