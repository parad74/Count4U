...
{
	public abstract class BaseCatalogSOLiteParser
	{
		//protected  IFileParser _fileParser;

		protected readonly ILog _log;
		protected Dictionary<string, Catalog> _productDictionary;
		...
		public BaseCatalogSOLiteParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			this._log = log;
			this._productDictionary = new Dictionary<string, Catalog>();
		...
		public Dictionary<string, Catalog> CatalogDictionary
		{
