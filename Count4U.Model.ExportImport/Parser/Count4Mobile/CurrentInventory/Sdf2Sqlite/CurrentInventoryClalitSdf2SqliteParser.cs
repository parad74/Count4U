...
{							  
	public class CurrentInventoryClalitSdf2SqliteParser : BaseCatalogSOLiteParser, ICurrentInventorSQLiteParser
	{
		private  IInventProductRepository _inventProductRepository;
		private IIturRepository _iturRepository;

		public CurrentInventoryClalitSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
	{
			...
			foreach (InventProduct inventProduct in this._inventProductRepository.GetInventProducts(fromPathFile))
			{
				...
				//SerialNumberLocal				SerialNumberLocal			1
				//ItemCode								Makat								"111"
				...
				string propertyStr13 = inventProduct.IPValueStr13;

				string[] uids = new string[] { serialNumber, makat, locationCode, propertyStr13 };
