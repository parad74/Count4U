...
{							  
	public class CurrentInventoryNativSdf2SqliteParser : BaseCatalogSOLiteParser, ICurrentInventorSQLiteParser
	{
		...
		public CurrentInventoryNativSdf2SqliteParser(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
	{
			...
			foreach (InventProduct inventProduct in this._inventProductRepository.GetInventProducts(fromPathFile))
			{
				...
				string propertyStr13 = inventProduct.IPValueStr13.CutLength(49);
				...
				string[] ids = new string[] { serialNumber, makat, locationCode, "" };	// 4 - составной ключ	 Q
