...
{
	public class InventProductMerkavaSqlite2SdfParser : InventProductParserBase, IInventProductSimpleParser
	{
		...
		public InventProductMerkavaSqlite2SdfParser(
		...
		//	string newWorkerID = ""; 
			...
			//int indexPropertyStr1 = -1;
			//int indexPropertyStr2 = -1;
			//int indexPropertyStr3 = -1;
			//int indexPropertyStr4 = -1;
			//int indexPropertyStr5 = -1;
			int indexPropertyStr6 = -1;
			int indexPropertyStr7 = -1;
			int indexPropertyStr8 = -1;				 //Входит в составной ключ
			//int indexPropertyStr9 = -1;
			//int indexPropertyStr10 = -1;
			//int indexPropertyStr11 = -1;
			//int indexPropertyStr12 = -1;
			//int indexPropertyStr13 = -1;
			//int indexPropertyStr14 = -1;
			//int indexPropertyStr15 = -1;
			//int indexPropertyStr16 = -1;
			//int indexPropertyStr17 = -1;
			//int indexPropertyStr18 = -1;				 
			//int indexPropertyStr19 = -1;
			//int indexPropertyStr20 = -1;
			int indexQuantity = -1;
				...
				countExcludeFirstString, tableName))
			{
				...
				if (rowCount == 1) // header of Table
				{
					...
					// 	dictionaryColumnNumbers - TODO получить индексы нужных полей, не найденых == -1
					{
						...
						//indexPropertyStr1 = "PropertyStr1".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr2 = "PropertyStr2".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr3 = "PropertyStr3".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr4 = "PropertyStr4".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr5 = "PropertyStr5".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						indexPropertyStr6 = "PropertyStr6".GetIndexColumnByName(dictionaryColumnNumbers, tableName, colCount, Log);
						indexPropertyStr7 = "PropertyStr7".GetIndexColumnByName(dictionaryColumnNumbers, tableName, colCount, Log);
						indexPropertyStr8 = "PropertyStr8".GetIndexColumnByName(dictionaryColumnNumbers, tableName, colCount, Log);
						//indexPropertyStr9 = "PropertyStr9".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr10 = "PropertyStr10".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr11 = "PropertyStr11".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr12 = "PropertyStr12".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr13 = "PropertyStr13".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr14 = "PropertyStr14".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr15 = "PropertyStr15".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr16 = "PropertyStr16".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr17 = "PropertyStr17".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr18 = "PropertyStr18".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr19 = "PropertyStr19".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
						//indexPropertyStr20 = "PropertyStr20".GetIndexColumnByName(dictionaryColumnNumbers, tableName, Log);
...
//Для айтемов типа "Q". Их нет в PreviuseInventory. Добавляя их в currentInventory четвертая строка в ключе = propertyStrKey8
					...
					//string propertyStr6 = record[indexPropertyStr6].CutLength(99);
					//string propertyStr7 = record[indexPropertyStr7].CutLength(99);
					...
					string[] ids = new string[] { serialNumber, makat, locationCodeFrom, "" };	// 3 - составной ключ для SN
					...
					//временно newInventProduct.StatusInventProductCode = filename.CutLength(49);
