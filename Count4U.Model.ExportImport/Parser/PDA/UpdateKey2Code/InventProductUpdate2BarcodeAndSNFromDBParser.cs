...
{
	public class InventProductUpdate2BarcodeAndSNFromDBParser : InventProductParserBase, IInventProductSimpleParser
	{
		private readonly IInventProductRepository _inventProductRepository;

		public InventProductUpdate2BarcodeAndSNFromDBParser(
		...
		Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			foreach (InventProduct inventProduct in inventProducts)
			{
				...
				//{
				newBarcode = barcode + "|" + serialNumber;
				//}

				//newInventProduct.Barcode = newMakat.CutLength(49);
				newInventProduct.Code = newBarcode.CutLength(299);
