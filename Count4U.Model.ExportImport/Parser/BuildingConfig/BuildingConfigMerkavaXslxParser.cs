...
{	 //Не используется в Count4U 		 см PropertyStrBuildingConfigMerkavaXslxParser
	// используется в SQLite
	public class BuildingConfigMerkavaXslxParser : IBuildingConfigParser
	{
		...
		public BuildingConfigMerkavaXslxParser(IServiceLocator serviceLocator,
			ILog log)
		{
