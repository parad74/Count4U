...
{
	public class LocationYesXlsxParserSN : ILocationParser
	{
		...
		public LocationYesXlsxParserSN(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				//{
					...
					newLocationString.Name = locationCode;
					newLocationString.Level1 = locationCode;
					newLocationString.Name1 = locationCode;
