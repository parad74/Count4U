...
{
	public class LocationNativPlusLadpcParser : ILocationParser
	{
		...
		public LocationNativPlusLadpcParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				String[] recordEmpty = { "", ""};
					...
					string locationCode = recordEmpty[0].CutLength(49);
					string locationName = newLocationString.Name = recordEmpty[1].ReverseDosHebrew(invertLetter, rt2lf);
					newLocationString.Code = locationCode;
					newLocationString.Name = locationName;
					newLocationString.Level1 = locationCode;
					newLocationString.Name1 = locationName;
