...
{
	public class ProductCatalogOrenOriginalsParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogOrenOriginalsParser1(IServiceLocator serviceLocator,
			ILog log)
