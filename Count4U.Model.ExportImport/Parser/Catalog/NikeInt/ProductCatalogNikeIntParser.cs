...
{
	// ВНИМАНИЕ !!! the same parcer used in ShalevetCsv
	public class ProductCatalogNikeIntParser : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogNikeIntParser(IServiceLocator serviceLocator,
			ILog log)
...
//	Field1: Item Code
//Field1:Barcode (Cut 12 from right)
//Field2: Name
