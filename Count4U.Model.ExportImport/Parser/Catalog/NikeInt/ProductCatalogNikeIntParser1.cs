...
{
	public class ProductCatalogNikeIntParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogNikeIntParser1(IServiceLocator serviceLocator,
			ILog log)
