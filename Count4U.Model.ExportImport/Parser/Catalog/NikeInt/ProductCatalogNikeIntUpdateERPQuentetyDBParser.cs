...
namespace Count4U.Model.Count4U
{
    ...
    public class ProductCatalogNikeIntUpdateERPQuentetyDBParser : BaseProductCatalogParser, IProductSimpleParser
    {
        private readonly IProductRepository _productRepository;
        private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

		public ProductCatalogNikeIntUpdateERPQuentetyDBParser(IProductRepository productRepository,
            ILog log,
