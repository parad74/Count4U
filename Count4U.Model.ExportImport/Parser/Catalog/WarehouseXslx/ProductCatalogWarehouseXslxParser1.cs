...
{
	public class ProductCatalogWarehouseXslxParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogWarehouseXslxParser1(IServiceLocator serviceLocator,
			ILog log)
