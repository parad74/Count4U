...
{
	public class ProductCatalogWarehouseXslxParser3 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogWarehouseXslxParser3(IServiceLocator serviceLocator,
			ILog log)
