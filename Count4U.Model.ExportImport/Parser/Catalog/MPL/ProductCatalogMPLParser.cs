...
{
	public class ProductCatalogMPLParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogMPLParser(IServiceLocator serviceLocator,
			ILog log)
...
//Field6: Section Name (optional)		5
				...
				if (record.Length > 4)				  //>4
				{
					string sectionCode = record[4].Trim(' ');		 //	record[4]
