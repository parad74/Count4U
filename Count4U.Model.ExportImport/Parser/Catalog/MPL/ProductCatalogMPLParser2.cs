...
{
	public class ProductCatalogMPLParser2 : BaseProductCatalogParser, IProductSimpleParser
	{
		
		public ProductCatalogMPLParser2(
...
//Field1: BranchName					0
//Field2: Item Code					1
//Field3: Itur code ERP				2
//Field4: Quantity Expected Per Item code in Itur code ERP ***		3
				...
				string iturCodeERP = record[2].Trim();
				...
				if (record.Length > 3)
				{
					string balanceQuantityERP = record[3].Trim(' ');
