...
namespace Count4U.Model.Count4U
{
	...
	public class ProductCatalogMPLUpdateERPQuentetyDBParser1 :BaseProductCatalogParser, IProductSimpleParser
	{
		private readonly IProductRepository _productRepository;
		private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

		public ProductCatalogMPLUpdateERPQuentetyDBParser1(IProductRepository productRepository,
			ILog log, 
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			//==================================
			Dictionary<string, ProductSimple> productQuantityERPDictionary = this._productRepository.GetProductQuantityERPDictionary(dbPath);
			...
			this._productRepository.DeleteAllMakat(dbPath);
			//===========================================================
			foreach (Product product in productMakatOnlyFromDB)
			{
				...
				{
					product.BalanceQuantityERP = ps.BalanceQuantityERP;
				}
