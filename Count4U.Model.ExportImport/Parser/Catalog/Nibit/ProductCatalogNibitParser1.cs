...
{
	public class ProductCatalogNibitParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogNibitParser1(IServiceLocator serviceLocator,
			ILog log)
...
//Field1: Barcode (col 2-14)
//Field2: Item Code (col 16-28) 
//Field1 goes into Barcode
//Field2 is ParentMakat
