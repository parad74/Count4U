...
{
	public class ProductCatalogForComaxASPParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogForComaxASPParser1(IServiceLocator serviceLocator,
			ILog log)
