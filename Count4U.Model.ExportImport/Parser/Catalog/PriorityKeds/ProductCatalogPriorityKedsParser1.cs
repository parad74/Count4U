...
{
	public class ProductCatalogPriorityKedsParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogPriorityKedsParser1(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			{
				//10763762608,107637,ееси сшйв,10763762608
				// 0						,1			, 2				,3
