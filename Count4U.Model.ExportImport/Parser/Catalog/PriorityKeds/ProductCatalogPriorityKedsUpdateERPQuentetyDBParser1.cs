...
{
	public class ProductCatalogPriorityKedsUpdateERPQuentetyDBParser1 :BaseProductCatalogParser, IProductSimpleParser
	{
		private readonly IProductRepository _productRepository;
		private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

		public ProductCatalogPriorityKedsUpdateERPQuentetyDBParser1(IProductRepository productRepository,
			ILog log, 
...
//mlout.txt
   ...
   // makat,  Quantity Expected,  
		...
		countExcludeFirstString))
			...
			IEnumerable<Product> productFromDB = this._productRepository.GetProducts(dbPath) ;
			...
			foreach (Product productSimple in productFromDB)
			{
