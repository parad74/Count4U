...
{
	public class ProductCatalogPriorityKedsParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogPriorityKedsParser(IServiceLocator serviceLocator,
			ILog log)
...
//Field3: Name				   2
				...
				string sectionCode = record[1].Trim();
				if (sectionCode == "9998")
				{
					sectionCode = "998";
				}
				...
				{
					sectionCode = record[1].Trim().LeadingZero3();
				}
