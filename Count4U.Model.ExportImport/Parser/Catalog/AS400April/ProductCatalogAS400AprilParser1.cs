...
{
	public class ProductCatalogAS400AprilParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogAS400AprilParser1(IServiceLocator serviceLocator,
			ILog log)
