...
{
	public class ProductCatalogOrenMutagimParser : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogOrenMutagimParser(IServiceLocator serviceLocator,
			ILog log)
...
//Field1: Barcode						 0
//Field2: subsectionCode 		 1
//Field3: SupplierCode			 2
...
//Field6: Item Code					 5
				...
				string supplierName = "";
				supplierName = record[2].Trim();

				string sectionName = "";
				sectionName = record[3].Trim();

				string subsectionName = "";
				subsectionName = record[1].Trim();
   			
				newMakatProductSimpleString.Makat = makat;
				newMakatProductSimpleString.SupplierCode = supplierName;
				newMakatProductSimpleString.Name = productName;
				newMakatProductSimpleString.SectionCode = sectionName;
				...
				newMakatProductSimple.SupplierName = supplierName;
				newMakatProductSimple.SectionName = sectionName;
				newMakatProductSimple.SubSectionCode = subsectionName;
				newMakatProductSimple.SubSectionName = subsectionName;
