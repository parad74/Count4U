...
{
	public class ProductCatalogOrenMutagimParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogOrenMutagimParser1(IServiceLocator serviceLocator,
			ILog log)
