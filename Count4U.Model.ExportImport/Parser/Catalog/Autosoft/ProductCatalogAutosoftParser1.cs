...
{
	public class ProductCatalogAutosoftParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogAutosoftParser1(IServiceLocator serviceLocator,
			ILog log)
