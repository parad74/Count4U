...
{
	public class ProductCatalogAutosoftParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogAutosoftParser(IServiceLocator serviceLocator,
			ILog log)
...
//Field11: PriceBuy (col 195-204)
			...
			startEndSubstring.Add(new Point(catalogParserPoints.CatalogPriceSaleStart, catalogParserPoints.CatalogPriceSaleEnd));
				...
				countExcludeFirstString))
			{
				...
				//Field11: PriceBuy (col 195-204)									   4
				//Field7: PriceSell(col 103 - 112)									 5
				//===========Product=======================================
				...
				string priceSell = record[5].Trim();
				priceSell = String.IsNullOrEmpty(priceSell) ? "0" : priceSell;
				newProductSimpleString.PriceSale = priceSell;
