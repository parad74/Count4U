...
{
	public class ProductCatalogGazitLeeCooperParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogGazitLeeCooperParser(IServiceLocator serviceLocator,
			ILog log)
