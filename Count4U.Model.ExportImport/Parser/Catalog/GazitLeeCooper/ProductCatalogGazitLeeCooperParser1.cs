...
{
	public class ProductCatalogGazitLeeCooperParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogGazitLeeCooperParser1(IServiceLocator serviceLocator,
			ILog log)
