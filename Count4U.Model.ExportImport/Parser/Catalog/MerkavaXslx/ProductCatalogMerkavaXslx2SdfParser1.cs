...
{
	//не используется
	public class ProductCatalogMerkavaXslx2SdfParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogMerkavaXslx2SdfParser1(IServiceLocator serviceLocator,
			ILog log)
