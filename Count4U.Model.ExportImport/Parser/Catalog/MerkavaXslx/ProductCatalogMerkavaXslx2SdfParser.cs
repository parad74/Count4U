...
{
	public class ProductCatalogMerkavaXslx2SdfParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogMerkavaXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
