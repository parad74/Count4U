...
{
	public class ProductCatalogMiniSoftParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogMiniSoftParser1(IServiceLocator serviceLocator,
			ILog log)
