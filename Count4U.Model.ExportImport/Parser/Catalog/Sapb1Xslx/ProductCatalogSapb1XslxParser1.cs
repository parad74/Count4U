...
{
	public class ProductCatalogSapb1XslxParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogSapb1XslxParser1(IServiceLocator serviceLocator,
			ILog log)
