...
{
    public class ProductCatalogSapb1XslxUpdateERPQuentetyDBParser1 : BaseProductCatalogParser, IProductSimpleParser
    {
        private readonly IProductRepository _productRepository;
        private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

		public ProductCatalogSapb1XslxUpdateERPQuentetyDBParser1(IProductRepository productRepository,
            ILog log,
        ...
        countExcludeFirstString))
            {
				...
				//Field1 goes into Makat										 A			0
				//  Field5 goes into BalanceQuantityERP 				E		   4
                ...
                newProductSimpleString.BalanceQuantityERP = record[4].Trim(' ');
