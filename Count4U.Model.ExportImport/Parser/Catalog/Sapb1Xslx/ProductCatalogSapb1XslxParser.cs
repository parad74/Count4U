...
{
	public class ProductCatalogSapb1XslxParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogSapb1XslxParser(IServiceLocator serviceLocator,
			ILog log)
