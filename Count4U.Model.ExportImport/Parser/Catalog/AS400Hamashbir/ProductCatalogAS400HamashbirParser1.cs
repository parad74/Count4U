...
{
	public class ProductCatalogAS400HamashbirParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogAS400HamashbirParser1(IServiceLocator serviceLocator,
			ILog log)
