...
{
	public class ProductCatalogNativPlusLadpcParser : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogNativPlusLadpcParser(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				string itemType = record[5].Trim();
				string unitTypeCode = "Q";
				if (itemType == @"מתכלה") 
				{
					continue; 
				}
				else if (itemType == @"אינוונטר") { unitTypeCode = "Q"; }	  // itemType=Q
				else if (itemType == @"מוטבע") {unitTypeCode = "SN"; }//itemType=SN
				else 
				{
					base.Log.Add(MessageTypeEnum.TraceParser, String.Format(ParserFileErrorMessage.NoExpectedMarker, record.JoinRecord(separator)));
					continue; 
				}

				newMakatProductSimpleString.UnitTypeCode = unitTypeCode;												
