...
{
	public class ProductCatalogYesXslxParserSN : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogYesXslxParserSN(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				string productName = record[3].ReverseDosHebrew(invertLetter, rt2lf);			 //Field3: Item Name						 1
				...
				newMakatProductSimpleString.UnitTypeCode = "SN";												
