...
{
	public class ProductCatalogForUnizagParser3 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogForUnizagParser3(IServiceLocator serviceLocator,
			ILog log)
