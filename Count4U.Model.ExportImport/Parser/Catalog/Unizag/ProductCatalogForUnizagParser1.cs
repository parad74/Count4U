...
{
	public class ProductCatalogForUnizagParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogForUnizagParser1(IServiceLocator serviceLocator,
			ILog log)
