...
{
	public class ProductCatalogFRSVisionMirkamParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogFRSVisionMirkamParser1(IServiceLocator serviceLocator,
			ILog log)
