...
{
	public class ProductCatalogAvivMultiParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogAvivMultiParser1(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				//2,добешвш бмзорйд,027467003422,0274670073422,027467007342,,,,,,,,,,,
				//0,	1,							2,
