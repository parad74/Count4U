...
{
	public class ProductCatalogAvivMultiParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogAvivMultiParser(IServiceLocator serviceLocator,
			ILog log)
