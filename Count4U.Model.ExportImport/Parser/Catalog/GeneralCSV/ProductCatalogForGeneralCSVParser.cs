...
{
	public class ProductCatalogForGeneralCSVParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogForGeneralCSVParser(IServiceLocator serviceLocator,
			ILog log)
...
//Field7: Section Name (optional)  //6	! 5->6
				...
				if (record.Length > 5)				  //>4
				{
					string sectionCode = record[5].Trim(' ');		 //	record[4]
