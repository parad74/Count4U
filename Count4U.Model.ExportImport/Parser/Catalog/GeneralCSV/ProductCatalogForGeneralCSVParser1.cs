...
{
	public class ProductCatalogForGeneralCSVParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogForGeneralCSVParser1(IServiceLocator serviceLocator,
			ILog log)
