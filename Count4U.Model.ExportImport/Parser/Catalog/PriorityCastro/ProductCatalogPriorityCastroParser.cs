...
{
	public class ProductCatalogPriorityCastroParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogPriorityCastroParser(IServiceLocator serviceLocator,
			ILog log)
...
//Field2: Barcode (col 16-28)
//Field3: Name (col 29-58) - Optional
