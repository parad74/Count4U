...
{
	public class ProductCatalogForXtechMeuhedetParser2 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogForXtechMeuhedetParser2(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				{
					//Log.Add(MessageTypeEnum.WarningParser, String.Format(ParserFileErrorMessage.BarcodeIsEmpty, record.JoinRecord(separator)));
					continue;
				}
				...
				newProductSimpleString.CountInParentPack = "1";//quantityInPack.FormatComa2();
