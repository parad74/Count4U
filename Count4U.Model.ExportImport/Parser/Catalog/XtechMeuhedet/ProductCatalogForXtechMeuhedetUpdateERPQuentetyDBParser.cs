...
{
	public class ProductCatalogForXtechMeuhedetUpdateERPQuentetyDBParser :BaseProductCatalogParser, IProductSimpleParser
	{
		private readonly IProductRepository _productRepository;
		private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

		public ProductCatalogForXtechMeuhedetUpdateERPQuentetyDBParser(IProductRepository productRepository,
			ILog log, 
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			//SFMLAY.DAT
//Field1: ERP Code Branch (col 1-6)
//Field2: Item Code (col 5-11)
//Field3: Quantity Expected (col 20-30)
				...
				countExcludeFirstString))
			{
				...
				// 0			               1			2			
				//ERPCodeBranch  makat	 QuantityExpected
				//5510100130         00000000100*
				...
				newProductSimpleString.BalanceQuantityERP = record[1].FormatComa3();
				//newProductSimpleString.SectionCode = record[4].Trim();
				//string priceSale = record[2];
				//newProductSimpleString.PriceSale = priceSale.FormatComa2();
				//string priceBuy = record[3];
