...
{
	public class ProductCatalogForPriorityRenuarParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogForPriorityRenuarParser1(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			});	//Point( 16, 28, 13));	 //28 - 16 + 1			(col 17-29) 
