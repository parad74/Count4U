...
{
	public class ProductCatalogAS400MangoParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogAS400MangoParser(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			//Field2: Name (col 17-41)
			//Field3: Barcode (col 43-54) 
				...
				countExcludeFirstString))
			{
				...
				String[] record = { "", "", ""};
				//Field1: Item Code (col 1-12)			0
				//Field2: Name (col 17-41)				1
				//Field3: Barcode (col 43-54)			2
