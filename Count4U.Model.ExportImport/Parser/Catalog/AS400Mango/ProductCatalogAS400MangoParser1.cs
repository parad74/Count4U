...
{
	public class ProductCatalogAS400MangoParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogAS400MangoParser1(IServiceLocator serviceLocator,
			ILog log)
