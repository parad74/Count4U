...
{
	public class ProductCatalogGazitAlufHaSportXlsxParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogGazitAlufHaSportXlsxParser(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
  		...
  		foreach (String[] record in fileParser.GetRecords(fromPathFile,
			...
			{
//	Field1 goes into Barcode 											  0
//Field2 goes into Family & Makat*										  1
//Field3 goes into Family.Type & Makat*								   2
//Field4 goes goes into Family.Size & Makat*						 3
//Field5 goes into Name															4
