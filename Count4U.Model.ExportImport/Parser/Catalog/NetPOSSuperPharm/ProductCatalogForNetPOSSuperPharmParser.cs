...
{
	public class ProductCatalogForNetPOSSuperPharmParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogForNetPOSSuperPharmParser(IServiceLocator serviceLocator,
			ILog log)
