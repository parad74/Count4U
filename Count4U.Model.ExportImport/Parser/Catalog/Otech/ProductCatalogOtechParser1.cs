...
{
	public class ProductCatalogOtechParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogOtechParser1(IServiceLocator serviceLocator,
			ILog log)
