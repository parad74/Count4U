...
{
	public class ProductCatalogOtechParser2 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogOtechParser2(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				//Field1: Item Code 		   //0
				//	column 3+4+5 together is barcode2	  2 + 3 + 4
				
				string makat = record[0].Trim();
				string barcode = record[2].Trim() + record[3].Trim() + record[4].Trim();
				...
				newBarcodeProductSimpleString.BalanceQuantityERP = "0";
