...
{
	public class ProductCatalogOtechParser : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogOtechParser(IServiceLocator serviceLocator,
			ILog log)
