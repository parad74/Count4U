...
{
	public class ProductCatalogComaxASPMultiBarcodeParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogComaxASPMultiBarcodeParser1(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			//if (encoding == Encoding.GetEncoding(862))
			//{
			//    invertWords = parms.GetBoolValueFromParm(ImportProviderParmEnum.InvertWords);
			//}
				...
				countExcludeFirstString))
			{
				...
				//productMakatDBDictionary.Add(newBarcodeProductSimple.Makat,
				//    new ProductMakat
				//    {
				//        Makat = newBarcodeProductSimple.Makat,
				//        Name = "",
				//        ParentMakat = newBarcodeProductSimple.ParentMakat,
				//        MakatOriginal = newBarcodeProductSimple.MakatOriginal,
