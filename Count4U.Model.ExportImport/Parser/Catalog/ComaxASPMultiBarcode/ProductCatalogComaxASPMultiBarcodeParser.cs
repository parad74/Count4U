...
{
	public class ProductCatalogComaxASPMultiBarcodeParser : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogComaxASPMultiBarcodeParser(IServiceLocator serviceLocator,
			ILog log)
