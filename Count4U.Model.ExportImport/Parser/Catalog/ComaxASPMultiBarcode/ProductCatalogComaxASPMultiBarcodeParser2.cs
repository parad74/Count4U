...
{
	public class ProductCatalogComaxASPMultiBarcodeParser2 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogComaxASPMultiBarcodeParser2(IServiceLocator serviceLocator,
			ILog log)
