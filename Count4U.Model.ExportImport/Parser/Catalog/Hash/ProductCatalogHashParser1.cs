...
{
	public class ProductCatalogHashParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogHashParser1(IServiceLocator serviceLocator,
			ILog log)
