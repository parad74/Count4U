...
{
	public class ProductCatalogAS400HonigmanParser2 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogAS400HonigmanParser2(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				if (makat.Length > 6) makat = makat.Substring(0, 6);
