...
{
	public class ProductCatalogXtechMeuhedetXLSXParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogXtechMeuhedetXLSXParser1(IServiceLocator serviceLocator,
			ILog log)
