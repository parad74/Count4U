...
{
	public class ProductCatalogXtechMeuhedetXLSXParser2 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogXtechMeuhedetXLSXParser2(IServiceLocator serviceLocator,
			ILog log)
