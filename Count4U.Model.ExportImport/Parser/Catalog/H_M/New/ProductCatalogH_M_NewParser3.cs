...
{
	public class ProductCatalogH_M_NewParser3 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogH_M_NewParser3(IServiceLocator serviceLocator,
			ILog log)
