...
{
	public class ProductCatalogH_M_NewParser2 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogH_M_NewParser2(IServiceLocator serviceLocator,
			ILog log)
