...
{
	public class ProductCatalogAS400HoParser1 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogAS400HoParser1(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
					...
					countExcludeFirstString))
			{
				...
				//Field1: Item Code				0
				//Field2: Section Code			1
				//Field3: Supplier Code		2	   
				//	Field4 : Barcode1				3	??
				//Field5 : 		4								   Family code (no need to import for now)
				//Field6: Name					5
				//Field7: Item Type				 6			Field6: "" = Q \ Y = SN
