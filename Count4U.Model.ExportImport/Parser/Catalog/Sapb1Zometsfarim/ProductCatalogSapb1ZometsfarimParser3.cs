...
{
	public class ProductCatalogSapb1ZometsfarimParser3 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogSapb1ZometsfarimParser3(IServiceLocator serviceLocator,
			ILog log)
