...
{
	public class ProductCatalogSapb1ZometsfarimParser2 : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogSapb1ZometsfarimParser2(IServiceLocator serviceLocator,
			ILog log)
