...
{
	public class ProductCatalogPrioritySweetGirlXLSXParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogPrioritySweetGirlXLSXParser(IServiceLocator serviceLocator,
			ILog log)
