...
{
	public class ProductCatalogForYarpaUpdateERPQuentetyWindowsDBParser1 :BaseProductCatalogParser, IProductSimpleParser
	{
		private readonly IProductRepository _productRepository;
		private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

		public ProductCatalogForYarpaUpdateERPQuentetyWindowsDBParser1(IProductRepository productRepository,
			ILog log, 
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			//H            3498 03122012
//mlout.txt
   // 67397,     11, Quantity Expected
   // makat,  Quantity Expected,  Quantity Type .
		...
		countExcludeFirstString))
			{
			   ...
			   //-------------
				string  quantityType = record[2].Trim();
				if (string.IsNullOrWhiteSpace(quantityType) == false && quantityType == ".")			//BalanceQuantityPartialERP
				{
