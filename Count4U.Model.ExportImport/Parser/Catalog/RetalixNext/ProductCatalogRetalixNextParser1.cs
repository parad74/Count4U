...
{
	public class ProductCatalogRetalixNextParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogRetalixNextParser1(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			//Toinfo.txt
			//Field1: Item Code (col 1-13)  Makat with MakatMask
			//Field1: Item Code (col 1-13)  Barcode with BarcodeMask
