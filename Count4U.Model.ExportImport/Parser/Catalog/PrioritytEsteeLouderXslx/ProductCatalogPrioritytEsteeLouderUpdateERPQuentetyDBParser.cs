...
{
    public class ProductCatalogPrioritytEsteeLouderUpdateERPQuentetyDBParser : BaseProductCatalogParser, IProductSimpleParser
    {
        private readonly IProductRepository _productRepository;
        private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

		public ProductCatalogPrioritytEsteeLouderUpdateERPQuentetyDBParser(IProductRepository productRepository,
            ILog log,
...
//Field1: BranchCodeERP
//Field2: Item Code 
//Field3: Quantity Expected
                ...
                newProductSimpleString.BalanceQuantityERP = record[6].Trim(' ');
