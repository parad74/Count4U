...
{
	public class ProductCatalogAvivPOSParser2 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogAvivPOSParser2(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				string barcode = record[0].Trim();				//field1 - mask : 7290000000000 - Barcode1
