...
{
	public class ProductCatalogAvivPOSParser3 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogAvivPOSParser3(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				// only case 1:	Item has 2 codes (field1 -long item code & field 2- short item code)
				string makat = record[0].Trim();					 //field1 - mask : 0000000000000 - Item code
				string barcode = record[1].Trim();				//field2 - mask : 0000000000000 - Barcode3
