...
{
	public class ProductCatalogTafnitMatrixParser2 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogTafnitMatrixParser2(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				//Field1: Item Code						0   Makat without space
				//Field1: Item Code						0  Barcode with space right add to lenth 14 

				string makat = record[0].Trim();
				string barcode = record[0].PadRight(14,' ');
