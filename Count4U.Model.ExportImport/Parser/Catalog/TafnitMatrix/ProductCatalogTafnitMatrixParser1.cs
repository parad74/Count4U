...
{
	public class ProductCatalogTafnitMatrixParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogTafnitMatrixParser1(IServiceLocator serviceLocator,
			ILog log)
