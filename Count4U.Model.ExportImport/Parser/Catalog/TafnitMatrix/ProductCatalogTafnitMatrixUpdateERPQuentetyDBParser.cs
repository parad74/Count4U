...
{
    public class ProductCatalogTafnitMatrixUpdateERPQuentetyDBParser : BaseProductCatalogParser, IProductSimpleParser
    {
        private readonly IProductRepository _productRepository;
        private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

        public ProductCatalogTafnitMatrixUpdateERPQuentetyDBParser(IProductRepository productRepository,
            ILog log,
        ...
        countExcludeFirstString))
            {
                ...
                newProductSimpleString.BalanceQuantityERP = record[5].Trim(' ');
