...
{
	public class ProductCatalogLadyComfortParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogLadyComfortParser(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				newProductSimpleString.PriceSale = record[4].Trim();
