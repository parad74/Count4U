...
{
	public class ProductCatalogNimrodAvivParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogNimrodAvivParser1(IServiceLocator serviceLocator,
			ILog log)
