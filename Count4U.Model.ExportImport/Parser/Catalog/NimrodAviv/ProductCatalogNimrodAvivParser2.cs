...
{
	public class ProductCatalogNimrodAvivParser2 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogNimrodAvivParser2(IServiceLocator serviceLocator,
			ILog log)
