...
{
	public class ProductCatalogMikramSonolParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogMikramSonolParser1(IServiceLocator serviceLocator,
			ILog log)
