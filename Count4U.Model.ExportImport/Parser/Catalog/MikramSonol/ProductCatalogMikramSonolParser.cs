...
{
	public class ProductCatalogMikramSonolParser : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogMikramSonolParser(IServiceLocator serviceLocator,
			ILog log)
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				newMakatProductSimpleString.PriceSale = priceBuy; 
				...
				//newMakatProductSimpleString.PriceSale = "0";
				newMakatProductSimpleString.SectionCode = record[4].Trim().LeadingZero3(); 
