...
{
	public class ProductCatalogPriorityAldoParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogPriorityAldoParser1(IServiceLocator serviceLocator,
			ILog log)
