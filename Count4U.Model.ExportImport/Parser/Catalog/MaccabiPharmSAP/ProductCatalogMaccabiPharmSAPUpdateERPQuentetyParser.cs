...
{
	public class ProductCatalogMaccabiPharmSAPUpdateERPQuentetyParser :BaseProductCatalogParser, IProductSimpleParser
	{
		private readonly IProductRepository _productRepository;
		private readonly IImportCatalogADORepository _importCatalogSimpleRepository;

		public ProductCatalogMaccabiPharmSAPUpdateERPQuentetyParser(IProductRepository productRepository,
			ILog log, 
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
			...
			//Field1 For Branch Code compare
			//Field2 goes into Makat
			//Field3 goes into ERP Quantity Expected (Format 7.3) 
			//(Format ***)
			//			2346	57106	2.195
		...
		countExcludeFirstString))
			{
				//Field1 For Branch Code compare   0
				//Field2 goes into Makat					1
				//Field3 goes into ERP Quantity Expected (Format 7.3)   2
				//(Format ***)
				//			2346	57106	2.195		
			...
			foreach (Product productSimple in productFromDBSimples)
			{
				...
				{
					productSimple.BalanceQuantityERP = 0.000;
