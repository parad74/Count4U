...
{
	public class ProductCatalogMaccabiPharmSAPParser : BaseProductCatalogParser, IProductSimpleParser
	{

		public ProductCatalogMaccabiPharmSAPParser(IServiceLocator serviceLocator,
			ILog log)
...
//	Field11 goes into Price Sell        10
				...
				string countInParentPack = record[4];
