...
{
	public class ProductCatalogMade4NetParser1 : BaseProductCatalogParser, IProductSimpleParser
	{
		public ProductCatalogMade4NetParser1(IServiceLocator serviceLocator,
			ILog log)
