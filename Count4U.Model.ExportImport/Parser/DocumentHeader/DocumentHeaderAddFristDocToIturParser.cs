...
{
	public class DocumentHeaderAddFristDocToIturParser : IDocumentHeaderParser
	{																														  
		...
		public DocumentHeaderAddFristDocToIturParser(IDocumentHeaderRepository documentHeaderRepository,
