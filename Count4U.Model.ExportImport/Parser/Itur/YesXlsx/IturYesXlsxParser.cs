...
{					 
	public class IturYesXlsxParser : IIturParser
	{
		...
		public IturYesXlsxParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				Itur newItur = new Itur();
					...
					newIturString.LocationCode = recordEmpty[0];
					...
					else //	Error  retBit == 0 
					{
						...
						newItur.InvStatus = 0;
						newItur.LevelNum = 2;
						newItur.Name = recordEmpty[2].CutLength(49);
						...
						newItur.Name2 = recordEmpty[2].CutLength(249);//Level2Name
