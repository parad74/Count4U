...
namespace Count4U.Model.Count4U
{
	...
	// Пока только для Clalit такое правило
	public class IturUpdateClalitSqlite2SdfParser : IIturParser
	{
		...
		public IturUpdateClalitSqlite2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
