...
{					 
	public class IturNativPlusLadpcParser1 : IIturParser
	{
		...
		public IturNativPlusLadpcParser1(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				newIturString.IturCode = prfix + "0001";
				newIturString.ERPIturCode = newIturString.LocationCode;
				...
				else //	Error  retBit == 0 
				{
					...
					if (iturFromDBDictionary.IsDictionaryContainsKey(newItur.IturCode) == false)
					{
						...
						newItur.NodeType = 2;  //0 = Terminal Node  - изначально предполагаем что все терминальный
