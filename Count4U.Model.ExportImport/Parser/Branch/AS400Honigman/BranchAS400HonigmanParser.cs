...
{
	public class BranchAS400HonigmanParser : IBranchParser
	{
		...
		public BranchAS400HonigmanParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				string branchCodeLocal = record[0];
				...
				newBranch.BranchCodeERP = branchCodeLocal;
				//CodeERP
				...
				else //	Error  retBit == 0 
				{
					...
					//if (branchFromDBDictionary.ContainsKey(newItur.IturCode) == false)
					//{
					//    this._branchDictionary[newItur.IturCode] = newItur;
					//    branchFromDBDictionary[newItur.IturCode] = null;
