...
{
	public class BranchDefaultXlsxParser : IBranchParser
	{
		...
		public BranchDefaultXlsxParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//{
				//	if (rows[k] != null)  record[k] = rows[k].ToString();
				//}

				Branch newBranch = new Branch();

				//Code Local
				string branchCodeLocal = record[0].Trim();
				string branchCodeERP = record[0].Trim();
