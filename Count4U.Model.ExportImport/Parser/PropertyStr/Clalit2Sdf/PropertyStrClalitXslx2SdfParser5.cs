...
namespace Count4U.Model.Count4U
{
	...
	public class PropertyStrClalitXslx2SdfParser5 : IPropertyStrParser
	{
		...
		public PropertyStrClalitXslx2SdfParser5(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Field3: vend_id						2			  newPropertyStr.PropertyStrCode = recordEmpty[2];
				...
				int count = 4;
					...
					//PropertyStr3
					//CountExcludeFirstRow = 8	 / col =  3
					propertyStr.PropertyStrCode = recordEmpty[2];	 //	 vend_id
