...
namespace Count4U.Model.Count4U
{
	...
	public class PropertyStrClalitXslx2SdfParser3 : IPropertyStrParser
	{
		...
		public PropertyStrClalitXslx2SdfParser3(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Field3: model_id						2			//	 newPropertyStr.PropertyStrCode = recordEmpty[2];
				//Field4: model_name					3		  //	newPropertyStr.Name = recordEmpty[3];
				// PropertyStr4		  
				//CountExcludeFirstRow = 8	 // col =  3
				if (record.Length < 4)
				{
				...
				int count = 4;
					...
					//Field4: model_name					3		  //	newPropertyStr.Name = recordEmpty[3];
					// PropertyStr4		  
					propertyStr.PropertyStrCode = recordEmpty[2];	 //	model_id 
					propertyStr.Name = recordEmpty[3].ReverseDosHebrew(invertLetter, rt2lf); ;						//	model_name

					propertyStr.DomainObject = DomainObjectTypeEnum.PropertyStr4.ToString();
