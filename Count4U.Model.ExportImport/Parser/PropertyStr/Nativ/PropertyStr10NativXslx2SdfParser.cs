...
{	   
	public class PropertyStr10NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr10NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property10Str
				//Property10StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property10StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
				...
				int count = 2;
					...
					propertyStr.Name = recordEmpty[1].ReverseDosHebrew(invertLetter, rt2lf); ;						//	EmployeeName
					//propertyStr.Code = recordEmpty[1];						//	EmployeeID

					propertyStr.DomainObject = DomainObjectTypeEnum.PropertyStr10.ToString();
