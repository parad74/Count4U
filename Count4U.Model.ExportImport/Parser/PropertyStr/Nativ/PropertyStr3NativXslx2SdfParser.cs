...
{	   
	public class PropertyStr3NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr3NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property3Str
				//Property3StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property3StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
				...
				int count = 2;
					...
					propertyStr.DomainObject = DomainObjectTypeEnum.PropertyStr3.ToString();
