...
{	   
	public class PropertyStr2NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr2NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property2Str
				//Property2StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property2StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
