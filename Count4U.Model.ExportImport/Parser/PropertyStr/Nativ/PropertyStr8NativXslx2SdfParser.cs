...
{	   
	public class PropertyStr8NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr8NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property8Str
				//Property8StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property8StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
