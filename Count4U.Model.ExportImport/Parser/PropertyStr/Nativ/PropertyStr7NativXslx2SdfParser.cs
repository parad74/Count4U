...
{	   
	public class PropertyStr7NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr7NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property7Str
				//Property7StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property7StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
