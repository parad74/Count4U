...
{	   
	public class PropertyStr9NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr9NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property9Str
				//Property9StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property9StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
				...
				int count = 2;
					...
					propertyStr.DomainObject = DomainObjectTypeEnum.PropertyStr9.ToString();
