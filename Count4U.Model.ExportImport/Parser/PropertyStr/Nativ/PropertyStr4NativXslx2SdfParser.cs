...
{	   
	public class PropertyStr4NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr4NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property4Str
				//Property4StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property4StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
