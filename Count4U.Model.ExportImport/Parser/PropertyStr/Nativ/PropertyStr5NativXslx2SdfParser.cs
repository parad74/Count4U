...
{	   
	public class PropertyStr5NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr5NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property5Str
				//Property5StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property5StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
				...
				int count = 2;
					...
					propertyStr.DomainObject = DomainObjectTypeEnum.PropertyStr5.ToString();
