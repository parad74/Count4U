...
{	   
	public class PropertyStr6NativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr6NativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property6Str
				//Property6StrCode			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Property6StrName		  1 				 newPropertyStr.Name = recordEmpty[1];
