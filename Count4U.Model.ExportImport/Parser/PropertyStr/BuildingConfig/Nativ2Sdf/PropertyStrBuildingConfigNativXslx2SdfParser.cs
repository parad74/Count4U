...
{
	public class PropertyStrBuildingConfigNativXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStrBuildingConfigNativXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
