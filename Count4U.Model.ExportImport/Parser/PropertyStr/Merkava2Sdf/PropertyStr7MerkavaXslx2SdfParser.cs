...
{	   
	public class PropertyStr7MerkavaXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr7MerkavaXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				int count = 2;
					...
					propertyStr.DomainObject = DomainObjectTypeEnum.PropertyStr7.ToString();
