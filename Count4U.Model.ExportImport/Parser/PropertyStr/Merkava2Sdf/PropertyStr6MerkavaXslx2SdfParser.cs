...
{	   
	public class PropertyStr6MerkavaXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr6MerkavaXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				///EmployeeName		  1 				 newPropertyStr.Name = recordEmpty[1];

				//Property6Str
				// => на втором шаге связать
				//EmployeeCode			  0					newPropertyStr.PropertyStrCode
				//EmployeeID				 1 						 newPropertyStr.Code

				// нужен результат в БД
				//EmployeeCode			  0			newPropertyStr.PropertyStrCode
