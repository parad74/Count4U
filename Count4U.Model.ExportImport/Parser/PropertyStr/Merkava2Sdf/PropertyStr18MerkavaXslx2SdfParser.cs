...
{	   
	public class PropertyStr18MerkavaXslx2SdfParser : IPropertyStrParser
	{
		...
		public PropertyStr18MerkavaXslx2SdfParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				//Property18Str
				//Code			  0				newPropertyStr.PropertyStrCode = recordEmpty[0];
				///Name		  1 				 newPropertyStr.Name = recordEmpty[1];
				...
				int count = 2;
					...
					propertyStr.PropertyStrCode = recordEmpty[0];	 //	 Code
					propertyStr.Name = recordEmpty[1].ReverseDosHebrew(invertLetter, rt2lf); ;						//Name

					propertyStr.DomainObject = DomainObjectTypeEnum.PropertyStr18.ToString();
			...
			//	newPropertyStr.DomainObject = DomainObjectTypeEnum.PropertyStr18.ToString();
			//	this._propertyStrDictionary[newPropertyStr.PropertyStrCode] = newPropertyStr;
			//}
