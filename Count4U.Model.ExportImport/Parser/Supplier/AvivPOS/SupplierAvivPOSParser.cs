...
{
	public class SupplierAvivPOSParser : ISupplierParser
	{
		...
		public SupplierAvivPOSParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				string supplierCode = record[6].Trim();
				
				if (this._supplierDictionary.ContainsKey(supplierCode) == false)
				{
					string supplierName = record[7].ReverseDosHebrew(invertLetter, rt2lf); 
