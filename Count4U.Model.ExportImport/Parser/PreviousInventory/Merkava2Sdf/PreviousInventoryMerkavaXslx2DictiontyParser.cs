...
{
	public class PreviousInventoryMerkavaXslx2DictiontyParser : IPreviousInventorySQLiteParser
	{
		...
		public PreviousInventoryMerkavaXslx2DictiontyParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				sheetNumberXlsx))
			{
				...
				if (serialNumberLocal == "CNHX170096")
				{
					uid = uid.CutLength(49);
				}
