...
{
	public class SectionSapb1ZometsfarimParser1 : ISectionParser
	{
		...
		public SectionSapb1ZometsfarimParser1(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				string subSectionCode = record[8].Trim();//.LeadingZero3(); //record[4];
				...
				string sectionCode = record[6].Trim();//.LeadingZero3(); //record[4];
