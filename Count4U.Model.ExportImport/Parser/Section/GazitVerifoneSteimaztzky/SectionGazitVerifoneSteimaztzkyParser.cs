...
{
	public class SectionGazitVerifoneSteimaztzkyParser : ISectionParser
	{
		...
		public SectionGazitVerifoneSteimaztzkyParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				string sectionCode = record[13].Trim();//.LeadingZero3(); 
				newSectionString.SectionCode = sectionCode;

				newSectionString.Description = "";

				string name = record[14].Trim();
