...
{
	public class FamilyGeneralXLSXParser : IFamilyParser
	{
		...
		public FamilyGeneralXLSXParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				if (string.IsNullOrWhiteSpace(record[9].Trim()) == false)
				{
					familyCode = record[9].Trim(' ');
					familyName = record[9].Trim(' ');
				}
