...
{
	public class FamilyDefaultParser : IFamilyParser
	{
		...
		public FamilyDefaultParser(IServiceLocator serviceLocator,
			ILog log)
		{
			...
			Dictionary<ImportProviderParmEnum, object> parms = null)
		{
				...
				countExcludeFirstString))
			{
				...
				if (this._familyDictionary.ContainsKey(familyCode) == false)
				{
					...
					Family family = new Family { FamilyCode = familyCode, Name = familyName, Description = "", Type = type, Size = size, Extra1 = extra1, Extra2 = extra2 };
