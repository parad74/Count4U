...
{
	public class FamilyPriorityRenuarParser : IFamilyParser
	{
		...
		public FamilyPriorityRenuarParser(IServiceLocator serviceLocator,
			ILog log)
		{
...
//Field4: FamilySize	3
				...
				if (this._familyDictionary.ContainsKey(familyCode) == false)
				{
					...
					Family family = new Family { FamilyCode = familyCode, Name = familyName, Description = "", Type = type, Size = size, Extra1= "", Extra2=""};
