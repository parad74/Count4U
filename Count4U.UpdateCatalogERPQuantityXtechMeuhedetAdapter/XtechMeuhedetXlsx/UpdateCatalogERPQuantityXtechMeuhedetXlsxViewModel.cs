...
namespace Count4U.UpdateCatalogERPQuantityXtechMeuhedetXlsxAdapter
{																																				  
    public class UpdateCatalogERPQuantityXtechMeuhedetXlsxViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public UpdateCatalogERPQuantityXtechMeuhedetXlsxViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = String.Format("{0}SHAUL.csv", this._branchErpCode);//StoreXXX_SOH.txt 
		...
		{
			return base.ContinueAfterBranchERPWarning(base.Path, @"(.+)SHAUL\.csv");
		}
