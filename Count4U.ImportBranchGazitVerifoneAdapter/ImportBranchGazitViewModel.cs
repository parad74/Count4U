...
{
    public class ImportBranchGazitViewModel : TemplateAdapterOneFileViewModel    
    {
        ...
        public ImportBranchGazitViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this.PathFilter = "*.lum|*.lum|All files (*.*)|*.*";

			this._fileName = "Stores.lum";
		...
		{
//Field1: ERP Code (col 1-5) leading zeros
//Field2: Name (col 6-25)

			this._catalogParserPoints1 = new CatalogParserPoints
			{
				CatalogMinLengthIncomingRow = 5,
				CatalogItemCodeStart = 1,
				CatalogItemCodeEnd = 5,
				CatalogItemNameStart = 6,
				CatalogItemNameEnd = 25
			};
		}
        ...
        {
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportBranchGazitVerifoneProvider);
