...
{
    public class ImportCatalogAS400_LeumitViewModel : TemplateAdapterTwoFilesViewModel
    {
        ...
        public ImportCatalogAS400_LeumitViewModel(IServiceLocator serviceLocator,
        ...
        {
            if (_withQuantityERP == false)
                return true;

            try
            {
                string path = base.Path2;
        ...
        public override void InitDefault(CBIState state = null)
        {
            ...
            this._fileName1 = "TOMPARP.csv";//String.Format("sfpart{0}.dat", this._branchErpCode);
            this._fileName2 = "TOXXX.csv";//String.Format("sfmlay{0}.dat", this._branchErpCode);
        ...
        public override void Import()
        {
            ...
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400LeumitADOProvider);
            ...
            IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400LeumitADOProvider1);
