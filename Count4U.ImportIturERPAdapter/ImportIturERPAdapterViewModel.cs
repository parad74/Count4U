...
{
    public class ImportIturERPAdapterViewModel : TemplateAdapterFileFolderViewModel
    {
        private readonly IIturRepository _iturRepository;
		public string _fileName {get; set;}

        public ImportIturERPAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportIturERP Adapter");
			base.LogImport.Add(MessageTypeEnum.Trace, String.Format("Path : {0}", this.Path));

            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportIturERPADOProvider);
