...
{
    public class ImportBranchMirkamSonolViewModel : TemplateAdapterOneFileViewModel    
    {
        ...
        public ImportBranchMirkamSonolViewModel(IServiceLocator serviceLocator,
        ...
        {
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportBranchMikramSonolProvider);
