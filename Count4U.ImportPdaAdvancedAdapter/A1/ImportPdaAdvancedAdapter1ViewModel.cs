...
{
    public class ImportPdaAdvancedAdapter1ViewModel : ImportPdaAdvancedAdapterCommonViewModel
    {
        public ImportPdaAdvancedAdapter1ViewModel(
		...
		private void InitInventProductAdvancedField()		   //InitDefault
		{
        ...
        public override void InitFromIni()
        {
			...
			Dictionary<ImportProviderParmEnum, string> iniData1 = base.GetIniData("ImportPdaAdvancedAdapter1");			 //Init from Inin file
