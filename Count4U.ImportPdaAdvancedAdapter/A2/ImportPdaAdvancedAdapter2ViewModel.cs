...
{
    public class ImportPdaAdvancedAdapter2ViewModel : ImportPdaAdvancedAdapterCommonViewModel
    {
        public ImportPdaAdvancedAdapter2ViewModel(
        ...
        public override void InitFromIni()
        {
			...
			Dictionary<ImportProviderParmEnum, string> iniData1 = base.GetIniData("ImportPdaAdvancedAdapter2");
