...
namespace Count4U.ExportErpTextAdapter.AS400Mega
{
	public class ExportErpAS400MegaAdapterViewModel : ExportErpMakatViewModel
    {

		public ExportErpAS400MegaAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpAS400MegaAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
            ...
            if (base.CurrentBranch != null)
                branchCodeErp = base.CurrentBranch.BranchCodeERP.PadLeft(5,'0');
			...
			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductAS400MegaERPFileProvider.ToString());
