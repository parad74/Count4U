...
{
    public class ExportErpTafnitMatrixAdapterViewModel : ExportErpMakatViewModel
    {

		public ExportErpTafnitMatrixAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpTafnitMatrixAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
			...
			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductTafnitMatrixERPFileProvider.ToString());
			...
			IExportERPProvider provider2 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductTafnitMatrixERPFileProvider1.ToString());
