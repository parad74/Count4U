...
namespace Count4U.ExportErpTextAdapter.XtechMeuhedetXlsx
{
    public class ExportErpXtechMeuhedetXlsxAdapterViewModel : ExportErpMakatViewModel
    {

		public ExportErpXtechMeuhedetXlsxAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpXtechMeuhedetXlsxAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
			...
			if (base.CurrentBranch != null)
			{
				...
				branchName = base.CurrentBranch.Name;
			}
			...
			////FILE1
			string fileName1 = String.Format("sfira_{0}", branchCodeErp); //result file only name without extension            
			...
			IExportERPProvider provider1 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductXtechMeuhedetXlsxProvider.ToString());
			...
			provider1.Parms[ImportProviderParmEnum.InventorDate] = branchName;
			...
			provider1.Parms[ImportProviderParmEnum.ExcludeNotExistingInCatalog] = "0";
			...
			//FILE2
			string fileName2 = String.Format("sfiraEX_{0}", branchCodeErp); //result file only name without extension            
			string fileNameWithExtension2 = String.Format("{0}.tsv", fileName2);
			string fullPath2 = Path.Combine(base.PathToExportErp, fileNameWithExtension2);

			IExportERPProvider provider2 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductXtechMeuhedetXlsxProvider2.ToString());
			...
			provider2.Parms[ImportProviderParmEnum.InventorDate] = branchName;
			...
			//provider1.Parms[ImportProviderParmEnum.ExcludeNotExistingInCatalog] = info.IsExcludeNotExistingInCatalog ? "1" : String.Empty;
			provider2.Parms[ImportProviderParmEnum.ExcludeNotExistingInCatalog] = "0";
			...
			IExportERPProvider provider3 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductXtechMeuhedetXlsxProvider1.ToString());
