...
{
    public class ExportErpMirkamSonolSAPAdapterViewModel : ExportErpMakatViewModel
    {
        public ExportErpMirkamSonolSAPAdapterViewModel(IContextCBIRepository contextCbiRepository,
            ILog logImport,
        ...
        {
            return Path.Combine(base.GetModulesFolderPath(), "ExportErpMirkamSonolSAPAdapter.ini");            
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
			...
			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductMikramSonolSAPERPFileProvider.ToString());
			...
			IExportERPProvider provider1 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductMikramSonolSAPERPFileProvider1.ToString());
