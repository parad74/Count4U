...
namespace Count4U.ExportErpTextAdapter.XtechMeuhedet
{
    public class ExportErpXtechMeuhedetAdapterViewModel : ExportErpMakatViewModel
    {      
        public ExportErpXtechMeuhedetAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
            return Path.Combine(base.GetModulesFolderPath(), "ExportErpXtechMeuhedetAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
            ...
            //FILE1
            string fileName1 = String.Format("SFRA{0}", branchCodeErp); //result file only name without extension            
			...
			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductXtechMeuhedetERPFileProvider.ToString());
			...
			IExportERPProvider provider1 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductXtechMeuhedetERPFileProvider1.ToString());
