...
namespace Count4U.ExportErpTextAdapter.MaccabiPharmSAP
{
    public class ExportErpMaccabiPharmSAPAdapterViewModel : ExportErpMakatViewModel
    {

		public ExportErpMaccabiPharmSAPAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpMaccabiPharmSAPAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
            ...
            //FILE1
			string fileName1 = "stock-a"; //result file only name without extension            
			string fileNameWithExtension1 = "stock-a.txt";
            string fullPath1 = Path.Combine(base.PathToExportErp, fileNameWithExtension1);

			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductMaccabiPharmSAPERPFileProvider.ToString());
			...
			IExportERPProvider provider1 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductMaccabiPharmSAPERPFileProvider1.ToString());
