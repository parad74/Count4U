...
{
    public class ExportErpPriorityKedsRegularAdapterViewModel : ExportErpMakatViewModel
    {
      

        public ExportErpPriorityKedsRegularAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
            return Path.Combine(base.GetModulesFolderPath(), "ExportErpPriorityKedsRegularAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
			...
			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductPriorityKedsRegularERPFileProvider.ToString());
			...
			provider.Parms[ImportProviderParmEnum.BranchName] = branchName;
