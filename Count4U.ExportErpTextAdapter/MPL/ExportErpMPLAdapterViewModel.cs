...
namespace Count4U.ExportErpTextAdapter.MPL
{
    public class ExportErpMPLAdapterViewModel : ExportErpMakatViewModel
    {

		public ExportErpMPLAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpMPLAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
            ...
            //FILE1
			string fileName1 = String.Format("{0}_{1}", inventorDatefileName, branchCodeErp); //result file only name without extension            
			...
			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductMPLFileProvider.ToString());
