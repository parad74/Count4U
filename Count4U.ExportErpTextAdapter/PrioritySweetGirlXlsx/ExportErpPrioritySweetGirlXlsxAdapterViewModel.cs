...
namespace Count4U.ExportErpTextAdapter.PrioritySweetGirlXlsx
{
    public class ExportErpPrioritySweetGirlXlsxAdapterViewModel : ExportErpMakatViewModel
    {

		public ExportErpPrioritySweetGirlXlsxAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpPrioritySweetGirlXlsxAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
           ...
           // string inventorDate1 = string.Empty;
            ...
            //FILE1
			string fileName1 = "invcount"; //result file only name without extension            
			string fileNameWithExtension1 = "invcount.dat";
            string fullPath1 = Path.Combine(base.PathToExportErp, fileNameWithExtension1);

			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductPrioritySweetGirlXlsxErpFileProvider.ToString());
			...
			IExportERPProvider provider1 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductPrioritySweetGirlXlsxErpFileProvider1.ToString());
