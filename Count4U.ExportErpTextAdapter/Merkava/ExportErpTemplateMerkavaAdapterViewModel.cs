...
{
    public class ExportErpTemplateMerkavaAdapterViewModel : ExportErpMakatViewModel
    {
		protected string _photoPropertyName;
		protected string _pathPhoto;
		protected IConnectionDB _connection;
		public ExportErpTemplateMerkavaAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpTemplateMerkavaAdapter.ini");
        }
