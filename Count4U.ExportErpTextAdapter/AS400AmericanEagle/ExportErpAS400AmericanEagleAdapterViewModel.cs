...
namespace Count4U.ExportErpTextAdapter.AS400AmericanEagle
{
    public class ExportErpAS400AmericanEagleAdapterViewModel : ExportErpMakatViewModel
    {

		public ExportErpAS400AmericanEagleAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpAS400AmericanEagleAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
			...
			string fileName = String.Format("COUNT_{0}", branchCodeErp); //result file only name with extension            
			...
			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductAS400AmericanEagleERPFileProvider.ToString());
			...
			IExportERPProvider provider2 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductAS400AmericanEagleERPFileProvider1.ToString());
