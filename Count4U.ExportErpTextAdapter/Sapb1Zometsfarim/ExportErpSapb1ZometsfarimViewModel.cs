...
{
    public class ExportErpSapb1ZometsfarimAdapterViewModel : ExportErpMakatViewModel
    {

		public ExportErpSapb1ZometsfarimAdapterViewModel(IContextCBIRepository contextCbiRepository,
                                               ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpSapb1ZometsfarimAdapter.ini");
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
            ...
            //FILE1
			string fileName1 = "sfira_File1"; //result file only name without extension            
			string fileNameWithExtension1 = "sfira_File1.txt";
            string fullPath1 = Path.Combine(base.PathToExportErp, fileNameWithExtension1);

			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductSapb1ZometsfarimERPFileProvider.ToString());
