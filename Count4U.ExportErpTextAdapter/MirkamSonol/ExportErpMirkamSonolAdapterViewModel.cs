...
{
    public class ExportErpMirkamSonolAdapterViewModel : ExportErpMakatViewModel
    {      

        public ExportErpMirkamSonolAdapterViewModel(IContextCBIRepository contextCbiRepository,
            ILog logImport,
        ...
        {
            return Path.Combine(base.GetModulesFolderPath(), "ExportErpMirkamSonolAdapter.ini");            
        }
        ...
        protected override void RunExportInner(ExportErpCommandInfo info)
        {
			...
			IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductMikramSonolERPFileProvider.ToString());
			...
			IExportERPProvider provider1 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductMikramSonolERPFileProvider1.ToString());
