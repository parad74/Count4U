...
namespace Count4U.ExportErpTextAdapter.BazanCsv
{
    public class ExportErpBazanCsvAdapterViewModel: ExportErpModuleBaseViewModel
    {
		public ExportErpBazanCsvAdapterViewModel(IContextCBIRepository contextCbiRepository,
            ILog logImport,
        ...
        {
			return Path.Combine(base.GetModulesFolderPath(), "ExportErpBazanCsvAdapter.ini");
        }
        ...
        {         
			...
			//IExportERPProvider provider = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductBazanCsvERPFileProvider.ToString());
			...
			IExportERPProvider provider1 = base.ServiceLocator.GetInstance<IExportERPProvider>(ExportProviderEnum.ExportInventProductBazanCsvERPFileProvider1.ToString());
