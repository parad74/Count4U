...
{
	public class ImportCatalogGeneralXLSXViewModel : TemplateAdapterTwoFilesViewModel
    {
		...
		public ImportCatalogGeneralXLSXViewModel(IServiceLocator serviceLocator,
		...
		protected override void InitFromConfig(ImportCommandInfo info, CBIState state)
		{
			...
			base.State = state;
			if (info.FromConfigXDoc == ConfigXDocFromEnum.InitWithoutConfig) return;
			...
			if (File.Exists(configPath) == true)	   //если есть сохраненный файла config.xml
			{
				try
				{
					...
					if (this.FileName1.Contains("XXX") == true)
					{
						this.FileName1 = this.FileName1.Replace("XXX", this._branchErpCode);
					}
					if (this.FileName2.Contains("XXX") == true)
					{
						this.FileName2 = this.FileName2.Replace("XXX", this._branchErpCode);
					}

					base.Path1 = System.IO.Path.GetFullPath(importPath.Trim('\\') + @"\" + this.FileName1);
					base.Path2 = System.IO.Path.GetFullPath(importPath.Trim('\\') + @"\" + this.FileName2);
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this.PathFilter1 = "*.xlsx|*.xlsx|All files (*.*)|*.*";
         	this.FileName1 = "Catalog.xlsx";
			base.XlsxFormat1 = true;

			this.PathFilter2 = "*.csv|*.csv|All files (*.*)|*.*";
			this.FileName2 = String.Format("MLAY_{0}.csv", this._branchErpCode);
			base.XlsxFormat2 = false;
        ...
        public override void InitFromIni()
        {
            ...
            //init GUI
            this.FileName1 = iniData.SetValue(ImportProviderParmEnum.FileName1, this.FileName1);
            this.FileName2 = iniData.SetValue(ImportProviderParmEnum.FileName2, this.FileName2);
            ...
            base.Path1 = System.IO.Path.GetFullPath(base.GetImportPath().Trim('\\') + @"\" + this.FileName1);
			base.Path2 = System.IO.Path.GetFullPath(base.GetImportPath().Trim('\\') + @"\" + this.FileName2);
			if (System.IO.Path.GetExtension(base.Path1) == ".xlsx") base.XlsxFormat1 = true; else base.XlsxFormat1 = false;
			if (System.IO.Path.GetExtension(base.Path2) == ".xlsx") base.XlsxFormat2 = true; else base.XlsxFormat2 = false;
        ...
        public override void Import()
        {
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGeneralXLSXProvider1);
            ...
            {
				IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGeneralXLSXUpdateERPQuentetyADOProvider1);
				...
				provider2.Parms[ImportProviderParmEnum.FileXlsx] = base.XlsxFormat2 ? "1" : String.Empty;
			...
			//FileLogInfo fileLogInfo = new FileLogInfo();
			//fileLogInfo.File = this.Path1;
			//base.SaveFileOnlyPrintLog(fileLogInfo);
        }
