...
{
	public class ImportCatalogGeneralCSVViewModel : TemplateAdapterTwoFilesViewModel
    {
        ...
        public ImportCatalogGeneralCSVViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
            ...
            this._fileName1 = "producs.csv";//String.Format("sfpart{0}.dat", this._branchErpCode);
        ...
        public override void Import()
        {
            ...
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGeneralCSVADOProvider);
            ...
            IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGeneralCSVADOProvider1);
