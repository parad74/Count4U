...
{
    public class ImportAvivMultiBarcodesViewModel : TemplateAdapterTwoFilesViewModel
    {
        ...
        public ImportAvivMultiBarcodesViewModel(IServiceLocator serviceLocator,
          IContextCBIRepository contextCBIRepository,
          IEventAggregator eventAggregator,
          IRegionManager regionManager,
          ILog logImport,
          IIniFileParser iniParser,
		  ITemporaryInventoryRepository temporaryInventoryRepository,
          IUserSettingsManager userSettingsManager) :
			base(serviceLocator, contextCBIRepository, eventAggregator, regionManager, logImport, iniParser, temporaryInventoryRepository, userSettingsManager)
        {
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName1 = "AvivMulti.csv";//String.Format("sfpart{0}.dat", this._branchErpCode);
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAvivMultiADOProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAvivMultiADOProvider1);
			...
			{
				IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAvivMultiUpdateERPQuentetyADOProvider1);
