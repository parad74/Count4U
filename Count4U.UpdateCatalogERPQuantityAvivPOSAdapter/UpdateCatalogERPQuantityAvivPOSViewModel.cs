...
{																																				  
    public class UpdateCatalogERPQuantityAvivPOSViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		string _branchErpCode = String.Empty;

        public UpdateCatalogERPQuantityAvivPOSViewModel(IServiceLocator serviceLocator,
