...
namespace Count4U.ImportCatalogKitAdapter.OrenOriginals
{
    public class ImportCatalogOrenOriginalsViewModel : TemplateAdapterOneFileViewModel
    {
	...
	//	private bool _importSupplier;
		...
		public ImportCatalogOrenOriginalsViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
            ...
            //init GUI
			this.PathFilter = "*.itm|*.itm|All files (*.*)|*.*";
			this._fileName = "ABC.itm";
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogOrenOriginalsAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOrenOriginalsProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOrenOriginalsProvider1);
