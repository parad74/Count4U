...
namespace Count4U.ImportCatalogKitAdapter.OrenMutagim
{
    public class ImportCatalogOrenMutagimViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        private string _branchErpCode = String.Empty;
	
		public ImportCatalogOrenMutagimViewModel(IServiceLocator serviceLocator,
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogOrenMutagimAdapter.ini"));
            //init GUI
		...
		public override void Import()
		{
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOrenMutagimProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOrenMutagimProvider1);
