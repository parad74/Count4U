...
{
    public class ImportCatalogH_M_NewViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogH_M_NewViewModel(IServiceLocator serviceLocator,
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogH_M_NewAdapter.ini"));
            //init GUI
		...
		public override void Import()
		{
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogH_M_NewProvider);
			...
			//IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogH_M_NewProvider1);
			...
			if (this.WithBarcode == true)
			{
				...
				IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogH_M_NewProvider2);
				...
				IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogH_M_NewProvider3);
			...
			IImportProvider provider4 = this.GetProviderInstance(ImportProviderEnum.ImportSectionH_M_NewProvider);
			...
			//if (this.WithBarcode == true)
			//{
			//IImportProvider provider5 = this.GetProviderInstance(ImportProviderEnum.ImportFamilyH_M_NewProvider);
        ...
        public override void Clear()
        {
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportFamilyH_M_NewProvider);
			provider1.ToPathDB = base.GetDbPath;
			provider1.Clear();

			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportSectionH_M_NewProvider);
			provider2.ToPathDB = base.GetDbPath;
			provider2.Clear();
