...
{
    public class ImportCatalogLadyComfortViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogLadyComfortViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = "Lady_Comfort_Catalog.csv";
        ...
        {
				Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogLadyComfortAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
            ...
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogLadyComfortADOProvider);
			...
			{
				IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportFamilyLadyComfortADOProvider);
