...
{
    public class ImportCatalogRetalixNextViewModel : TemplateAdapterOneFileViewModel
    {
        ...
        public ImportCatalogRetalixNextViewModel(IServiceLocator serviceLocator,
        ...
        public override void Import()
        {
            ...
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogRetalixNextADOProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogRetalixNextADOProvider1);
            ...
            StepCurrent = 1;
            provider.Import();
            if (this.MakatMask.Trim().ToLower() != this.BarcodeMask.Trim().ToLower())
            {
                StepCurrent = 2;
                provider1.Import();
            }
