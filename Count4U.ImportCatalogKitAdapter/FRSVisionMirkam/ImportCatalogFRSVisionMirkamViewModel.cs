...
namespace Count4U.ImportCatalogKitAdapter.FRSVisionMirkam
{
    public class ImportCatalogFRSVisionMirkamViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogFRSVisionMirkamViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = "FRS_Catalog.txt";
			...
			//this.MakatMask = "0000000000000{S}";										  01.06.2021 Dolev ask
        ...
        public override void InitFromIni()
        {
			...
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogFRSVisionMirkamAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogFRSVisionMirkamADOProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogFRSVisionMirkamADOProvider1);
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportSectionFRSVisionMirkamProvider);
        ...
        public override void Clear()
        {
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportSupplierFRSVisionMirkamADOProvider);
			provider1.ToPathDB = base.GetDbPath;
			provider1.Clear();
