...
{
	// ВНИМАНИЕ !!! the same provider used in ShalevetCsv
    public class ImportCatalogNikeIntViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogNikeIntViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
		   ...
		   this._fileName = "NikeProdInfo_IsraelCount_WithExtraCodes.txt"; 
