...
namespace Count4U.ImportCatalogKitAdapter.GazitLeeCooper
{
    public class ImportCatalogGazitLeeCooperViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogGazitLeeCooperViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._catalogParserPoints = new CatalogParserPoints
			{
				...
				HamarotBarcodeStart = 24,
				HamarotBarcodeEnd = 37
			};
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogGazitLeeCooperAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGazitLeeCooperProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGazitLeeCooperProvider1);
