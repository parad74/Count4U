...
namespace Count4U.ImportCatalogKitAdapter.NikeInt
{

	//ВНИМАНИЕ use ImportCatalogNikeIntParser
    public class ImportCatalogShalevetCsvViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogShalevetCsvViewModel(IServiceLocator serviceLocator,
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogShalevetCsvProvider);
			...
			//IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogNikeIntProvider1);
