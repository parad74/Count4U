...
namespace Count4U.ImportCatalogYtungXlsxAdapter
{
	public class ImportCatalogYtungXlsxAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogYtungXlsxAdapterViewModel(IServiceLocator serviceLocator,
		...
		{
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogYtungXlsxAdapter.ini"));
			//init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogYtungXlsxProvider);
			...
			{
				IImportProvider provider4 = this.GetProviderInstance(ImportProviderEnum.ImportSectionGazitGlobalXlsxProvider);
        ...
        public override void Clear()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGazitGlobalXlsxProvider);
            provider.ToPathDB = base.GetDbPath;
            provider.Clear();
