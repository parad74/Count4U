...
namespace Count4U.ImportCatalogGazitAlufHaSportXlsxAdapter
{
	public class ImportCatalogGazitAlufHaSportXlsxAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogGazitAlufHaSportXlsxAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGazitAlufHaSportXlsxProvider);
