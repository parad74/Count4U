...
namespace Count4U.ImportCatalogMPLAdapter
{
    public class ImportCatalogMPLAdapterViewModel : TemplateAdapterTwoFilesViewModel
    {
		...
		public ImportCatalogMPLAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public bool ImportSection
        {
            ...
            set
            {
				...
				if (this.WithQuantityErp == true) base.StepTotal = base.StepTotal + 2;
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName1 = "Catalog.csv";//String.Format("sfpart{0}.dat", this._branchErpCode);
            this._fileName2 = String.Format("Stockbylocation_{0}.csv", this._branchErpCode);
			...
			base.StepTotal = 2;
			if (this._withQuantityERP == true)		base.StepTotal = base.StepTotal + 2;
			if (this.ImportSection == true)		base.StepTotal = base.StepTotal + 1;
        ...
        {
			return base.ContinueAfterBranchERPWarning(base.Path2, @"Stockbylocation_(.+)\.csv");
        }
        ...
        public override void Import()
        {
            ...
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMPLProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMPLProvider1);
			...
			{
				IImportProvider provider4 = this.GetProviderInstance(ImportProviderEnum.ImportSectionMPLProvider);
        ...
        public override void Clear()
        {
			...
			if (this.ImportSection == true)
			{
				IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportSectionMPLProvider);
				provider3.ToPathDB = base.GetDbPath;
				provider3.Clear();
			}
            UpdateLogFromILog();
