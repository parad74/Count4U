...
namespace Count4U.ImportCatalogGazitGlobalXlsxAdapter
{
	public class ImportCatalogGazitGlobalXlsxAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogGazitGlobalXlsxAdapterViewModel(IServiceLocator serviceLocator,
		...
		{
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogGazitGlobalXlsxAdapter.ini"));
			//init GUI
