...
namespace Count4U.ImportCatalogKitAdapter.AS400Mango
{
    public class ImportCatalogAS400MangoViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogAS400MangoViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			{
				CatalogMinLengthIncomingRow = 12,
				CatalogItemCodeStart = 1,
				CatalogItemCodeEnd = 12, 
				CatalogItemNameStart = 17,
				CatalogItemNameEnd = 41,
				HamarotBarcodeStart = 43,
				HamarotBarcodeEnd = 54
			};
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogAS400MangoAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
            ...
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400MangoProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400MangoProvider1);
