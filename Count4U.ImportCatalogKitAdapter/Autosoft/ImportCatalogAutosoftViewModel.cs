...
namespace Count4U.ImportCatalogKitAdapter.Autosoft
{
    public class ImportCatalogAutosoftViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogAutosoftViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._catalogParserPoints = new CatalogParserPoints
			{
				...
				CatalogPriceSaleStart = 103, 
				CatalogPriceSaleEnd = 112,
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogAutosoftAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAutosoftProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAutosoftProvider1);
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAutosoftProvider2);
