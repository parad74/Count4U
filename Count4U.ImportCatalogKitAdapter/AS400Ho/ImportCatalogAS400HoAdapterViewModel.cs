...
{
    public class ImportCatalogAS400HoAdapterViewModel : TemplateAdapterTwoFilesViewModel
    {
		...
		public ImportCatalogAS400HoAdapterViewModel(IServiceLocator serviceLocator,
			...
			base(serviceLocator, contextCBIRepository, eventAggregator, regionManager, logImport, iniFileParser, temporaryInventoryRepository, userSettingsManager)
        {
			...
			//this.ImportSupplier = false;
			//this.ImportSection = false;
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName1 = "PARTS.txt";//String.Format("sfpart{0}.dat", this._branchErpCode);
			this._fileName2 = String.Format("NIRDAF.txt");

			base.Encoding = System.Text.Encoding.GetEncoding("utf-8");
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400HoProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400HoProvider1);
			...
			IImportProvider provider2_1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400HoProvider2_1);
			provider2_1.ToPathDB = base.GetDbPath;
			provider2_1.FastImport = base.IsTryFast;
			provider2_1.FromPathFile = this.Path2;
			provider2_1.Parms.Clear();
			provider2_1.Parms.AddCancellationUpdate(base.UpdateProgress, base.CancellationToken);
			provider2_1.ProviderEncoding = base.Encoding;
			provider2_1.Parms[ImportProviderParmEnum.InvertLetters] = base.IsInvertLetters ? "1" : String.Empty;
			provider2_1.Parms[ImportProviderParmEnum.InvertWords] = base.IsInvertWords ? "1" : String.Empty;
			provider2_1.Parms[ImportProviderParmEnum.Delimiter] = this._delimiter;
			provider2_1.Parms[ImportProviderParmEnum.DBPath] = base.GetDbPath;

			IImportProvider provider2_2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400HoProvider2_2);
			provider2_2.ToPathDB = base.GetDbPath;
			provider2_2.FastImport = base.IsTryFast;
			provider2_2.FromPathFile = this.Path2;
			provider2_2.Parms.Clear();
			provider2_2.Parms.AddCancellationUpdate(base.UpdateProgress, base.CancellationToken);
			provider2_2.ProviderEncoding = base.Encoding;
			provider2_2.Parms[ImportProviderParmEnum.InvertLetters] = base.IsInvertLetters ? "1" : String.Empty;
			provider2_2.Parms[ImportProviderParmEnum.InvertWords] = base.IsInvertWords ? "1" : String.Empty;
			provider2_2.Parms[ImportProviderParmEnum.Delimiter] = this._delimiter;
			provider2_2.Parms[ImportProviderParmEnum.DBPath] = base.GetDbPath;
			...
			if (string.IsNullOrWhiteSpace(this.MakatMask1) == false)
			{
				...
				provider2_2.Parms.Add(ImportProviderParmEnum.MakatMaskRecord, makatMaskRecord);
				provider2_1.Parms.Add(ImportProviderParmEnum.MakatMaskRecord, makatMaskRecord);
			}
			if (string.IsNullOrWhiteSpace(this.BarcodeMask1) == false)
			{
				...
				provider2_1.Parms.Add(ImportProviderParmEnum.BarcodeMaskRecord, barcodeMaskRecord);
				provider2_2.Parms.Add(ImportProviderParmEnum.BarcodeMaskRecord, barcodeMaskRecord);
			}
