...
namespace Count4U.ImportCatalogKitAdapter.AS400April
{
    public class ImportCatalogAS400AprilViewModel : TemplateAdapterTwoFilesViewModel
    {
		...
		public ImportCatalogAS400AprilViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName1 = String.Format("KB99INFO.{0}", _branchErpCode);
			...
			this.BarcodeMask1 = "0000000000000{S}";
        ...
        public override void InitFromIni()
        {
			...
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogAS400AprilAdapter.ini"));

			Dictionary<ImportProviderParmEnum, string> iniData1 = base.GetIniData("ImportCatalogAS400AprilProvider",  base.GetPathToIniFile("Count4U.ImportCatalogAS400AprilAdapter.ini"));
			Dictionary<ImportProviderParmEnum, string> iniData2 = base.GetIniData("ImportCatalogAS400AprilProvider1", base.GetPathToIniFile("Count4U.ImportCatalogAS400AprilAdapter.ini"));
		...
		private void InitCatalogParserPoints2()
		{
			this._catalogParserPoints2 = new CatalogParserPoints
			{
				...
				CatalogItemCodeStart = 15,
				CatalogItemCodeEnd = 27
			};
		}
        ...
        protected override bool PreImportCheck()
        {
			...
			return base.ContinueAfterBranchERPWarning(base.Path1, @"KB99INFO.(.+)") &&
				 base.ContinueAfterBranchERPWarning(base.Path2, @"PLUEXTRA.(.+)");
        }
        ...
        public override void Import()
        {
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportSupplierAS400AprilProvider);
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400AprilProvider1);
        ...
        public override void Clear()
        {
			...
			IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportSupplierAS400AprilProvider);
			provider3.ToPathDB = base.GetDbPath;
			provider3.Clear();
