...
namespace Count4U.ImportCatalogKitAdapter.BazanCsv
{
    public class ImportCatalogBazanCsvViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogBazanCsvViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = "CATALOG_BAZAN.csv";
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogBazanCsvAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogBazanCsvProvider);
