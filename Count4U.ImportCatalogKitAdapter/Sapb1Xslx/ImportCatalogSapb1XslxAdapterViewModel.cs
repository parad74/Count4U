...
namespace Count4U.ImportCatalogSapb1XslxAdapter
{
    public class ImportCatalogSapb1XslxAdapterViewModel : TemplateAdapterTwoFilesViewModel
    {
      ...
      //  private bool _importSection;
		...
		public ImportCatalogSapb1XslxAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this.XlsxFormat1 = true;
			this.XlsxFormat2 = false;

			this._fileName1 = "CatalogSAPB1.xlsx";//String.Format("sfpart{0}.dat", this._branchErpCode);
			this._fileName2 = String.Format("I6_{0}.csv", this._branchErpCode);
			...
			base.StepTotal = 2;
			if (this._withQuantityERP == true)		base.StepTotal = base.StepTotal + 1;
		//	if (this.ImportSection == true)		base.StepTotal = base.StepTotal + 1;
        ...
        protected override bool PreImportCheck()
        {
			...
			{
				return base.ContinueAfterBranchERPWarning(base.Path2, @"I6_(.+)\.csv");
			}
			else return true;
        }
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogSapb1XslxProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogSapb1XslxProvider1);
