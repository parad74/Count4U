...
namespace Count4U.ImportCatalogKitAdapter.Otech
{
    public class ImportCatalogOtechViewModel : TemplateAdapterOneFileViewModel
    {
	...
	//	private bool _withQuantityERP;
		...
		public ImportCatalogOtechViewModel(IServiceLocator serviceLocator,
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogOtechAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOtechProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOtechProvider1);
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOtechProvider2);
