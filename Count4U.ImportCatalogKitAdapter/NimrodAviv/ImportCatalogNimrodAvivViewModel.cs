...
namespace Count4U.ImportCatalogKitAdapter.NimrodAviv
{
    public class ImportCatalogNimrodAvivViewModel : TemplateAdapterTwoFilesViewModel
    {
		...
		public ImportCatalogNimrodAvivViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName1 = "catalog.txt";//String.Format("sfpart{0}.dat", this._branchErpCode);
			this._fileName2 = "products.txt"; //String.Format("barcodes.csv", this._branchErpCode);
        ...
        public override void Import()
        {
            ...
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogNimrodAvivProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogNimrodAvivProvider1);
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogNimrodAvivProvider2);
			...
			//{
			IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportSectionNimrodAvivProvider);
