...
{
    public class ImportCatalogMade4NetViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogMade4NetViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = "Made4Net_Catalog.csv";
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogMade4NetAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMade4NetADOProvider);
