...
{
    public class ImportCatalogAS400HonigmanAdapterViewModel : TemplateAdapterTwoFilesViewModel
	{
		...
		public ImportCatalogAS400HonigmanAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName1 = "SFPRIT.TXT";
			this._fileName2 = "BARCODE.XLS";
			//this._fileName3 = "itur_quantity.csv";
            ...
            {
                CatalogMinLengthIncomingRow = 6,
                CatalogItemCodeStart = 1,
                CatalogItemCodeEnd = 6,
                CatalogItemNameStart = 7,
        ...
        public override void InitFromIni()
        {
			...
			//this._fileName3 = iniData.SetValue(ImportProviderParmEnum.FileName3, this._fileName3);
			//if (this._fileName3.Contains("XXX") == true)
			//{
			//	this._fileName3 = this._fileName3.Replace("XXX", this._branchErpCode);
			//}
        ...
        public override void Import()
        {
            ...
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400HonigmanProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400HonigmanProvider1);//!1
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400HonigmanProvider2);
			...
			//{
			//	IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogIturQuantityProvider);
