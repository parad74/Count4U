...
namespace Count4U.ImportCatalogKitAdapter.Nesher
{
    public class ImportCatalogNesherViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public ImportCatalogNesherViewModel(IServiceLocator serviceLocator,
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.ImportCatalogNesherAdapter.ini"));
            //init GUI
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogNesherProvider);
