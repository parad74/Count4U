...
namespace Count4U.ImportCatalogKitAdapter.MaccabiPharmSAP
{
    public class ImportCatalogMaccabiPharmSAPViewModel : TemplateAdapterTwoFilesViewModel
    {
		...
		public ImportCatalogMaccabiPharmSAPViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
            ...
            this._fileName1 = "items.txt";//String.Format("sfpart{0}.dat", this._branchErpCode);
			this._fileName2 = "stock-b.txt"; //String.Format("barcodes.csv", this._branchErpCode);
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMaccabiPharmSAPADOProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMaccabiPharmSAPADOProvider1);
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMaccabiPharmSAPADOProvider2);
			...
			{
				IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMaccabiPharmSAPUpdateERPQuentetyADOProvider1);
				provider3.ToPathDB = base.GetDbPath;					   //ProductCatalogForXtechMeuhedetUpdateERPQuentetyDBParser
