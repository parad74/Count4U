...
{
    public class ImportSectionGazitVerifoneSteimaztzkyAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}

		public ImportSectionGazitVerifoneSteimaztzkyAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
            ...
            //init GUI
			this._fileName = "steimatzky_catalog.txt";
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportSectionGazitVerifoneSteimaztzky Adapter");
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportSectionGazitVerifoneSteimaztzkyProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportSectionGazitVerifoneSteimaztzkyProvider1);
