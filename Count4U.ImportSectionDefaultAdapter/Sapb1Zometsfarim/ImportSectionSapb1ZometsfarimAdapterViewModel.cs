...
{
    public class ImportSectionSapb1ZometsfarimAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}

		public ImportSectionSapb1ZometsfarimAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportSectionSapb1Zometsfarim Adapter");
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportSectionSapb1ZometsfarimProvider);
