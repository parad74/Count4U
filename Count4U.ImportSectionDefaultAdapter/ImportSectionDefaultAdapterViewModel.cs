...
{
    public class ImportSectionDefaultAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}

        public ImportSectionDefaultAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			base.LogImport.Clear();																					 //SectionNetPOSSuperPharmParser
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportSectionDefault Adapter");
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportSectionDefaultADOProvider);
