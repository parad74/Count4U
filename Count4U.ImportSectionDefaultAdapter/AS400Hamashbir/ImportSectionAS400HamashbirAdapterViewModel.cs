...
{
    public class ImportSectionAS400HamashbirAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		private CatalogParserPoints _catalogParserPoints1;

		public ImportSectionAS400HamashbirAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = String.Format("SPARITEWSN.{0}", branchErpCode);
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportSectionAS400Hamashbir Adapter");
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportSectionAS400HamashbirProvider);
