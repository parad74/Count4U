...
{
    public class ImportBranchXTechMeuhedetViewModel : TemplateAdapterOneFileViewModel    
    {
        ...
        public ImportBranchXTechMeuhedetViewModel(IServiceLocator serviceLocator,
        ...
        {
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportBranchXtechMeuhedetProvider);
