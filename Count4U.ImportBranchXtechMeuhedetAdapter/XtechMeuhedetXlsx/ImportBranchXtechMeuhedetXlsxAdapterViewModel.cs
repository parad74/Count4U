...
namespace Count4U.ImportBranchXtechMeuhedetXlsxAdapter
{
    public class ImportBranchXtechMeuhedetXlsxAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        private string _currentCode = String.Empty;
        private bool _isCreateDb;

		public ImportBranchXtechMeuhedetXlsxAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			base.XlsxFormat = false;
			//base._isCreateDb = false;
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = "BranchesXtech.xlsx";
        ...
        {
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportBranchXtechMeuhedetXlsxProvider);
			...
			provider1.Parms[ImportProviderParmEnum.SheetNameXlsx] = "גיליון1";
