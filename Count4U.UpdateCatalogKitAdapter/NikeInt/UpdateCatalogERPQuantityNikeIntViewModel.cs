...
namespace Count4U.UpdateCatalogERPQuantityNikeIntAdapter
{																																				  
    public class UpdateCatalogERPQuantityNikeIntViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public UpdateCatalogERPQuantityNikeIntViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = "StoreXXX_SOH.txt"; //StoreXXX_SOH.txt 
		...
		{
			return base.ContinueAfterBranchERPWarning(base.Path, @"Store(.+)_SOH\.txt");
		}
        ...
        public override void Import()
        {
			...
			IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogNikeIntUpdateERPQuentetyProvider);
