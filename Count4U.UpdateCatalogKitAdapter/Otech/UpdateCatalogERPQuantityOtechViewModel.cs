...
namespace Count4U.UpdateCatalogKitAdapter.Otech
{
	// НЕ ИСПОЛЬЗУЕТСЯ
    public class UpdateCatalogERPQuantityOtechViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        string _branchErpCode = String.Empty;

		public UpdateCatalogERPQuantityOtechViewModel(IServiceLocator serviceLocator,
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.UpdateCatalogERPQuantityOtechAdapter.ini"));
