...
{
    public class UpdateCatalogERPQuantityOne1ViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        string _branchErpCode = String.Empty;

		public UpdateCatalogERPQuantityOne1ViewModel(IServiceLocator serviceLocator,
        ...
        {
	         Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.UpdateCatalogERPOne1Adapter.ini"));
