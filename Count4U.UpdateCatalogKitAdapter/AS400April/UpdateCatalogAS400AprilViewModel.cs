...
namespace Count4U.UpdateCatalogKitAdapter.AS400April
{
    public class UpdateCatalogAS400AprilViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        string _branchErpCode = String.Empty;
		private CatalogParserPoints _catalogParserPoints;

		public UpdateCatalogAS400AprilViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this.BarcodeMask = "0000000000000{S}";
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.UpdateCatalogERPAS400AprilAdapter.ini"));
        ...
        {
			return base.ContinueAfterBranchERPWarning(base.Path, @"KB99INFO.(.+)");
        }
        ...
        public override void Import()
        {
		    ...
		    IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400AprilUpdateERPQuentetyProvider);
