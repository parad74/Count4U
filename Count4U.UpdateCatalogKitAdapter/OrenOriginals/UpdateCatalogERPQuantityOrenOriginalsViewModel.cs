...
namespace Count4U.UpdateCatalogERPQuantityOrenOriginalsAdapter
{																																				  
    public class UpdateCatalogERPQuantityOrenOriginalsViewModel : TemplateAdapterOneFileViewModel
    {
	...
	//	private CatalogParserPoints _catalogParserPoints2;
		...
		public UpdateCatalogERPQuantityOrenOriginalsViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			string dateToday = DateTime.Now.ToString("ddMMyy");
			//DDMMYY_xxx.csv 
			this._fileName = String.Format("{0}_{1}.txt", dateToday,this._branchErpCode);
			...
			{
				CatalogMinLengthIncomingRow = 30,
        ...
        {
			return base.ContinueAfterBranchERPWarning(base.Path, @"_(.+)\.txt");
        }
        ...
        public override void Import()
        {
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOrenOriginalsProvider2);
			...
			IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogOrenOriginalsUpdateERPQuentetyProvider1);
			...
			provider3.Parms.AddCatalogParserPoints(this._catalogParserPoints);
