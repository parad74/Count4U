...
namespace Count4U.UpdateCatalogERPQuantityTafnitMatrixAdapter
{																																				  
    public class UpdateCatalogERPQuantityTafnitMatrixViewModel : TemplateAdapterOneFileViewModel
    {
        ...
        public UpdateCatalogERPQuantityTafnitMatrixViewModel(IServiceLocator serviceLocator,
		...
		protected override bool PreImportCheck()
		{
			...
			//string fileName = System.IO.Path.GetFileNameWithoutExtension(base.Path);
		
			//if (fileName == "00") return true;
			...
			//		branchCodeERP = "00";
			//	}
			//	bool check = (fileName.ToLower() == branchCodeERP.ToLower());
			//	return check; //base.ContinueAfterBranchERPWarning(base.Path, @"(.+)\.txt");  //branchCodeERP + ".txt"; //(XX - Branch code without leading zero's);
			//}
			//else
			//{
			//	return true;
        ...
        public override void Import()
        {
            ...
            //IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMPLProvider2);
            ...
            IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogTafnitMatrixUpdateERPQuentetyProvider);
