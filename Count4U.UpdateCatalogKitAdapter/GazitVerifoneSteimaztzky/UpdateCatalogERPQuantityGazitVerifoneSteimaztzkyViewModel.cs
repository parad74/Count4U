...
namespace Count4U.UpdateCatalogERPQuantityGazitVerifoneSteimaztzkyAdapter
{																																				  
    public class UpdateCatalogERPQuantityGazitVerifoneSteimaztzkyViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public UpdateCatalogERPQuantityGazitVerifoneSteimaztzkyViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = String.Format("Store_{0}_{1}.txt", this._branchErpCode, currentDate);	
        ...
        protected override bool PreImportCheck()
        {
			...
			return base.ContinueAfterBranchERPWarning(base.Path, filename);
        }
        ...
        public override void Import()
        {
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogGazitVerifoneSteimaztzkyUpdateERPQuentetyProvider);
