...
namespace Count4U.UpdateCatalogERPQuantitySapb1ZometsfarimAdapter
{																																				  
    public class UpdateCatalogERPQuantitySapb1ZometsfarimViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public UpdateCatalogERPQuantitySapb1ZometsfarimViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = String.Format("StoreCount.txt");//, this._branchErpCode);
        ...
        public override void Import()
        {
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogSapb1ZometsfarimUpdateERPQuentetyProvider);
