...
namespace Count4U.UpdateCatalogERPQuantityMPLAdapter
{																																				  
    public class UpdateCatalogERPQuantityMPLViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public UpdateCatalogERPQuantityMPLViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = String.Format("Stockbylocation_{0}.csv", this._branchErpCode);
        ...
        {
			return base.ContinueAfterBranchERPWarning(base.Path, @"Stockbylocation_(.+)\.csv");
        }
