...
namespace Count4U.UpdateCatalogKitAdapter.AS400Mega
{
    public class UpdateCatalogAS400MegaViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        string _branchErpCode = String.Empty;
		private CatalogParserPoints _catalogParserPoints;

		public UpdateCatalogAS400MegaViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this.PathFilter = "All files (*.txt)|*.*";
			//this._fileName = String.Format("KB99INFO.{0}", _branchErpCode);
			this._fileName = "TOI6#DB.txt";
        ...
        public override void Import()
        {
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogAS400MegaUpdateERPQuentetyProvider);
