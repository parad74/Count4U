...
namespace Count4U.UpdateCatalogKitAdapter.MaccabiPharmSAP
{
    public class UpdateCatalogERPQuantityMaccabiPharmSAPViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        string _branchErpCode = String.Empty;

		public UpdateCatalogERPQuantityMaccabiPharmSAPViewModel(IServiceLocator serviceLocator,
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.UpdateCatalogERPQuantityMaccabiPharmSAPAdapter.ini"));
        ...
        public override void Import()
        {
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogMaccabiPharmSAPUpdateERPQuentetyADOProvider1);
