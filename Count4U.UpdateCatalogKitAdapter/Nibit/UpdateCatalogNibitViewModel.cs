...
namespace Count4U.UpdateCatalogKitAdapter.Nibit
{
    public class UpdateCatalogNibitViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        string _branchErpCode = String.Empty;
		//private CatalogParserPoints _catalogParserPoints;

		public UpdateCatalogNibitViewModel(IServiceLocator serviceLocator,
        ...
        {
			Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile("Count4U.UpdateCatalogNibitAdapter.ini"));
