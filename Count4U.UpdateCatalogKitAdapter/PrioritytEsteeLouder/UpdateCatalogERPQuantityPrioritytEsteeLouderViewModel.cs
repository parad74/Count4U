...
namespace Count4U.UpdateCatalogERPQuantityPrioritytEsteeLouderAdapter
{																																				  
    public class UpdateCatalogERPQuantityPrioritytEsteeLouderViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public UpdateCatalogERPQuantityPrioritytEsteeLouderViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName = "Inventory_XXX.txt"; 
		...
		{
			return base.ContinueAfterBranchERPWarning(base.Path, @"Inventory_(.+)\.txt");
		}
        ...
        public override void Import()
        {
			...
			IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogPrioritytEsteeLouderUpdateERPQuentetyProvider);
