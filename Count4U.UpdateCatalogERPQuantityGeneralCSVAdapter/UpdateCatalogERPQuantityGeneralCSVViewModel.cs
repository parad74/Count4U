...
{																																				  
    public class UpdateCatalogERPQuantityGeneralOldViewModel : TemplateAdapterOneFileViewModel
    {
		...
		public UpdateCatalogERPQuantityGeneralOldViewModel(IServiceLocator serviceLocator,
