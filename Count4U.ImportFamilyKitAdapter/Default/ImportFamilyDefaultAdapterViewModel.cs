...
{
    public class ImportFamilyDefaultAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		private string _branchErpCode = String.Empty;

		public ImportFamilyDefaultAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportFamilyDefault Adapter");
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportFamilyDefaultProvider);
        ...
        public override void Clear()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportFamilyDefaultProvider);
