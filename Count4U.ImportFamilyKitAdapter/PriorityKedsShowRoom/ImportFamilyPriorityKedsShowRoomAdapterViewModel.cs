...
{
    public class ImportFamilyPriorityKedsShowRoomAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		private string _branchErpCode = String.Empty;

		public ImportFamilyPriorityKedsShowRoomAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportFamilyPriorityKedsShowRoom Adapter");
        ...
        public override void Clear()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportFamilyPriorityKedsShowRoomProvider);
