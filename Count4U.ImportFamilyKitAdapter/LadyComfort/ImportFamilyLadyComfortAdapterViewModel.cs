...
namespace Count4U.ImportFamilyKitAdapter.LadyComfort
{
    public class ImportFamilyLadyComfortAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		private string _branchErpCode = String.Empty;

		public ImportFamilyLadyComfortAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportFamilyLadyComfort Adapter");
        ...
        public override void Clear()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportFamilyLadyComfortADOProvider);
