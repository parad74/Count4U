...
namespace Count4U.ImportFamilyKitAdapter.H_M
{
    public class ImportFamilyH_MAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		private string _branchErpCode = String.Empty;

		public ImportFamilyH_MAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportFamilyH_M Adapter");
        ...
        public override void Clear()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportFamilyH_M_NewProvider);
