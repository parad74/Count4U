...
namespace Count4U.ImportFamilyKitAdapter.PriorityRenuar
{
	public class ImportFamilyPriorityRenuarAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		private string _branchErpCode = String.Empty;

		public ImportFamilyPriorityRenuarAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportFamilyPriorityRenuar Adapter");
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportFamilyPriorityRenuarADOProvider);
        ...
        public override void Clear()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportFamilyPriorityRenuarADOProvider);
