...
{
    public class SearchIturAdvancedViewModel : CBIContextBaseViewModel, ISearchGridViewModel
    {
        ...
        public SearchIturAdvancedViewModel(IContextCBIRepository contextCbiRepository,
            ...
            : base(contextCbiRepository)
        {
            ...
            _inventorRepository = _inventorRepository;
        ...
        private SelectParams SelectParamsBuild()
        {
            ...
            {
                IturAdvancedFilterData filterData = _searchFieldViewModel.BuildFilterData() as IturAdvancedFilterData;
                if (filterData != null)
                {
                    filterData.ApplyToSelectParams(result, _inventProductRepository, base.GetDbPath);
                }
            }
