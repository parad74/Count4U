...
{
    public class ImportPdaYarpaAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
        ...
        public ImportPdaYarpaAdapterViewModel(
        ...
        {
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportInventProductSimpleYarpaADOProvider);
			//IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportInventProductBulkProvider1);
			//provider.SetColumnMappings<InventProduct>();
           ...
           // List<string> newDocumentCodeList = new List<string>();
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    base.BackupSourceFilesAfterImport(this.Path, files, appendDateTimeToBackupedFile: true);
