...
{
    public class ImportLocationXlsxAdapterViewModel : TemplateAdapterFileFolderViewModel
    {
		public string _fileName {get; set;}
		private bool XlsxFormat;

		public ImportLocationXlsxAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportLocationXlsxAdapter");

            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportLocationXlsxProvider);
