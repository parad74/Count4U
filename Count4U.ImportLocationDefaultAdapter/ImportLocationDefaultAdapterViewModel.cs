...
{
    public class ImportLocationDefaultAdapterViewModel : TemplateAdapterFileFolderViewModel
    {
		public string _fileName {get; set;}

        public ImportLocationDefaultAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			//init GUI
            this._fileName = "ImportLocationTest.txt";
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportLocationDefoultAdapter");
