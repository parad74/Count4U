...
{
    public class ImportLocationUpdateTagAdapterViewModel : TemplateAdapterFileFolderViewModel
    {
		public string _fileName {get; set;}
		private bool XlsxFormat;

		public ImportLocationUpdateTagAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			//init GUI
			this._fileName = "UpdateLocationTag.xlsx";
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportLocationUpdateTagAdapter");

			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportLocationUpdateTagProvider);
			...
			provider.Parms[ImportProviderParmEnum.FileXlsx] = this.XlsxFormat ? "1" : String.Empty;
