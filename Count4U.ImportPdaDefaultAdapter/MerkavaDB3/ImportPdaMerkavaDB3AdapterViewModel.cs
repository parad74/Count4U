...
{
    public class ImportPdaMerkavaDB3AdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaMerkavaDB3AdapterViewModel(
        ...
        public override void InitFromIni()
        {
			...
			Dictionary<ImportProviderParmEnum, string> iniData1 = base.GetIniData("ImportPdaMerkavaDB3Adapter");
		...
		public override void Import()
		{
			...
			try
			{
				...
				IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportTemporaryInventoryMerkavaSqlite2SdfProvider);
				provider1.ToPathDB = base.GetDbPath;
				provider1.ProviderEncoding = base.Encoding;

				//IturUpdateMerkavaSqlite2SdfParser
				IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportLocationUpdateMerkavaSqlite2SdfProvider);
				provider2.ToPathDB = base.GetDbPath;
				provider2.ProviderEncoding = base.Encoding;

				//InventProductMerkavaSqlite2SdfParser
				IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportInventProductMerkavaSqlite2SdfProvider);
        ...
        public override void Clear()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportInventProductMerkavaSqlite2SdfProvider);
