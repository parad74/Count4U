...
namespace Count4U.ImportPdaMISAdapter
{
    public class ImportPdaMISAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaMISAdapterViewModel(
