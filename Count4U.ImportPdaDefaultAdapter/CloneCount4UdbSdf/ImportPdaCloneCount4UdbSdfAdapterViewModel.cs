...
namespace Count4U.ImportPdaCloneCount4UdbSdfAdapter
{
    public class ImportPdaCloneCount4UdbSdfAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaCloneCount4UdbSdfAdapterViewModel(
		...
		public override void Import()
		{
			...
			if (sourceInventorDb != null)
			{
				...
				if (String.IsNullOrEmpty(inheritFromDBPath) == false)
				{
					...
					inventorRepository.Connection.CopyCount4UDB(base.CurrentInventor.DBPath, folder, sourcePath);
				}
