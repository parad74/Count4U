...
{
    public class ImportPdaNativPlusMISSqliteAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaNativPlusMISSqliteAdapterViewModel(
		...
		public override void Import()
		{
			...
			try
			{
				...
				IImportProvider providerInventProduct = this.GetProviderInstance(ImportProviderEnum.ImportInventProductNativPlusMISSqlite2SdfProvider);
