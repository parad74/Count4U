...
{
    public class ImportPdaAddCount4UdbSdfAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaAddCount4UdbSdfAdapterViewModel(
