...
namespace Count4U.ImportPdaMerkavaUpdateDbAdapter
{
    public class ImportPdaMerkavaUpdateDbAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaMerkavaUpdateDbAdapterViewModel(
		...
		{							
			...
			IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportInventProductBulkUpdateProvider);
			...
			IImportProvider provider6 = this.GetProviderInstance(ImportProviderEnum.ImportInventProductBulkUpdateProvider4);
			provider6.ToPathDB = getDbPath;		//  base.GetDbPath;
			provider6.ProviderEncoding = base.Encoding;
                ...
                while (true)
                {
					...
					if (Step4 == true)
					{
						...
						provider6.Parms[ImportProviderParmEnum.NewSessionCode] = newSessionCode;
						provider6.Parms[ImportProviderParmEnum.DBPath] = getDbPath;		//base.GetDbPath;
						provider6.FromPathFile = getDbPath;
						provider6.Import();
					}
