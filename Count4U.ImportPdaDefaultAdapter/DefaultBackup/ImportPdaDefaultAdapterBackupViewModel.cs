...
namespace Count4U.ImportPdaDefaultBackupAdapter
{
    public class ImportPdaDefaultBackupAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaDefaultBackupAdapterViewModel(
        ...
        {
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportInventProductDefaultBackupProvider);
