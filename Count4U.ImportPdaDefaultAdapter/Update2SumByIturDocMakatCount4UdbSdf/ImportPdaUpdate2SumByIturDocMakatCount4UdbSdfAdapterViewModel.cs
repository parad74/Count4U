...
{
    public class ImportPdaUpdate2SumByIturDocMakatCount4UdbSdfAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaUpdate2SumByIturDocMakatCount4UdbSdfAdapterViewModel(
		...
		{							
			...
			IImportProvider provider3 = this.GetProviderInstance(ImportProviderEnum.ImportInventProductUpdate2SumByIturDocMakatDbBulkProvider);
