...
namespace Count4U.ImportPdaNativSqliteAdapter
{
    public class ImportPdaNativSqliteAdapterViewModel : TemplateAdapterFileFolderViewModel, IImportPdaAdapter
    {
		...
		public ImportPdaNativSqliteAdapterViewModel(
        ...
        public override void InitFromIni()
        {
			...
			Dictionary<ImportProviderParmEnum, string> iniData1 = base.GetIniData("ImportPdaNativSqliteAdapter");
		...
		public override void Import()
		{
			...
			try
			{
				...
				IImportProvider providerTemporaryInventory = this.GetProviderInstance(ImportProviderEnum.ImportTemporaryInventoryNativSqlite2SdfProvider);
				...
				IImportProvider providerLocation = this.GetProviderInstance(ImportProviderEnum.ImportLocationUpdateNativSqlite2SdfProvider);
				...
				IImportProvider providerCatalog = this.GetProviderInstance(ImportProviderEnum.ImportCatalogNativSqlite2SdfProvider);
				providerCatalog.ToPathDB = base.GetDbPath;
				providerCatalog.ProviderEncoding = base.Encoding;

				//InventProductNativSqlite2SdfParser
				IImportProvider providerInventProduct = this.GetProviderInstance(ImportProviderEnum.ImportInventProductNativSqlite2SdfProvider);
				...
				if (base.IsSingleFile == true)
				{
					...
					providerLocation.Parms[ImportProviderParmEnum.DBPath] = base.GetDbPath;
					...
					providerPropertyStr.FromPathFile = this.Path;

					if (System.IO.Path.GetExtension(base.Path) == ".db3")
					{
						providerTemporaryInventory.Parms[ImportProviderParmEnum.FileDB3] = "1";
						providerLocation.Parms[ImportProviderParmEnum.FileDB3] = "1";
						providerCatalog.Parms[ImportProviderParmEnum.FileDB3] = "1";
						providerInventProduct.Parms[ImportProviderParmEnum.FileDB3] = "1";
					//	providerPropertyStr.Parms[ImportProviderParmEnum.FileDB3] = "1";
						StepCurrent++;
				...
				else
				{
					...
					while (true)
					{
						...
						base.StepTotal = files.Count * 4 + 1;
						base.StepCurrent = 0;
						//=====================	  Temporary 
						...
						foreach (string filePath in files)
						{
							...
							providerCatalog.Parms[ImportProviderParmEnum.DBPath] = base.GetDbPath;
							string finalPath = System.IO.Path.Combine(this.Path, filePath);
							providerCatalog.FromPathFile = finalPath;
						...
						foreach (string filePath in files)
						{
							...
							providerLocation.Parms[ImportProviderParmEnum.DBPath] = base.GetDbPath;
							string finalPath = System.IO.Path.Combine(this.Path, filePath);
							providerLocation.FromPathFile = finalPath;
						...
						//	providerPropertyStr.Parms[ImportProviderParmEnum.DBPath] = base.GetDbPath;
						//	string finalPath = System.IO.Path.Combine(this.Path, filePath);
						//	providerPropertyStr.FromPathFile = finalPath;
        ...
        public override void Clear()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportInventProductNativSqlite2SdfProvider);
			...
			IImportProvider provider2 = this.GetProviderInstance(ImportProviderEnum.ImportLocationUpdateNativSqlite2SdfProvider);
