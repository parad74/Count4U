...
{
	public static class CurrentInventoryAdvancedDictionary 
	{
		public static Dictionary<Pair<string, string, string>, CurrentInventoryAdvanced> QuantitySerialCurrentInventorys(this CurrentInventoryAdvanceds collection)
		{
			var dictionary = new Dictionary<Pair<string, string, string>, CurrentInventoryAdvanced>();
			foreach (CurrentInventoryAdvanced currentIventory in collection)
