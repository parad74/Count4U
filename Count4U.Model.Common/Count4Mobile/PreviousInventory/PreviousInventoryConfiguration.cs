...
{
	public class PreviousInventoryConfiguration : EntityTypeConfiguration<PreviousInventory>
	{
		public PreviousInventoryConfiguration()
		{
			this.ToTable("PreviousInventory");
			this.Property(p => p.Uid).HasMaxLength(50).IsRequired();
