...
{
    public class ImportGazitVerifonePriceAdapterViewModel : TemplateAdapterTwoFilesViewModel
    {
		...
		public ImportGazitVerifonePriceAdapterViewModel(IServiceLocator serviceLocator,
