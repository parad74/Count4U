...
{
	public class ExportPdaNativSQLiteAdapterViewModel : ExportPdaModuleBaseViewModel	  //все для динамической смены\выбора  ExportPda Adapter
    {
		...
		public ExportPdaNativSQLiteAdapterViewModel(
		...
		public void Export()
		{
		 ...
		 base.ServiceLocator.GetInstance<IImportProvider>(ImportProviderEnum.ImportLocationNativSdf2SqliteProvider.ToString());
			...
			SaveFileLog(ExportPdaAdapterName.ExportPdaNativSqliteAdapter);
		}
