...
{
	public class ExportPdaNativPlusSQLiteAdapterViewModel : ExportPdaModuleBaseViewModel	  //все для динамической смены\выбора  ExportPda Adapter
    {
		...
		public ExportPdaNativPlusSQLiteAdapterViewModel(
		...
		public void Export()
		{
			...
			//"Catalog";
			IImportProvider provider =																		   //CatalogNativSdf2SqliteParser
			...
			//   //"Location"
			IImportProvider provider1 =																   //LocationNativSdf2SqliteParser
		 base.ServiceLocator.GetInstance<IImportProvider>(ImportProviderEnum.ImportLocationNativSdf2SqliteProvider.ToString());
			...
			SaveFileLog(ExportPdaAdapterName.ExportPdaNativPlusSQLiteAdapter);
		}
