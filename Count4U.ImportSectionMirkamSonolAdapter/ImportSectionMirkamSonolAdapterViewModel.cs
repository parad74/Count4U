...
{
    public class ImportSectionMirkamSonolAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		private string _branchErpCode = String.Empty;

        public ImportSectionMirkamSonolAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportSectionMikramSonol Adapter");
            IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportSectionMikramSonolADOProvider);
