...
{
	public static class Response12_ToString
	{

		public static string Response12ToString(this Response12 response)
		{
			...
			if (codeOperationEnum == CodeOperationEnum.CodeOperation12)
			{
			...
			{
				return "Code operation is expected " + (int)CodeOperationEnum.CodeOperation12;
			}
		}
