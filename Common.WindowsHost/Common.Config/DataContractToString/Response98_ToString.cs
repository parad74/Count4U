...
{
	public static class Response98_ToString
	{
		...
		public static string Response98ToString(this Response98 response)
		{
			...
			if (codeOperationEnum == CodeOperationEnum.CodeOperation98)
			{
			...
			{
				return "Code operation is expected " + (int)CodeOperationEnum.CodeOperation98;
			}
		}
