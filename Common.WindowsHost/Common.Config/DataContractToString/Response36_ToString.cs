...
{
	public static class Response36_ToString
	{

		public static string Response36ToString(this Response36 response)
		{
			...
			if (codeOperationEnum == CodeOperationEnum.CodeOperation36)
			{
			...
			{
				return "Code operation is expected " + (int)CodeOperationEnum.CodeOperation36;
			}
		}
