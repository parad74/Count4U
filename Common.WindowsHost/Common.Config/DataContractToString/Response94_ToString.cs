...
{
	public static class Response94_ToString
	{

		public static string Response94ToString(this Response94 response)
		{
			...
			if (codeOperationEnum == CodeOperationEnum.CodeOperation94)
			{
			...
			{
				return "Code operation is expected " + (int)CodeOperationEnum.CodeOperation94;
			}
		}
