...
{
	public static class Response30_ToString
	{

		public static string Response30ToString(this Response30 response)
		{
			...
			if (codeOperationEnum == CodeOperationEnum.CodeOperation30)
			{
			...
			{
				return "Code operation is expected " + (int)CodeOperationEnum.CodeOperation30;
			}
		}
