...
{
	public static class Response38_ToString
	{

		public static string Response38ToString(this Response38 response)
		{
			...
			if (codeOperationEnum == CodeOperationEnum.CodeOperation38)
			{
			...
			{
				return "Code operation is expected " + (int)CodeOperationEnum.CodeOperation38;
			}
		}
