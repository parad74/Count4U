...
{
	public static class Response64_ToString
	{

		public static string Response64ToString(this Response64 response)
		{
			...
			{
				return "Code operation is expected " + (int)CodeOperationEnum.CodeOperation64;
			}
		}
