...
{
	public static class Response18_ToString
	{

		public static string Response18ToString(this Response18 response)
		{
			...
			if (codeOperationEnum == CodeOperationEnum.CodeOperation18)
			{
			...
			{
				return "Code operation is expected " + (int)CodeOperationEnum.CodeOperation18;
			}
		}
