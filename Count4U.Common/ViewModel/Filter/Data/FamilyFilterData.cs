...
{
    [Serializable]
    public class FamilyFilterData : CommonFilterData, IFilterData
    {
        public string Code { get; set; }
        public string Name { get; set; }

        [XmlIgnore]
		public string FieldViewName { get { return Common.ViewNames.SearchFamilyFieldView; } }

		public FamilyFilterData()
		{
			this.Code = "";
			this.Name = "";
		}
        ...
        public void ApplyToSelectParams(SelectParams selectParams)
        {
            ...
            {
				selectParams.FilterParams.Add("FamilyCode", new FilterParam() { Operator = FilterOperator.Contains, Value = this.Code });
            }
