...
{
	public interface IExportPdaModuleInfo : IBaseImportExportModuleInfo
    {
       // string Name { get; set; }
	...
	public class ExportPdaModuleInfo : ComplexModuleBaseViewModel, IExportPdaModuleInfo
    {
		...
		public ExportPdaModuleInfo() : base() { } 

		//public ExportPdaModuleInfo(IContextCBIRepository contextCbiRepository,
		//	ILog logImport,
		...
		//	//path = contextCbiRepository.GetExportToPDAFolderPath(currentDomainObject, true);
