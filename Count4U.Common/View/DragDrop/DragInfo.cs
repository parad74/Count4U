...
namespace Count4U.Common.View.DragDrop
{
    public interface IDragInfo
    {
        ...
        bool NonStandardAdorner { get; set; }
    }
    ...
    public class DragInfo : IDragInfo
    {
        ...
        public DragInfo(object sender, MouseButtonEventArgs e)
        {
            ...
            if (sender is ItemsControl)
            {
                ...
                if (item == null && e.OriginalSource is Run)
                {
                    item = VisualTreeExtensions.GetVisualAncestor<ContentPresenter>((Run)e.OriginalSource);
                }
                else
                {
                    if (item == null)
        ...
        public bool NonStandardAdorner { get; set; }
    }
}