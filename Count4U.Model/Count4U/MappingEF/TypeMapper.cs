...
namespace Count4U.Model.Count4U.MappingEF
{
    public static class TypeMapper
    {
        ...
        /// Domain object.
        /// </returns>
        public static Type ToDomainObject(this App_Data.Type entity)
        {
        ...
        /// </returns>
        public static Type ToSimpleDomainObject(this App_Data.Type entity)
        {
            return new Type()
            {
                ID = entity.ID,
        ...
        public static App_Data.Type ToEntity(this Type domainObject)
        {
			if (domainObject == null) return null;
            return new App_Data.Type()
            {
                ID = domainObject.ID,
        ...
        /// Domain object.
        /// </param>
        public static void ApplyChanges(this App_Data.Type entity, Type domainObject)
        {
