...
{
	public static class AuditProcessJobMapper
	{

		public static ProcessJob ToAuditDomainObject(this App_Data.AuditProcessJob entity)
		{
		...
		public static ProcessJob ToAuditSimpleDomainObject(this App_Data.AuditProcessJob entity)
		{
			throw new NotImplementedException();
		}

		public static App_Data.AuditProcessJob ToAuditEntity(this ProcessJob domainObject)
		{
			if (domainObject == null) return null;
			return new App_Data.AuditProcessJob()
			{
				ID = domainObject.ID,
		...
		public static void ApplyAuditChanges(this App_Data.AuditProcessJob entity, ProcessJob domainObject)
		{
