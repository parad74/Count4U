...
{
	public class StatusInventorEFRepository : IStatusInventorRepository
	{
	   ...
	   /// <returns></returns>
		...
		private App_Data.StatusInventor GetEntityByCode(App_Data.AuditDB dc, string code)
		{
			var entity = dc.StatusInventor.FirstOrDefault(e => e.Code.CompareTo(code) == 0);
			return entity;
		}
