...
{
	public static class TemporaryMainProcessJobMapper
	{

		public static ProcessJob ToTemporaryMainDomainObject(this App_Data.TemporaryMainProcessJob entity)
		{
		...
		public static ProcessJob ToTemporaryMainSimpleDomainObject(this App_Data.TemporaryMainProcessJob entity)
		{
			throw new NotImplementedException();
		}

		public static App_Data.TemporaryMainProcessJob ToTemporaryMainEntity(this ProcessJob domainObject)
		{
			if (domainObject == null) return null;
			return new App_Data.TemporaryMainProcessJob()
			{
				ID = domainObject.ID,
		...
		public static void ApplyTemporaryMainChanges(this App_Data.TemporaryMainProcessJob entity, ProcessJob domainObject)
		{
