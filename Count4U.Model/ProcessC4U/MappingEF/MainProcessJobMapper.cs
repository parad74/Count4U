...
{
	public static class MainProcessJobMapper
	{

		public static ProcessJob ToMainDomainObject(this App_Data.MainProcessJob entity)
		{
		...
		public static ProcessJob ToMainSimpleDomainObject(this App_Data.MainProcessJob entity)
		{
			throw new NotImplementedException();
		}

		public static App_Data.MainProcessJob ToMainEntity(this ProcessJob domainObject)
		{
			if (domainObject == null) return null;
			return new App_Data.MainProcessJob()
			{
				ID = domainObject.ID,
		...
		public static void ApplyMainChanges(this App_Data.MainProcessJob entity, ProcessJob domainObject)
		{
