...
{
    public class ImportCatalogYarpaWindowsViewModel : TemplateAdapterTwoFilesViewModel
    {
        ...
        public ImportCatalogYarpaWindowsViewModel(IServiceLocator serviceLocator,
        ...
        public override void InitDefault(CBIState state = null)
        {
			...
			this._fileName1 = "prout.txt";//String.Format("sfpart{0}.dat", this._branchErpCode);
			this._fileName2 = "mlout.txt";//String.Format("sfmlay{0}.dat", this._branchErpCode);
        ...
        public override void Import()
        {
			...
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportCatalogYarpaWindowsADOProvider);
			...
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportCatalogYarpaWindowsADOProvider1);
