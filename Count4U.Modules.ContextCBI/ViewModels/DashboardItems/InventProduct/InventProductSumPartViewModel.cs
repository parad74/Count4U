...
{
    public class InventProductSumPartViewModel : CBIContextBaseViewModel, IMdiChild
    {
        ...
        public InventProductSumPartViewModel(IContextCBIRepository contextCBIRepository,
