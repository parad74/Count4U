...
{
    public class ImportMirkamSonolSAPAdapterViewModel : TemplateAdapterOneFileViewModel
    {
        ...
        public ImportMirkamSonolSAPAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
            Dictionary<ImportProviderParmEnum, string> iniData = base.GetIniData(String.Empty, base.GetPathToIniFile( "Count4U.ImportCatalogMirkamSonolSAPAdapter.ini"));
            //init GUI
