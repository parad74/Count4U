...
{
    public class ImportSupplierComaxASPAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
		private string _branchErpCode = String.Empty;

        public ImportSupplierComaxASPAdapterViewModel(IServiceLocator serviceLocator,
        ...
        public override void Import()
        {
			...
			base.LogImport.Add(MessageTypeEnum.Trace, "Start ImportSupplierComaxASP Adapter");
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportSupplierComaxASPADOProvider);
        ...
        {
			base.LogImport.Clear();
			IImportProvider provider = this.GetProviderInstance(ImportProviderEnum.ImportSupplierComaxASPADOProvider);
