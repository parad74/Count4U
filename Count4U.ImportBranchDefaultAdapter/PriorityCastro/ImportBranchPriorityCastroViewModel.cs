...
namespace Count4U.ImportBranchPriorityCastroAdapter
{
    public class ImportBranchPriorityCastroViewModel : TemplateAdapterOneFileViewModel    
    {
		...
		public ImportBranchPriorityCastroViewModel(IServiceLocator serviceLocator,
		...
		private void InitCatalogParserPoints1()
		{
			...
			//Field2: Branch Name (col 5-36)
			this._catalogParserPoints1 = new CatalogParserPoints
			{
				CatalogMinLengthIncomingRow = 4,
				CatalogItemCodeStart = 1,
				CatalogItemCodeEnd = 4, 
				CatalogItemNameStart = 5, 
        ...
        {
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportBranchPriorityCastroProvider);
