...
{
    public class ImportBranchDefaultAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        private string _currentCode = String.Empty;
        private bool _isCreateDb;

        public ImportBranchDefaultAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
            IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportBranchDefaultProvider);
