...
{
    public class ImportBranchDefaultXlsxAdapterViewModel : TemplateAdapterOneFileViewModel
    {
		public string _fileName {get; set;}
        private string _currentCode = String.Empty;
        private bool _isCreateDb;

		public ImportBranchDefaultXlsxAdapterViewModel(IServiceLocator serviceLocator,
        ...
        {
			IImportProvider provider1 = this.GetProviderInstance(ImportProviderEnum.ImportBranchDefautXlsxProvider);
			...
			provider1.Parms[ImportProviderParmEnum.SheetNameXlsx] = "רשימת חנויות";
